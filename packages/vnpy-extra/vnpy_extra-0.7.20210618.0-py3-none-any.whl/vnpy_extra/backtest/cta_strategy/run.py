...
from vnpy_extra.backtest import CrossLimitMethod, ALL_VT_SYMBOL_LIST
...
def _run_backtest():
    from strategies.double_ma_strategy import DoubleMA4Test, DoubleMATargetPosNoStopOrder4Test
...
def _run_bulk_backtest_separated_by_symbol(all_symbol_4_test_cases=False):
    ...
    if not all_symbol_4_test_cases:
        ...
        vt_symbol_info_list = [(item, 0) for item in ALL_VT_SYMBOL_LIST]
