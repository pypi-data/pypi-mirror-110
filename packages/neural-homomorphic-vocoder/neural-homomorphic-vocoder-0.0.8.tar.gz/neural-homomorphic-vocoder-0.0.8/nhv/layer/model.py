...
class NeuralHomomorphicVocoder(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        # LTV layers
        ltv_params = self._get_ltv_params()
        self.ltv_harmonic = CCepLTVFilter(
            **ltv_params, feat2linear_fn=self.feat2linear_fn
        )
        self.ltv_noise = CCepLTVFilter(**ltv_params)
    ...
    def _forward(self, x, cf0, uv):
        ...
        # TODO(k2kobayashi): consider postfilter for each ltv output
