...
import unittest
import os
import vcf2fhir_test_517
import json
from os.path import join, dirname
import shutil
import logging

suite = doctest.DocTestSuite(vcf2fhir_test_517)
...
class Testvcf2fhir_test_517Inputs(unittest.TestCase):
    ...
    def test_valid_ref_build_37(self):
        o_vcf_2_fhir = vcf2fhir_test_517.Converter(os.path.join(
            os.path.dirname(__file__), 'vcf_example1.vcf'), 'GRCh37')
        self.assertEqual(type(o_vcf_2_fhir), vcf2fhir_test_517.Converter)
    ...
    def test_conv_region_only(self):
        ...
        o_vcf_2_fhir = vcf2fhir_test_517.Converter(
            os.path.join(
...
class TestTranslation(unittest.TestCase):
    ...
    def test_with_patient_id(self):
        self.maxDiff = None
        o_vcf_2_fhir = vcf2fhir_test_517.Converter(os.path.join(os.path.dirname(
...
class TestLogger(unittest.TestCase):
    ...
    def test_logger_forks(self):
        ...
        # create logger
        general_logger = logging.getLogger('vcf2fhir_test_517.general')
        invalid_record_logger = logging.getLogger('vcf2fhir_test_517.invalidrecord')
...
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(Testvcf2fhir_test_517Inputs))
