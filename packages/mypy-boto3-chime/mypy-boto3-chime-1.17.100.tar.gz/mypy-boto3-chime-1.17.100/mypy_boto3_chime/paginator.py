...
class ListAccountsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/chime.html#Chime.Paginator.ListAccounts.paginate)
...
class ListUsersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/chime.html#Chime.Paginator.ListUsers.paginate)
