...
``tendril-connector-influxdb`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-connector-influxdb
...
`github releases <https://github.com/tendril-framework/tendril-connector-influxdb/releases>`_.
...
``tendril-connector-influxdb``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-connector-influxdb.git
    $ cd tendril-connector-influxdb
    $ pip install -e .
