...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'google-native', '0.4.1a1624008761'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource google-native 0.4.1a1624008761`
                """)
            else:
                raise
