...
class Train():
    ...
    def _define_model(self,
        ...
        :return:
        '''
        model = MultiLayerResCNN(input_dim,
                                 output_dim,
                                 emb_dim,
                                 hid_dim,
                                 cnn_layers,
...
if __name__ == '__main__':
    ...
    # define model
    model = Train.define_model(input_dim,
                         output_dim,
                         emb_dim,
                         hid_dim,
                         cnn_layers,
    ...
    if optimizer_name == 'adam':
        ...
        optimizer = define_optimizer.define_optimizer_adagrad(model, lr=lr, lr_decay=lr_decay, weight_decay=weight_decay)

    elif optimizer_name == 'rmsprop':
        optimizer = define_optimizer.define_optimizer_rmsprop(model, lr=lr, weight_decay=weight_decay, momentum=momentum)
    ...
    # train and validate
    Train().train_val_main(model, optimizer, criterion, clip, n_epochs, train_iter, val_iter, model_path)
