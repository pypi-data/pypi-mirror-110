...
class DescribeBackupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/fsx.html#FSx.Paginator.DescribeBackups.paginate)
...
class DescribeFileSystemsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/fsx.html#FSx.Paginator.DescribeFileSystems.paginate)
...
class ListTagsForResourcePaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/fsx.html#FSx.Paginator.ListTagsForResource.paginate)
