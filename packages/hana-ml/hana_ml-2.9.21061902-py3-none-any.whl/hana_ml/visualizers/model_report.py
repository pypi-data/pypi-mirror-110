...
class StatisticReportBuilder(object):
    ...
    def build(self):
        self.__clear()
        if isinstance(self.__statistic_table, DataFrame):
...
class ConfusionMatrixReportBuilder(object):
    ...
    def build(self):
        self.__clear()
        if isinstance(self.__confusion_matrix_table, DataFrame):
...
class VariableImportanceReportBuilder(object):
    ...
    def build(self):
        self.__clear()
        if isinstance(self.__variable_importance_table, DataFrame):
...
class UnifiedClassificationReportBuilder(object):
    ...
    def set_statistic_table(self, statistic_table):
    ...
    def set_confusion_matrix_table(self, confusion_matrix_table):
        if confusion_matrix_table and confusion_matrix_table.shape[0] > 0:
    ...
    def set_metric_table(self, metric_table):
