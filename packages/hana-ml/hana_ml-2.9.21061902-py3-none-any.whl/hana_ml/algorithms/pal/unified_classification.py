    ...
    def build_report(self):
        ...
        try:
            if self.__report_builder is None:
                self.__report_builder = UnifiedClassificationReportBuilder(["KEY", "VALUE"], ["KEY", "VALUE"])
            rowlist = []
            ...
            self.__report_builder \
                .set_statistic_table(self.model_[1]) \
                .set_parameter_table(parameter_df) \
                .set_optimal_parameter_table(self.model_[2].collect()) \
                .set_confusion_matrix_table(self.model_[3]) \
                .set_variable_importance_table(self.model_[4]) \
                .set_metric_table(self.model_[5]) \
                .build()
