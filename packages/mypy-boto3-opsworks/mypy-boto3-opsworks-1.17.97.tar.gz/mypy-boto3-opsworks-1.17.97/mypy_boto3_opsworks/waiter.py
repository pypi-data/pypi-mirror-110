...
class AppExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/opsworks.html#OpsWorks.Waiter.AppExistsWaiter)
...
class DeploymentSuccessfulWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/opsworks.html#OpsWorks.Waiter.DeploymentSuccessfulWaiter)
...
class InstanceOnlineWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/opsworks.html#OpsWorks.Waiter.InstanceOnlineWaiter)
...
class InstanceRegisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/opsworks.html#OpsWorks.Waiter.InstanceRegisteredWaiter)
...
class InstanceStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/opsworks.html#OpsWorks.Waiter.InstanceStoppedWaiter)
...
class InstanceTerminatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/opsworks.html#OpsWorks.Waiter.InstanceTerminatedWaiter)
