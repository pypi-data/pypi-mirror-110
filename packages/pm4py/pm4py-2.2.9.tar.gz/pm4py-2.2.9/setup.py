...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.analysis', 'pm4py.algo.analysis.woflan',
              ...
              'pm4py.algo.discovery.causal', 'pm4py.algo.discovery.causal.variants', 'pm4py.algo.discovery.batches',
              ...
              'pm4py.algo.evaluation.precision.variants', 'pm4py.algo.evaluation.simplicity',
              'pm4py.algo.evaluation.simplicity.variants', 'pm4py.algo.evaluation.generalization',
              'pm4py.algo.evaluation.generalization.variants', 'pm4py.algo.evaluation.replay_fitness',
              'pm4py.algo.evaluation.replay_fitness.variants', 'pm4py.algo.evaluation.earth_mover_distance',
              'pm4py.algo.evaluation.earth_mover_distance.variants', 'pm4py.algo.simulation',
              'pm4py.algo.simulation.playout', 'pm4py.algo.simulation.playout.dfg',
              ...
              'pm4py.algo.conformance.alignments.petri_net', 'pm4py.algo.conformance.alignments.petri_net.variants',
              'pm4py.algo.conformance.alignments.decomposed', 'pm4py.algo.conformance.alignments.decomposed.variants',
              'pm4py.algo.conformance.alignments.process_tree', 'pm4py.algo.conformance.alignments.process_tree.util',
              ...
              'pm4py.algo.conformance.log_skeleton.variants', 'pm4py.algo.conformance.logs_alignments',
              ...
              'pm4py.algo.transformation.log_to_trie', 'pm4py.algo.transformation.log_to_features',
              'pm4py.algo.transformation.log_to_features.variants', 'pm4py.algo.decision_mining',
              ...
              'pm4py.objects.petri.importer', 'pm4py.objects.petri.importer.variants', 'pm4py.objects.petri_net',
              'pm4py.objects.petri_net.utils', 'pm4py.objects.petri_net.exporter',
              'pm4py.objects.petri_net.exporter.variants', 'pm4py.objects.petri_net.importer',
              'pm4py.objects.petri_net.importer.variants', 'pm4py.objects.conversion', 'pm4py.objects.conversion.dfg',
              ...
              'pm4py.statistics.rework', 'pm4py.statistics.rework.log', 'pm4py.statistics.rework.pandas',
              'pm4py.statistics.traces', 'pm4py.statistics.traces.log', 'pm4py.statistics.traces.common',
              'pm4py.statistics.traces.pandas', 'pm4py.statistics.traces.generic',
              'pm4py.statistics.traces.generic.log', 'pm4py.statistics.traces.generic.common',
              'pm4py.statistics.traces.generic.pandas', 'pm4py.statistics.traces.cycle_time',
              'pm4py.statistics.traces.cycle_time.log', 'pm4py.statistics.traces.cycle_time.util',
              'pm4py.statistics.traces.cycle_time.pandas', 'pm4py.statistics.traces.case_overlap',
              'pm4py.statistics.traces.case_overlap.log', 'pm4py.statistics.traces.case_overlap.utils',
              'pm4py.statistics.traces.case_overlap.pandas', 'pm4py.statistics.variants',
              ...
              'pm4py.visualization.bpmn', 'pm4py.visualization.bpmn.variants', 'pm4py.visualization.trie',
              ...
              'pm4py.visualization.petrinet.variants', 'pm4py.visualization.petri_net',
