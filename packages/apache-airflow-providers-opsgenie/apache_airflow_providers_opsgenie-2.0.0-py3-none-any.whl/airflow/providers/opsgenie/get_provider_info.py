...
def get_provider_info():
    return {
        ...
        'versions': ['2.0.0', '1.0.2', '1.0.1', '1.0.0'],
        ...
        'operators': [
            {
                'integration-name': 'Opsgenie',
                'python-modules': ['airflow.providers.opsgenie.operators.opsgenie_alert'],
            }
        ],
        'hooks': [
            {
                'integration-name': 'Opsgenie',
                'python-modules': ['airflow.providers.opsgenie.hooks.opsgenie_alert'],
            }
        ],
        'hook-class-names': ['airflow.providers.opsgenie.hooks.opsgenie_alert.OpsgenieAlertHook'],
    }
