...
from algorithmia_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from algorithmia_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.admin_list_secret_providers  # this is an instance of the class Endpoint
        api_instance.admin_list_secret_providers()  # this invokes api_instance.admin_list_secret_providers.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.admin_list_secret_providers.callable or self.callable in this class
