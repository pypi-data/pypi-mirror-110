...
class OrganizationTypeListResult(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OrganizationTypeListResult - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([OrganizationType]):  # noqa: E501

        Keyword Args:
            value ([OrganizationType]):  # noqa: E501
