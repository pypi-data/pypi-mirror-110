...
class IAMConnectorCredential(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_key_id, secret_access_key, *args, **kwargs):  # noqa: E501
        """IAMConnectorCredential - a model defined in OpenAPI
