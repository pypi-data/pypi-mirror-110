...
class EventListenerRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, algo_name, algo_owner, credentials, source_type, source_uri, *args, **kwargs):  # noqa: E501
        """EventListenerRequest - a model defined in OpenAPI
