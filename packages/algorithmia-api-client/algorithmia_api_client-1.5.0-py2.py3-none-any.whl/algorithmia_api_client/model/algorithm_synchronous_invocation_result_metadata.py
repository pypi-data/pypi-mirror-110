...
class AlgorithmSynchronousInvocationResultMetadata(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, duration, *args, **kwargs):  # noqa: E501
        """AlgorithmSynchronousInvocationResultMetadata - a model defined in OpenAPI
