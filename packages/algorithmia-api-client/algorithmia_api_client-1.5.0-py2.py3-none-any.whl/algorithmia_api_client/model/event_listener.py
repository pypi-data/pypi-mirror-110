...
class EventListener(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_type, source_uri, algo_name, algo_owner, algo_version, credentials, *args, **kwargs):  # noqa: E501
        """EventListener - a model defined in OpenAPI
