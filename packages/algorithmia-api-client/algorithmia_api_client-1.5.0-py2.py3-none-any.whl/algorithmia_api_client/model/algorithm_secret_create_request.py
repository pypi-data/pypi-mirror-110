...
class AlgorithmSecretCreateRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'secret_value': 'secret_value',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, short_name, description, owner_type, owner_id, *args, **kwargs):  # noqa: E501
        """AlgorithmSecretCreateRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            secret_value (str): [optional]  # noqa: E501
