...
class FrontendConfigurationEntry(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, keyname, value, resource_type, *args, **kwargs):  # noqa: E501
        """FrontendConfigurationEntry - a model defined in OpenAPI
