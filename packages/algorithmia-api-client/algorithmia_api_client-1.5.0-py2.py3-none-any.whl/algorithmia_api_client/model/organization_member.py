...
class OrganizationMember(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, username, role, user_link, resource_type, *args, **kwargs):  # noqa: E501
        """OrganizationMember - a model defined in OpenAPI
