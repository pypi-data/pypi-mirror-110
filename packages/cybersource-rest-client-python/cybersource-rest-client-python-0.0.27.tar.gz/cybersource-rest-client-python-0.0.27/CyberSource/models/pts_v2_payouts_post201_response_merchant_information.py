...
class PtsV2PayoutsPost201ResponseMerchantInformation(object):
    """
    ...
    def __init__(self, merchant_descriptor=None):
        """
        PtsV2PayoutsPost201ResponseMerchantInformation - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PtsV2PayoutsPost201ResponseMerchantInformation):
            return False
