...
class Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded(object):
    """
    ...
    def __init__(self, instrument_identifier=None):
        """
        Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded):
            return False
