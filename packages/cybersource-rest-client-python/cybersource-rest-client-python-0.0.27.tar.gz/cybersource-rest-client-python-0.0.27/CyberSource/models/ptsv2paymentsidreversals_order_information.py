...
class Ptsv2paymentsidreversalsOrderInformation(object):
    """
    ...
    def line_items(self):
        """
        Gets the line_items of this Ptsv2paymentsidreversalsOrderInformation.

        :return: The line_items of this Ptsv2paymentsidreversalsOrderInformation.
        :rtype: list[Ptsv2paymentsidreversalsOrderInformationLineItems]
        """
    ...
    def line_items(self, line_items):
        """
        Sets the line_items of this Ptsv2paymentsidreversalsOrderInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2paymentsidreversalsOrderInformation):
            return False
