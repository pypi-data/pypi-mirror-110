...
class RiskV1AuthenticationsPost201ResponseErrorInformation(object):
    """
    ...
    def __init__(self, reason=None, message=None, details=None):
        """
        RiskV1AuthenticationsPost201ResponseErrorInformation - a model defined in Swagger
        """
    ...
    def message(self):
        """
        Gets the message of this RiskV1AuthenticationsPost201ResponseErrorInformation.
        The detail message related to the status and reason listed above.

        :return: The message of this RiskV1AuthenticationsPost201ResponseErrorInformation.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this RiskV1AuthenticationsPost201ResponseErrorInformation.
        The detail message related to the status and reason listed above.

        :param message: The message of this RiskV1AuthenticationsPost201ResponseErrorInformation.
        :type: str
        """
    ...
    def details(self):
        """
        Gets the details of this RiskV1AuthenticationsPost201ResponseErrorInformation.

        :return: The details of this RiskV1AuthenticationsPost201ResponseErrorInformation.
    ...
    def details(self, details):
        """
        Sets the details of this RiskV1AuthenticationsPost201ResponseErrorInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RiskV1AuthenticationsPost201ResponseErrorInformation):
            return False
