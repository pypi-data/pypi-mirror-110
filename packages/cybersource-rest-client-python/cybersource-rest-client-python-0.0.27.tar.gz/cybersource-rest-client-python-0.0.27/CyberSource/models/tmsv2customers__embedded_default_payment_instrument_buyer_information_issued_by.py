...
class Tmsv2customersEmbeddedDefaultPaymentInstrumentBuyerInformationIssuedBy(object):
    """
    ...
    def __init__(self, administrative_area=None):
        """
        Tmsv2customersEmbeddedDefaultPaymentInstrumentBuyerInformationIssuedBy - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2customersEmbeddedDefaultPaymentInstrumentBuyerInformationIssuedBy):
            return False
