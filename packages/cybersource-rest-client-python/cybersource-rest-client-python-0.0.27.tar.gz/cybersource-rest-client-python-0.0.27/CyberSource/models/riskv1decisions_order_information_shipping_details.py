...
class Riskv1decisionsOrderInformationShippingDetails(object):
    """
    ...
    def __init__(self, gift_wrap=None, shipping_method=None):
        """
        Riskv1decisionsOrderInformationShippingDetails - a model defined in Swagger
        """
    ...
    def gift_wrap(self):
        """
        Gets the gift_wrap of this Riskv1decisionsOrderInformationShippingDetails.
        ...
        :return: The gift_wrap of this Riskv1decisionsOrderInformationShippingDetails.
        :rtype: bool
        """
    ...
    def gift_wrap(self, gift_wrap):
        """
        Sets the gift_wrap of this Riskv1decisionsOrderInformationShippingDetails.
        Boolean that indicates whether the customer requested gift wrapping for this purchase. This field can contain one of the following values: - true: The customer requested gift wrapping. - false: The customer did not request gift wrapping. 

        :param gift_wrap: The gift_wrap of this Riskv1decisionsOrderInformationShippingDetails.
        :type: bool
        """
    ...
    def shipping_method(self):
        """
        Gets the shipping_method of this Riskv1decisionsOrderInformationShippingDetails.
        ...
        :return: The shipping_method of this Riskv1decisionsOrderInformationShippingDetails.
        :rtype: str
        """
    ...
    def shipping_method(self, shipping_method):
        """
        Sets the shipping_method of this Riskv1decisionsOrderInformationShippingDetails.
        Shipping method for the product. Possible values:   - `lowcost`: Lowest-cost service  - `sameday`: Courier or same-day service  - `oneday`: Next-day or overnight service  - `twoday`: Two-day service  - `threeday`: Three-day service  - `pickup`: Store pick-up  - `other`: Other shipping method  - `none`: No shipping method because product is a service or subscription 
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Riskv1decisionsOrderInformationShippingDetails):
            return False
