...
class TssV2TransactionsGet200ResponseErrorInformation(object):
    """
    ...
    def __init__(self, reason=None, message=None, details=None):
        """
        TssV2TransactionsGet200ResponseErrorInformation - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TssV2TransactionsGet200ResponseErrorInformation):
            return False
