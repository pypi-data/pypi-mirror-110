...
class Ptsv2paymentsidProcessingInformation(object):
    """
    ...
    def authorization_options(self):
        """
        Gets the authorization_options of this Ptsv2paymentsidProcessingInformation.

        :return: The authorization_options of this Ptsv2paymentsidProcessingInformation.
        :rtype: Ptsv2paymentsidProcessingInformationAuthorizationOptions
        """
    ...
    def authorization_options(self, authorization_options):
        """
        Sets the authorization_options of this Ptsv2paymentsidProcessingInformation.

        :param authorization_options: The authorization_options of this Ptsv2paymentsidProcessingInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2paymentsidProcessingInformation):
            return False
