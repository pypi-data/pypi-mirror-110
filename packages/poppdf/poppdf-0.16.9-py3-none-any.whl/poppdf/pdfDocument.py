...
if __name__=="__main__":
    ...
    pdf=PdfDocument("/Users/mohamedmentis/Dropbox/My Mac (MacBook-Pro.local)/Documents/Mentis/Development/Python/candriam_entities_api/pdf3/CS Invm Fds 3 - Credit Suisse (Lux) Emerging Market Corporate Investment....pdf", use_ocr=False)
