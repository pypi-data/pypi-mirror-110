...
if __name__=="__main__":
    ...
    image=image_from_path("/Users/mohamedmentis/Dropbox/My Mac (MacBook-Pro.local)/Documents/Mentis/Development/Python/pdf2text/pdf3/FR_FFG_GlobalFlex_Sust_DisR.pdf", first_page=2, last_page=2)[0]
