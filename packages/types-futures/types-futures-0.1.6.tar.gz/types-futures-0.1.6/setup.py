...
This is an auto-generated PEP 561 type stub package for `futures` package.
...
setup(name=name,
      ...
      package_data={'concurrent-python2-stubs': ['__init__.pyi', 'futures/thread.pyi', 'futures/_base.pyi', 'futures/process.pyi', 'futures/__init__.pyi', 'METADATA.toml']},
