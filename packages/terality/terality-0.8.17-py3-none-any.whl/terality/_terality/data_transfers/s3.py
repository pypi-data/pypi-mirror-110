...
def upload_s3_files(s3_bucket: str, s3_key_prefix: str) -> str:
    ...
    request = ImportFromCloudRequest(
        service=StorageService.AWS_S3, source=ImportFromS3Source(presigned_urls=presigned_urls)
    )
    ...
    try:
        ...
        for upload_id, parts in parts_by_upload_id:  # type: ignore
            ...
            s3_client.complete_multipart_upload(
                UploadId=upload_id, Bucket=bucket, Key=key, MultipartUpload={"Parts": etags}
            )
