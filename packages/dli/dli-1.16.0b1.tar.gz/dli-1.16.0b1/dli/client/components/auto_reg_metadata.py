...
from dli.client.utils import to_snake_case_keys, _AttributeAdapter, object_to_namedtuple
...
class AutoRegMetadata(BaseComponent):
    ...
    def edit_auto_registration_metadata(
        ...
        auto_reg_metadata_dict = auto_reg_metadata.as_dict()
