...
def test_requirements_offset_scenarios(session):
    ...
    extra_requirements = ['dask>=1.0.0    # 2018-10-27 # BSD License (BSD)',
                          's3fs>=0.4.0    # 2019-10-13 # BSD License (BSD)']
    rm.modify_requirements(from_file, to_file, min_date, extra_requirements)
...
class RequirementsModifier:
    ...
    def set_known_issues(self):
        ...
        self.version_limits = {
            ...
            'dask':'1.0.0',  # 2018-11-28
            'dask[dataframe]':'1.0.0',  # 2018-11-28
            's3fs': '0.2.0',  # 2018-11-22
        }
    ...
    def requirement_extension(self, req):
    ...
    def modify_requirements(self, from_file, to_file, min_date, extra_requirements=[]):
        ...
        self.requirements.extend(extra_requirements)
