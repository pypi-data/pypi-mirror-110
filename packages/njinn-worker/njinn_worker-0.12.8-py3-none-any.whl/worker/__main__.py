...
def main(api=None, clear_packs=False, token=None, no_default_queues=False):
    ...
    worker = NjinnWorker(registration_token=registration_token, njinn_url=njinn_url, no_default_queues=no_default_queues)
