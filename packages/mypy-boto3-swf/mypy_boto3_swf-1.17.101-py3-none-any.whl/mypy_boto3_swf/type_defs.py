...
_RequiredHistoryTypeDef = TypedDict(
    "_RequiredHistoryTypeDef",
    {
        "events": List["HistoryEventTypeDef"],
    },
)
_OptionalHistoryTypeDef = TypedDict(
    "_OptionalHistoryTypeDef",
    {
        "nextPageToken": str,
    },
    total=False,
...
_RequiredPendingTaskCountTypeDef = TypedDict(
    "_RequiredPendingTaskCountTypeDef",
    {
        "count": int,
    },
)
_OptionalPendingTaskCountTypeDef = TypedDict(
    "_OptionalPendingTaskCountTypeDef",
    {
        "truncated": bool,
    },
    total=False,
...
_RequiredWorkflowExecutionCountTypeDef = TypedDict(
    "_RequiredWorkflowExecutionCountTypeDef",
    {
        "count": int,
    },
)
_OptionalWorkflowExecutionCountTypeDef = TypedDict(
    "_OptionalWorkflowExecutionCountTypeDef",
    {
        "truncated": bool,
    },
    total=False,
...
_OptionalWorkflowExecutionInfosTypeDef = TypedDict(
    "_OptionalWorkflowExecutionInfosTypeDef",
    {
        "nextPageToken": str,
    },
    total=False,
