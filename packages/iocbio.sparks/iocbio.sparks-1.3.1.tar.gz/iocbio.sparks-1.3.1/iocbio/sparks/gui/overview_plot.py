...
class OverViewPlot(QWidget):
    ...
    def __init__(self, image):
        ...
        self.analysis_region_space = pg.LinearRegionItem((0,0), orientation='horizontal', movable=False)
        self.analysis_region_space.setBrush(pg.mkBrush(None))
        self.analysis_region_space.setZValue(20)
        self.plot_item.addItem(self.analysis_region_space)
    ...
    def update_analysis_region_space(self, rng):
        self.analysis_region_space.setRegion(rng)
