...
class Status:
    ...
    def __init__(
        ...
        Args:
            init_status (Any, optional): The initial status. Defaults
            to "initialised".
    ...
    def get_(self, content_type: str) -> Any:
        ...
        Args:
            content_type (str): The parameter whose value to return.
            Accepts "data", "time" and "status".
    ...
    def parse_to_message(self) -> Dict:
        ...
        Returns:
            Dict: The current status, always contains the keyword "status",
            optionally contains the keywords "time" and "data".
        """
        message = {}
