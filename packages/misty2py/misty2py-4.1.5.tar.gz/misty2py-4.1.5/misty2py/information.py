"""This script implements the information keywords matching to Misty's API
endpoints and sending information requests.
"""
import json
from os import path
...
class Get:
    ...
    Attributes:
        ...
        allowed_infos (dict): The dictionary of information keywords matching
        to the Misty's API endpoints.
    """
    ...
    def __init__(self, ip: str, custom_allowed_infos: Dict = {}) -> None:
        ...
        Args:
            ip (str): The IP address where the requests are sent.
            custom_allowed_infos (Dict, optional): The dictionary of custom
            information keywords. Defaults to {}.
        """
...
class Info(Get):
    ...
    def get_info(self, info_name: str, params: Dict = {}) -> Dict:
        ...
        Args:
            info_name (str): The information keyword specifying which
