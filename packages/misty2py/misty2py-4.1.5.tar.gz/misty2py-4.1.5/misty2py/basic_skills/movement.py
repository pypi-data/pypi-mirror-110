...
class Movement:
    ...
    def __init__(
        ...
        Args:
            max_velocity (int, optional): The maximal allowed velocity.
            Defaults to 100.
            min_velocity (int, optional): The minimal allowed velocity that is
            not stagnant. Defaults to 1.
            stagnant_velocity (int, optional): The stagnant velocity.
            Defaults to 0.
            max_angle (int, optional): The maximum turning angle.
            Defaults to 100.
            min_angle (int, optional): The minimum turning angle that is
            not equal to the straight line driving. Defaults to 1.
            stagnant_angle (int, optional): The angle equal to the straight
            line driving. Defaults to 0.
        """
    ...
    def _parse_value(
        ...
        Args:
            ...
            negative (bool, optional): Whether the input value should be
            transformed into its negative. Defaults to False.
            negatives_allowed (bool, optional): Whether an input value can be
            negative. Defaults to False.

        Returns:
            int: the input value so that it is smaller or equal to the maximum
            value and higher or equal to the minimum value if negatives are
            not allowed; transformed to its negative if `negative` is True
            and higher or equal to the negative of the maximal value and lower
            or equal to the maximal value if negatives are allowed.
        """
