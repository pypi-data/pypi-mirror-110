"""This script implements the action keywords matching to Misty's API
endpoints, sending action requests and data shortcuts.
"""
import json
import sys
from os import path
...
class Post:
    ...
    Attributes:
        ...
        allowed_actions (dict): The dictionary of custom action keywords
        matching to the Misty's API endpoints.
        allowed_data (dict): The dictionary of custom data shortcuts matching
        to the json dictionaries required my Misty's API.
    """
    ...
    def __init__(
        ...
        Args:
            ip (str): The IP address where the requests are sent.
            custom_allowed_actions (Dict, optional): The dictionary of action
            keywords. Defaults to {}.
            custom_allowed_data (Dict, optional): The dictionary of data
            shortcuts. Defaults to {}.
        """
    ...
    def perform_action(
        ...
        Args:
            ...
            request_method (str, optional): The request method.
            Defaults to "post".
...
class Action(Post):
    ...
    def perform_action(
        ...
        Args:
            action_name (str): The action keyword specifying which action
            is requested.
            data (Union[str, Dict]): The data shortcut representing the data
            supplied in the body of the request or the json dictionary
            to be supplied in the body of the request.
            data_method (str): "dict" if the data is supplied as a json
            dictionary, "string" if the data is supplied as a data shortcut.
    ...
    def action_handler(self, action_name: str, data: Union[Dict, str]) -> Dict:
        ...
        Args:
            ...
            data (Union[Dict, str]): The data to send in the request body
