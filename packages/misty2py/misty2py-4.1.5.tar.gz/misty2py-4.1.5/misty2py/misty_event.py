...
class MistyEvent:
    ...
    Attributes:
        ...
        type_str (str): The event type string as required by Misty's
        websockets.
        event_name (str): A custom, unique event name.
        return_property (str): The property to return as requeired by Misty's
        websockets.
        ...
        ee (Union[bool, Callable]): The event emitter function if one is
    ...
    def __init__(
        ...
        Args:
            ...
            websockets.
            event_name (str): A custom, unique event name.
            return_property (str): The property to return as required by
            Misty's websockets.
            debounce (int): The interval at which new information is sent
            in ms.
            len_data_entries (int): The maximum number of data entries to keep.
            event_emitter (Union[Callable, None]): The event emitter function
            if one is desired, False otherwise.
        """
    ...
    def on_close(self, ws):
        """Appends the closing message to the log and if ee is set,
        emits a 'close' event.
    ...
    def on_open(self, ws):
        ...
        and if ee is set, emits an 'open' event.
...
class MistyEventHandler:
    """A class that handles all events its related Misty object
    subscribed to during this runtime.

    Attributes:
        events (Dict): a dictionary of all Event objects its related Misty
        object subscribed to during this runtime.
        ip (str): the IP address of the Misty belonging to this object's
        related Misty object.
    """
    ...
    def subscribe_event(self, kwargs: Dict) -> Dict:
        ...
        Args:
            kwargs (Dict):  requires a key "type" (a string representing the
            event type to subscribe to). Optional keys are:
