...
class VolumeSpaceSchema(ResourceSchema):
    ...
    """afs_total,available,available_percent,block_storage_inactive_user_data,capacity_tier_footprint,footprint,local_tier_footprint,logical_space,metadata,over_provisioned,performance_tier_footprint,size,snapshot,total_footprint,used,used_by_afs,"""
    ...
    """afs_total,available_percent,logical_space,size,snapshot,used_by_afs,"""
