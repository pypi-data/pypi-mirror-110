...
__all__ = ["QtreeQosPolicy", "QtreeQosPolicySchema"]
__pdoc__ = {
    "QtreeQosPolicySchema.resource": False,
    "QtreeQosPolicy": False,
}


class QtreeQosPolicySchema(ResourceSchema):
    """The fields of the QtreeQosPolicy object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the qtree_qos_policy. """
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    """links,max_throughput_iops,max_throughput_mbps,min_throughput_iops,name,uuid,"""
    ...
    """max_throughput_iops,max_throughput_mbps,min_throughput_iops,name,uuid,"""
...
class QtreeQosPolicy(Resource):

    _schema = QtreeQosPolicySchema
