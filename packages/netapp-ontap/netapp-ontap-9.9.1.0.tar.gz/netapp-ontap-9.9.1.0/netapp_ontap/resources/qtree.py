...
Example: 1 """
    ...
    nas = fields.Nested("netapp_ontap.models.qtree_nas.QtreeNasSchema", data_key="nas", unknown=EXCLUDE)
...
Example: /volume3/qtree1 """
    ...
    qos_policy = fields.Nested("netapp_ontap.models.qtree_qos_policy.QtreeQosPolicySchema", data_key="qos_policy", unknown=EXCLUDE)
...
Example: 493 """
    ...
    """export_policy.id,export_policy.name,group,name,nas,qos_policy.max_throughput_iops,qos_policy.max_throughput_mbps,qos_policy.min_throughput_iops,qos_policy.name,qos_policy.uuid,security_style,unix_permissions,user,"""
    ...
    """export_policy.id,export_policy.name,group,name,nas,qos_policy.max_throughput_iops,qos_policy.max_throughput_mbps,qos_policy.min_throughput_iops,qos_policy.name,qos_policy.uuid,security_style,svm.name,svm.uuid,unix_permissions,user,volume.name,volume.uuid,"""
