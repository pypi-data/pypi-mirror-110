...
class MediatorSchema(ResourceSchema):
    ...
    dr_group = fields.Nested("netapp_ontap.resources.metrocluster_dr_group.MetroclusterDrGroupSchema", data_key="dr_group", unknown=EXCLUDE)
