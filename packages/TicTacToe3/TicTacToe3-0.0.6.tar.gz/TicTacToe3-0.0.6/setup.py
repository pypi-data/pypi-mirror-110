...
setup(
    ...
    python_requires=">=3",
    project_urls={"Home Page":"https://github.com/Programmin-in-Python/TicTacToe-cli",
                    "Release Notes":"https://github.com/Programmin-in-Python/TicTacToe-cli/releases/tag/v0.0.6"},
