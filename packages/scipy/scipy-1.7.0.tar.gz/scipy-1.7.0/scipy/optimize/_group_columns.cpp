...
namespace __pythran__group_columns
{
  ...
  typename group_sparse::type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type group_sparse::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& indices, argument_type3&& indptr) const
  {
    ...
    {
      long  __target140289072449424 = n;
      for (long  i=0L; i < __target140289072449424; i += 1L)
      {
        ...
        {
          long  __target140289072420704 = indptr.fast(pythonic::operator_::add(i, 1L));
          for (long  k=indptr.fast(i); k < __target140289072420704; k += 1L)
          {
            union_[indices[k]] = 1L;
          }
        }
        {
          long  __target140289072421184 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target140289072421184; j += 1L)
          {
            ...
            {
              long  __target140289072469760 = indptr.fast(pythonic::operator_::add(j, 1L));
              for (long  k_=indptr.fast(j); k_ < __target140289072469760; k_ += 1L)
              {
            ...
            {
              {
                long  __target140289072523728 = indptr.fast(pythonic::operator_::add(j, 1L));
                for (long  k__=indptr.fast(j); k__ < __target140289072523728; k__ += 1L)
                {
  ...
  typename group_dense::type<argument_type0, argument_type1, argument_type2>::result_type group_dense::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& A) const
  {
    ...
    {
      long  __target140289071676912 = n;
      for (long  i=0L; i < __target140289071676912; i += 1L)
      {
        if (pythonic::operator_::ge(groups.fast(i), 0L))
        {
          continue;
        ...
        {
          long  __target140289071545984 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target140289071545984; j += 1L)
          {
            if (pythonic::operator_::lt(groups.fast(j), 0L))
            {
              all_grouped = pythonic::builtins::False;
            ...
            typename pythonic::lazy<decltype(pythonic::builtins::False)>::type intersect = pythonic::builtins::False;
            {
              long  __target140289071655376 = m;
              for (long  k=0L; k < __target140289071655376; k += 1L)
              {
