...
__all__ = ['baixar_dados', 'journal2table', 'value_text_string', 'check_update', 'view_string', 'valida_fiscaliza',
           'issue_type', 'hm2prod', 'prod2hm', 'validar_dicionario', 'auth_user', 'issue2users', 'insp2acao',
           'utf2ascii', 'detalhar_issue', 'atualiza_fiscaliza', 'relatar_inspecao']
