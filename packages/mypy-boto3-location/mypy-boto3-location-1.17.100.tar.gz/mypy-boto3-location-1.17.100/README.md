...
[boto3.LocationService 1.17.100](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/location.html#LocationService)
...
def get_structure() -> BatchDeleteDevicePositionHistoryErrorTypeDef:
    return {
      ...
    }
```
