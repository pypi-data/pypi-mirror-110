...
try:
    ...
    pio_loaded = False
    raise PioException('GPIO not loaded because {}'.format(e))
...
class PiOut:
    ...
    def turn_on(self):
        ...
        :return: None
        """
        print('going to turn ON, state:{}'.format(self.state))
        if not self.state:
            print('Turning ON, state:{}'.format(self.state))
    ...
    def turn_off(self):
        ...
        :return: None
        """
        print('going to turn OFF, state:{}'.format(self.state))
        if self.state:
            print('Turning OFF, state:{}'.format(self.state))
