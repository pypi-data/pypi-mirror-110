[![pipeline status](https://git.dcc.sib.swiss/biwg/libweb/django-drf-utils/badges/dev/pipeline.svg)](https://git.dcc.sib.swiss/biwg/libweb/django-drf-utils/-/commits/dev)
