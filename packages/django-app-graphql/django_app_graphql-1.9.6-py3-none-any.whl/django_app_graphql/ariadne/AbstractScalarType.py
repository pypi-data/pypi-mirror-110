...
class AbstractScalarType(Generic[T], abc.ABC):
    ...
    _REGISTERED_SCALARS: Set[ScalarType] = set()
    ...
    @classmethod
    def get_all_registered_scalars(cls) -> FrozenSet[ScalarType]:
        """
        fetch all the scalars registered with this lcass
        :return:
        """
        return frozenset(AbstractScalarType._REGISTERED_SCALARS)
    ...
    def generate_scalar(self, *args, **kwargs) -> Tuple[ScalarType, Callable[[any], any], Callable[[any], any]]:
        ...
        AbstractScalarType._REGISTERED_SCALARS.add(scalar_type)
