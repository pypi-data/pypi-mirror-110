[![pipeline status](https://git.dcc.sib.swiss/biwg/libweb/django-identities/badges/dev/pipeline.svg)](https://git.dcc.sib.swiss/biwg/libweb/django-identities/-/commits/dev)
