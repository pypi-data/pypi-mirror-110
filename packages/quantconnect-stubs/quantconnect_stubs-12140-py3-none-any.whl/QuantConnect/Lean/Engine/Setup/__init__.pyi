...
class BacktestingSetupHandler(System.Object, QuantConnect.Lean.Engine.Setup.ISetupHandler):
    ...
    def GetMaximumOrders(self, job: QuantConnect.Packets.BacktestNodePacket) -> int:
        """
    ...
    def GetMaximumRuntime(self, parameters: QuantConnect.Lean.Engine.Setup.SetupHandlerParameters) -> datetime.timedelta:
        """
        Calculate the maximum runtime for this algorithm job.
        
        This method is protected.
        
        :param parameters: Setup handler parameters
...
class ConsoleSetupHandler(QuantConnect.Lean.Engine.Setup.BacktestingSetupHandler):
    ...
    def GetMaximumRuntime(self, parameters: QuantConnect.Lean.Engine.Setup.SetupHandlerParameters) -> datetime.timedelta:
        ...
        :param parameters: Maximum runtime for this job
        """
        ...
