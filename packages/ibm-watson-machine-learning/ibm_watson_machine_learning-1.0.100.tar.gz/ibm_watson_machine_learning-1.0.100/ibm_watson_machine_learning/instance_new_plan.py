...
class ServiceInstanceNewPlan:
    ...
    def __init__(self, client):
        ...
        self._href_definitions = HrefDefinitions(self._wml_credentials,
                                                 ...
                                                 git_based_project=self._client.project_type == "local_git_storage"
                                                 )
    ...
    def _get_cpd_token_from_request(self):
        ...
        **Output**
            ...
            **return type**: str\n
        """
        if self._client.ICP_40 and 'bedrock_url' in self._client.wml_credentials and 'password' in self._client.wml_credentials:
            try:
