...
def create_summary(details: dict, scoring: str) -> 'DataFrame':
    ...
    try:
        if is_ml_metrics:
            ...
            pipelines = pipelines.sort_values(
                by=['Winner'] + [get_metrics_names()[0]], ascending=False)
...
def validate_additional_params_for_optimizer(params):
    expected_params = [
        ...
        'enable_subsampling', 'n_parallel_data_connections', 'calculate_data_metrics',
        'batch_size', 'metrics_on_logical_batch', 'logical_batch_size'
    ]
