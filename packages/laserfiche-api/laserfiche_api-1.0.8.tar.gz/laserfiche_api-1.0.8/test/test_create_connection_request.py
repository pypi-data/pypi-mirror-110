...
from laserfiche_api.models.create_connection_request import CreateConnectionRequest  # noqa: E501
...
class TestCreateConnectionRequest(unittest.TestCase):
    ...
    def testCreateConnectionRequest(self):
        ...
        # model = laserfiche_api.models.create_connection_request.CreateConnectionRequest()  # noqa: E501
        pass
