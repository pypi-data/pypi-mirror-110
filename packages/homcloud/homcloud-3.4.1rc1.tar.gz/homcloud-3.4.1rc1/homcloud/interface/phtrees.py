...
class PHTrees(object):
    ...
    class Volume(object):
        ...
        def to_plotly_trace(self, color="green", width=1, name=""):
            """
        ...
        to_plotly = to_plotly_trace

        def to_plotly_mesh(self, color="green", name=""):
            """
    ...
    class Node(Volume, phtrees.Node):
        ...
        def living_descendants(self):
            """
            Returns:
                list of :class:`PHTrees.Node`: All descendant nodes with positive lifetime
            """
