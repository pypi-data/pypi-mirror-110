...
class SpacyRulesParameters(SegmenterParameters):
    ...
    split_rules: List[List[Dict[str, Any]]] = Field(SPLIT_DEFAULT,
                                                    description="List of join rules based on the [Spacy Rule-based matcher](https://spacy.io/usage/rule-based-matching) syntax",
                                                    extra="json")
    join_rules: List[List[Dict[str, Any]]] = Field(None,
                                                   description="List of split rules based on the [Spacy Rule-based matcher](https://spacy.io/usage/rule-based-matching) syntax",
                                                   extra="json", example=JOIN_EXAMPLE)
