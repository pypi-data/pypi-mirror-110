...
import pysegmenters_spacyrules


# -- Project information -----------------------------------------------------

project = "pysegmenters_spacyrules"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pysegmenters_spacyrules.__version__
release = pysegmenters_spacyrules.__version__
...
apidoc_module_dir = os.path.dirname(pysegmenters_spacyrules.__file__)
