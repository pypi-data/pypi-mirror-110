...
df_tree = pd.read_csv("uhafOBO_0621.csv")
...
def _seq2boolquery(metadata_condition,include_children = True):
...
def query_cells(metadata_conditions,include_children=False):
    ...
    """
    query = _seq2boolquery(metadata_conditions,include_children)
    # get primary keys
    results = []
    next_token = None
    total_cells = 0
