...
def search(hyperdrive_config, workspace, experiment_name, **kwargs):
    ...
    if hyperdrive_config.run_config is not None and hyperdrive_config.run_config.run_config is not None \
            and (hyperdrive_config.run_config.run_config.target is not None or
                 (hasattr(hyperdrive_config.run_config.run_config, "global_job_dispatcher") and
                  hyperdrive_config.run_config.run_config.global_job_dispatcher is not None)):
