...
class ForecastTCNWrapper(DNNForecastWrapper):
    ...
    def _build_canned_model(self, dset_config: DataSourceConfig, horizon: int, num_quantiles: int,
        ...
        dilation = self.params.get_value(TCNForecastParameters.DILATION, TCNForecastParameters.DILATION_DEFAULT)
        ...
        return create_tcn_quantile_forecaster(input_channels,
                                              ...
                                              num_channels, depth, dropout_rate, dilation)
    ...
    def _build_model_forecaster(self, run_update_callback: RunUpdateCallback,
        ...
        self.model = self._build_canned_model(dset_config=dset_config,
                                              horizon=self.params.get_value(ForecastConstant.Horizon),
