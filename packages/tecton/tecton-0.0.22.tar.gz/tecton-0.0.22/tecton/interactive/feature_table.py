...
class FeatureTable(FeatureDefinition):
    ...
    def get_feature_vector(
        self, join_keys: Optional[Dict[str, Union[int, str, bytes]]] = None, include_join_keys_in_response: bool = False
    ) -> FeatureVector:
        """
...
@sdk_public_method
def get_feature_table(ft_reference: str) -> FeatureTable:
    ...
    if not response.feature_view.HasField("feature_table"):
        raise errors.FCO_NOT_FOUND_WRONG_TYPE(FeatureTable, ft_reference, "get_feature_view")
