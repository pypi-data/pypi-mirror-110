...
class MediaStoreClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.can_paginate)
    ...
    def create_container(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.create_container)
    ...
    def delete_container(self, *, ContainerName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.delete_container)
    ...
    def delete_container_policy(self, *, ContainerName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.delete_container_policy)
    ...
    def delete_cors_policy(self, *, ContainerName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.delete_cors_policy)
    ...
    def delete_lifecycle_policy(self, *, ContainerName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.delete_lifecycle_policy)
    ...
    def delete_metric_policy(self, *, ContainerName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.delete_metric_policy)
    ...
    def describe_container(self, *, ContainerName: str = None) -> DescribeContainerOutputTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.describe_container)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.generate_presigned_url)
    ...
    def get_container_policy(self, *, ContainerName: str) -> GetContainerPolicyOutputTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.get_container_policy)
    ...
    def get_cors_policy(self, *, ContainerName: str) -> GetCorsPolicyOutputTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.get_cors_policy)
    ...
    def get_lifecycle_policy(self, *, ContainerName: str) -> GetLifecyclePolicyOutputTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.get_lifecycle_policy)
    ...
    def get_metric_policy(self, *, ContainerName: str) -> GetMetricPolicyOutputTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.get_metric_policy)
    ...
    def list_containers(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.list_containers)
    ...
    def list_tags_for_resource(self, *, Resource: str) -> ListTagsForResourceOutputTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.list_tags_for_resource)
    ...
    def put_container_policy(self, *, ContainerName: str, Policy: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.put_container_policy)
    ...
    def put_cors_policy(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.put_cors_policy)
    ...
    def put_lifecycle_policy(self, *, ContainerName: str, LifecyclePolicy: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.put_lifecycle_policy)
    ...
    def put_metric_policy(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.put_metric_policy)
    ...
    def start_access_logging(self, *, ContainerName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.start_access_logging)
    ...
    def stop_access_logging(self, *, ContainerName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.stop_access_logging)
    ...
    def tag_resource(self, *, Resource: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.tag_resource)
    ...
    def untag_resource(self, *, Resource: str, TagKeys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Client.untag_resource)
    ...
    def get_paginator(self, operation_name: Literal["list_containers"]) -> ListContainersPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mediastore.html#MediaStore.Paginator.ListContainers)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore/paginators.html#listcontainerspaginator)
        """
