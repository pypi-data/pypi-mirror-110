...
class FleetStartedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/appstream.html#AppStream.Waiter.FleetStartedWaiter)
...
class FleetStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/appstream.html#AppStream.Waiter.FleetStoppedWaiter)
