...
class TableExistsWaiter(Boto3Waiter):
    ...
    def wait(self, *, TableName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/dynamodb.html#DynamoDB.Waiter.TableExistsWaiter)
...
class TableNotExistsWaiter(Boto3Waiter):
    ...
    def wait(self, *, TableName: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/dynamodb.html#DynamoDB.Waiter.TableNotExistsWaiter)
