...
setuptools.setup(
	...
	author_email="claudiotarbe@gmail.com",
	# Short description that will show on the PyPi page.
	description="An simple and easy method to find and replace values of xml",
	...
	url="https://github.com/claudiotorresarbe/lgpdXml",
