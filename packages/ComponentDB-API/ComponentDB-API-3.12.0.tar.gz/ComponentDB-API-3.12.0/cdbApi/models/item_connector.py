...
class ItemConnector(object):
    ...
    def __init__(self, id=None, label=None, quantity=None, property_value_list=None, item=None, connector=None, item_element_relationship_history_list=None, item_element_relationship_history_list1=None, item_resource_list=None, item_element_relationship_list=None, item_element_relationship_list1=None, item_connector_of_item_connected_to=None, item_connected_via=None, connected=None, local_vars_configuration=None):  # noqa: E501
