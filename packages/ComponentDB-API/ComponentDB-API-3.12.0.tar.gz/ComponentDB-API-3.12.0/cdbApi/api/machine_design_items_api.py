...
class MachineDesignItemsApi(object):
    ...
    def get_hierarchy_id_list(self, item_doman_machine_design_id_list_request, **kwargs):  # noqa: E501
        """get_hierarchy_id_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hierarchy_id_list(item_doman_machine_design_id_list_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param ItemDomanMachineDesignIdListRequest item_doman_machine_design_id_list_request: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_hierarchy_id_list_with_http_info(item_doman_machine_design_id_list_request, **kwargs)  # noqa: E501

    def get_hierarchy_id_list_with_http_info(self, item_doman_machine_design_id_list_request, **kwargs):  # noqa: E501
        """get_hierarchy_id_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hierarchy_id_list_with_http_info(item_doman_machine_design_id_list_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'item_doman_machine_design_id_list_request' is set
        if self.api_client.client_side_validation and ('item_doman_machine_design_id_list_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['item_doman_machine_design_id_list_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `item_doman_machine_design_id_list_request` when calling `get_hierarchy_id_list`")  # noqa: E501
