...
[boto3.AppRunner 1.17.100](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/apprunner.html#AppRunner)
...
def get_structure() -> AssociateCustomDomainResponseTypeDef:
    return {
      ...
    }
```
