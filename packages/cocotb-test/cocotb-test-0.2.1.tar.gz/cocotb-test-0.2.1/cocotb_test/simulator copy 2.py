...
class Questa(Simulator):
    ...
    def build_command(self):
        ...
        if self.verilog_sources:
            do_script = "vlib {RTL_LIBRARY}; vlog -mixedsvvh -work {RTL_LIBRARY} +define+COCOTB_SIM -sv {FORCE} {DEFINES} {INCDIR} {EXTRA_ARGS} {VERILOG_SOURCES}; quit".format(
                RTL_LIBRARY=as_tcl_value(self.rtl_library),
...
class Verilator(Simulator):
    ...
    def build_command(self):
        ...
        cmd.append(["make", "-C", self.sim_dir, "-f", "Vtop.mk", "-j"])
