...
.. |commits-since| image:: https://img.shields.io/github/commits-since/dohlee/python-cleanlog/v0.1.8.svg
    :alt: Commits since latest release
    :target: https://github.com/dohlee/python-cleanlog/compare/v0.1.8...master
