...
class Client(object):
    ...
    def get(self, req_id: str, locator, category, symbol='ALL', start='ALL', end='ALL') -> list:
        ...
        if start == 'ALL' or end == 'ALL':
            return self.__get_from_one_file__(req_id, locator, category, symbol)
        else:
            return self.__get_from_multi_files__(req_id, locator, category, symbol, start, end)
