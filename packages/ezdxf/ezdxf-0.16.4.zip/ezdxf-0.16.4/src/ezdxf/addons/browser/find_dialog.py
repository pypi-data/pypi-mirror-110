...
class Ui_FindDialog(object):
    def setupUi(self, FindDialog):
        ...
        FindDialog.setMinimumSize(QtCore.QSize(300, 376))
        FindDialog.setMaximumSize(QtCore.QSize(300, 376))
        FindDialog.setBaseSize(QtCore.QSize(300, 376))
    ...
    def retranslateUi(self, FindDialog):
        ...
        self.find_next_button.setToolTip(_translate("FindDialog", "or press F3"))
        self.find_next_button.setText(_translate("FindDialog", "Find &Next"))
        self.find_backward_button.setToolTip(_translate("FindDialog", "or press F4"))
