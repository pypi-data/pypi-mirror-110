...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', '4.3.0-alpha.1624375053+f7fd3a71'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random 4.3.0-alpha.1624375053+f7fd3a71`
                """)
            else:
                raise
