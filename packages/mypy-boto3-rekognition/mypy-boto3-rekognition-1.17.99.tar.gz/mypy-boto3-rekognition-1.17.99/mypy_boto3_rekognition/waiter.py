...
class ProjectVersionRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/rekognition.html#Rekognition.Waiter.ProjectVersionRunningWaiter)
...
class ProjectVersionTrainingCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/rekognition.html#Rekognition.Waiter.ProjectVersionTrainingCompletedWaiter)
