...
class dbmysql:
        ...
        try:
            ...
            if str(e) == '1':
                try:
                    ...
                    logging.error(f"ping mysql error")
                    return None
                ret = fn(*args)
            else:
                return None
    ...
    def __get(self, sql: str, params: any = {}) -> tuple:
        """
        从数据库获取数据
    ...
    def post(self, sql: str, params: any = {}) -> tuple:
        return self.__execute_err_reconnect(self.__post, sql, params)


    def __post(self, sql: str, params: any = {}) -> bool:
        """
        修改数据库数据
    ...
    def __exec_proc(self, name: str, args: tuple = (), ret_count: tuple = ()) -> tuple:
        """
        执行存储过程
            @name:str: 存储过程名None
            @args:tuple: 存储过程参数
