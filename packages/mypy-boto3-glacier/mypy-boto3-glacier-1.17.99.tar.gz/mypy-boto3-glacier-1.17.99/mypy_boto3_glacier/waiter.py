...
class VaultExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/glacier.html#Glacier.Waiter.VaultExistsWaiter)
...
class VaultNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/glacier.html#Glacier.Waiter.VaultNotExistsWaiter)
