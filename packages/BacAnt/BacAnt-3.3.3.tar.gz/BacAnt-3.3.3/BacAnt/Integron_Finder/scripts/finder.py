...
def run_integron_finder(current_dir,resultdir,nucleotide,args=None, loglevel=None):
    """
    ...
    args = ("--cmsearch %s --hmmsearch %s --prodigal %s --outdir %s --cpu 4 --func-annot -qq "%(cmsearch,hmmsearch,prodigal,resultdir)+nucleotide).split(" ")
