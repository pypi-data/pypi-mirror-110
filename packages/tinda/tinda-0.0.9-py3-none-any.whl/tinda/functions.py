...
functions_dict = {"bol":"Using pyttsx3, converts string to audio",
                ...
                "Zoe" : "current if else voice bot version",
...
botSkillsD ={"botType":"needs string input of what to type, waits 3 seconds and will paste the input at the cusor position",
        "botDate":"print current date",
        "botGetMousePosition":"gets mouse position as tuple of (x,y)",
        "botGotoMousePosition":"goes to specified mouse position as above parameters",
        "botCloseApp" : "implemented to close a full screen windows app by left mouse click",
        "botMinimizeApp" : "implementes to minimize a full screen app on windows",
        "botLeftClick":"clicks left mouse button and releases right away",
        "botTime":"prints and says current time in 12 hour format",
        }
