...
class PreParation:
    ...
    def read_model(self):
        ...
        if self.model is not None:
            ...
            try:
                ...
                # print('!!! File: %s does not exist or corrupted: %s!!!' % (fullmodelname, traceback.format_exc()))
                print('------------------------------------')
                exit()
        else:
    ...
    def cifchains(self, fullmodelname):
        ...
        # chaindict[fullmodelname] = singlechainfiles
    ...
    def updatechains(selfs, chaindict):
        ...
        # for (model, chains) in zip(model, chains):
