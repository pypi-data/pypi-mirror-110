...
"""
    ...
    The version of the OpenAPI document: 0.0.1212
...
class RolesApi(object):
    ...
    def add_policy_collection_to_role(self, scope, code, add_policy_collection_to_role_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Add policy collections to a role  # noqa: E501
        ...
        :param str scope: The scope of the Role (required)
        :param str code: The code of the Role (required)
        :param AddPolicyCollectionToRoleRequest add_policy_collection_to_role_request: The policy collections to add (required)
    ...
    def add_policy_collection_to_role_with_http_info(self, scope, code, add_policy_collection_to_role_request, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'add_policy_collection_to_role_request']  # noqa: E501
        ...
        if ('add_policy_collection_to_role_request' not in local_var_params or
                local_var_params['add_policy_collection_to_role_request'] is None):
        ...
        header_params['X-LUSID-SDK-Version'] = '0.0.1212'
    ...
    def remove_policy_collection_from_role(self, scope, code, policycollectionscope, policycollectioncode, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Remove policy collection from role  # noqa: E501
        ...
        :param str scope: The scope of the Role (required)
        :param str code: The code of the Role (required)
        :param str policycollectionscope: The scope of policy collection to remove from the Role (required)
        :param str policycollectioncode: The code of the policy collection to remove from the Role (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def remove_policy_collection_from_role_with_http_info(self, scope, code, policycollectionscope, policycollectioncode, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'code', 'policycollectionscope', 'policycollectioncode']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('policycollectionscope' not in local_var_params or
                local_var_params['policycollectionscope'] is None):
        ...
        if ('policycollectioncode' not in local_var_params or
                local_var_params['policycollectioncode'] is None):
