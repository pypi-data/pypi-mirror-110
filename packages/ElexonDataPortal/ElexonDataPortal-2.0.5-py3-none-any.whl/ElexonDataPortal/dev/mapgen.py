...
def get_PN_df(api_key, start_date=None, end_date=None):
...
def download_latest_PN_data(api_key=None, data_dir='data/PN'):
    if api_key is None:
    ...
    if current_year_month not in years_months_downloaded:
        ...
        df = get_PN_df(api_key, start_date, end_date)
        ...
        if dt_rng.size > 1:
            ...
            try:
                df_latest = get_PN_df(api_key, start_date, end_date)
...
def generate_map(
    ...
    download_latest_PN_data(api_key, data_dir)
