...
def main():
    ...
    def openFile(e):
        try:
            ...
            file = filedialog.askopenfilename(initialdir=change_dir, title="Choose A File", filetypes=(("Text Files", "*.txt"), ("Python Files", "*.py"),  ("All Files", "*.*")))
            if file:
                global openFilename
                openFilename = file
            name = file
    ...
    def saveAs(e):
        try:
            file = filedialog.asksaveasfilename(defaultextension=".*", initialdir=change_dir, title="Save file as", filetypes=(("Text Files", "*.txt"), ("Python Files", "*.py"),  ("All Files", "*.*")))
            if file:
                name = file
                status_bar.config(text=f'{name}  opened')
