...
def add_parameter(stage, key, key_option, value, value_option, input, format, working_dir, config, verbosity):
    ...
    \tVALUE: The value for the parameter. It may be also provided via '--value' option.\n
    \nMultiple parmeters may be added at once from an input file using '--input' option. Use '--format' to specify the format of the input if neeeded.
    """
...
def delete_secret(key, key_option, input, format, stage, working_dir, config, verbosity):
    ...
    \nMultiple secrets may be added at once from an input file using '--input' option. Use '--format' to specify the format of the input if neeeded.
    """
...
def delete_template(key, key_option, input, recursive, format, working_dir, config, verbosity):
    ...
    \tKEY: The key of the template. It may also be provided via '--key' option.\n
    \nMultiple templates may be deleted at once from an input file using '--input' option. Use '--format' to specify the format of the input if neeeded.
    """
...
def set_config(key, key_option, value, value_option, _global, input, working_dir, config, verbosity):
    ...
    \tVALUE: The value for the configuration. It may be also provided via '--value' option.\n
    """
