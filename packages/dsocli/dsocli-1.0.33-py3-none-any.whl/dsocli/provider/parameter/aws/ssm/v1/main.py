...
from dsocli.utils import set_dict_value, deflatten_dict
...
###--------------------------------------------------------------------------------------------
    ...
    def list(self, project, application, stage, uninherited):
        ...
        ### 'parameters' flattened so far, which is not usuable for Jinja2, as Jinja2 needs nested format (dictionary)

        result = deflatten_dict(parameters)
