    ...
    def __assert_param_file_exists(self, context, key):
        if context:
            if not self.__context_exists(context):
                # raise DSOException(MESSAGES['ContextNotFound'].format(context))
                raise DSOException(MESSAGES['ParameterNotFound'].format(key))
...
###--------------------------------------------------------------------------------------------
    ...
    def list(self, context, uninherited):
        ...
        # if not self.__context_exists(context):
        #     if uninherited:
        #         Logger.warn(MESSAGES['ContextNotFound'].format(context))
        #     else:
        #         Logger.warn(MESSAGES['ContextNotFoundListingInherited'].format(context))
...
###--------------------------------------------------------------------------------------------
    ...
    def get(self, context, key):
        ...
        #     raise DSOException(MESSAGES['ParameterNotFoundScope'].format(key))
        return value
