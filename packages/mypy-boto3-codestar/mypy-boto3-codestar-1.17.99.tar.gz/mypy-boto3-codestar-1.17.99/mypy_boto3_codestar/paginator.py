...
class ListProjectsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/codestar.html#CodeStar.Paginator.ListProjects.paginate)
...
class ListResourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/codestar.html#CodeStar.Paginator.ListResources.paginate)
...
class ListTeamMembersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/codestar.html#CodeStar.Paginator.ListTeamMembers.paginate)
...
class ListUserProfilesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/codestar.html#CodeStar.Paginator.ListUserProfiles.paginate)
