...
_RequiredCreateProjectResultTypeDef = TypedDict(
    "_RequiredCreateProjectResultTypeDef",
    {
        "id": str,
        "arn": str,
    },
...
_RequiredCreateUserProfileResultTypeDef = TypedDict(
    "_RequiredCreateUserProfileResultTypeDef",
    {
        "userArn": str,
    },
)
...
_RequiredListProjectsResultTypeDef = TypedDict(
    "_RequiredListProjectsResultTypeDef",
    {
        "projects": List["ProjectSummaryTypeDef"],
    },
)
_OptionalListProjectsResultTypeDef = TypedDict(
    "_OptionalListProjectsResultTypeDef",
    {
        "nextToken": str,
    },
    total=False,
...
_RequiredUpdateUserProfileResultTypeDef = TypedDict(
    "_RequiredUpdateUserProfileResultTypeDef",
    {
        "userArn": str,
    },
)
