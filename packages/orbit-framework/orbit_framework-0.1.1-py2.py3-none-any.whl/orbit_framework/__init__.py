...
class Job(object):
    ...
    *Siehe auch:*
    ...
    def __init__(self, name, background, **_):
        self._name = name
        self._core = None
    ...
    def trace(self, text):
        ...
        """
        if self._tracing is True or \
                (self._tracing is not False and
                 self._core and
    ...
    def event_trace(self, name, value):
        if self._event_tracing is True or \
                (self._event_tracing is not False and self._core.configuration.event_tracing):
...
class Service(Job):
    ...
    *Siehe auch:*
    ...
    def __init__(self, name, **nargs):
        super(Service, self).__init__(name, True, **nargs)
...
class App(Job):
    ...
    *Siehe auch:*
    ...
    def __init__(self, name, in_history=False,
                 ...
                 **nargs):
        super(App, self).__init__(name, False, **nargs)
...
class Component(object):
    ...
    *Siehe auch:*
    ...
    def event_trace(self, name, value):
        if self._event_tracing is True or \
                (self._event_tracing is not False and
                 self._job and
