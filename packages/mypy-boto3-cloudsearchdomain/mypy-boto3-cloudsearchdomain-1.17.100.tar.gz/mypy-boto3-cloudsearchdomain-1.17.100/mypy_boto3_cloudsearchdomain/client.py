...
class CloudSearchDomainClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudsearchdomain.html#CloudSearchDomain.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudsearchdomain.html#CloudSearchDomain.Client.can_paginate)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudsearchdomain.html#CloudSearchDomain.Client.generate_presigned_url)
    ...
    def search(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudsearchdomain.html#CloudSearchDomain.Client.search)
    ...
    def suggest(self, *, query: str, suggester: str, size: int = None) -> SuggestResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudsearchdomain.html#CloudSearchDomain.Client.suggest)
    ...
    def upload_documents(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudsearchdomain.html#CloudSearchDomain.Client.upload_documents)
