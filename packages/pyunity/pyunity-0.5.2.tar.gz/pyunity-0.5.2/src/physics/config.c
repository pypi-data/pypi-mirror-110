...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "D:\\RayChen2\\Ray's docs and txts...anythin!\\python\\share\\pyunity\\pyunity\\physics\\config.py"
        ]
    },
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_vector3, __pyx_t_1, 2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
