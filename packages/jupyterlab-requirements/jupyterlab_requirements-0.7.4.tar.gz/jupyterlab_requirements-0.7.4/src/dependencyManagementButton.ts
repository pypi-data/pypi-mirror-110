...
// /**
//  * A StackedPanel implementation that creates area where to handle dependencies.
//  */
//  export class DependenciesConsolePanel extends StackedPanel {
//     /**
//      * Construct a DependenciesConsolePanel instance.
//      *
//      * @param NotebookPanel - The notebook panel to handle
...
//     ) {
//       super();
//       this.addClass('jp-DependenciesConsolePanel');
...
export class ManageDependenciesButtonExtension
    ...
    openWidget = async (): Promise<void> => {
        ...
        // const dependenciesPanel = new DependenciesConsolePanel(
        //     this.panel,
        //     initial_requirements,
        //     initial_requirements_lock,
        //     initial_config_file,
        //     initial_resolution_engine
        // );
        
        // const dependenciesPanelWidget = new MainAreaWidget({ content: dependenciesPanel });
