import abc
from typing import TypeVar, Optional, Set
...
class AbstractDjangoBackend(BaseBackend, abc.ABC):
    """
    An abstract class that allows you to implement a django backend using the content assist. Does not
    ...
    def get_user_permissions(self, user_obj: TUSER, obj=None) -> Set[TPERMISSION]:
        ...
        :return: set of permissions explicitly added to the user
        """
        pass

    @abc.abstractmethod
    def get_group_permissions(self, user_obj, obj=None) -> Set[TPERMISSION]:
        """
        ...
        :param user_obj: user whose permissions we need to fetch
        :return: set of permissions explicitly added to the user via the groups
        """
        pass
