...
class AbstractGenericUser(AbstractBaseUser, ArrowAuditMixIn, PermissionsMixin):
    ...
    This class differs from the normal django user since you need to specify how to fetch permissions.
    All the elements regarding permission have been purposely made abstract
    """
    class Meta:
