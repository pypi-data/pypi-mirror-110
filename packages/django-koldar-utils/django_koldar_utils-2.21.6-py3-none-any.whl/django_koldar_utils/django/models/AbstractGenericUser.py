...
class AbstractGenericUser(AbstractBaseUser, ArrowAuditMixIn):
    ...
    - AbstractPermissionsMixin django_koldar_utils.django.models.AbstractPermissionsMixin which does not

    To chose, implement the class as follows:

    .. code-block :: python

        class MyUser(AbstractGenericUser, AbstractPermissionsMixin):
            # implementation
