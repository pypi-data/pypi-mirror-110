...
def upload_dataset(source_path: str, dataset_name: str, run_id: str = None, version: str = None,
    ...
    if version is not None:
        ...
        assert isinstance(v, packaging.version.Version), 'Cannot use legacy version names. Use a format major.minor.micro.'
    ...
    manager.add_event("add_dataset", args, async_method=False)
