'''
    ...
    Usage:
        ...
        from denova.python.performance import profile
            ...
            for f_name in functions_by_total_time:
                ...
                if func.calls:
                    ...
                    for call in func.calls:
                        if verbose:
                            to_stderr(f'            elapsed_time: {timedelta_to_human_readable(call.elapsed_time)}')
                        total_time += call.elapsed_time
