...
class ListDeadLetterSourceQueuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/sqs.html#SQS.Paginator.ListDeadLetterSourceQueues.paginate)
...
class ListQueuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/sqs.html#SQS.Paginator.ListQueues.paginate)
