...
class iET():
    ...
    def compute_attribution(dataframe):
        '''
        ...
        for user_id in dataframe[self._touchpoint_colname].unique():
            tmp = dataframe.loc[ dataframe[self._client_session_colname] == user_id ].copy()
