...
def get_departure_time(departure, date_format):
    return parse_string_to_string(departure['plannedDateTime'][:-5], date_format, '%H:%M')
...
def get_parsed_departures(response_json, date_format):
    ...
    for departure in departures:
        ...
        parsed_departure['departure_time'] = get_departure_time(departure, date_format)
