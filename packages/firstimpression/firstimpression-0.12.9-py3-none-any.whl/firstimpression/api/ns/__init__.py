...
from firstimpression.time import parse_string_to_date, parse_string_time_to_minutes, parse_date_to_string
...
def get_departure_time(departure):
    return parse_date_to_string(departure['plannedDateTime'][:-5], '%H:%M')
