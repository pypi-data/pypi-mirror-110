...
[boto3.Proton 1.17.100](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/proton.html#Proton)
...
def get_structure() -> AcceptEnvironmentAccountConnectionOutputTypeDef:
    return {
      ...
    }
```
