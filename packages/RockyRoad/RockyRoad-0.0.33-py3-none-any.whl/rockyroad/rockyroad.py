...
def build(serviceName, version, base_url, **kw):
    ...
    Usage Examples - Data Services:
        ...
        api_response = dataservice.apbs().requests().list(apb_request_uid="123e4567-e89b-12d3-a456-426614174000")
        api_response = dataservice.apbs().requests().insert(new_apb_request=new_apb_request)
        api_response = dataservice.apbs().requests().delete(apb_request_uid="123e4567-e89b-12d3-a456-426614174000")
