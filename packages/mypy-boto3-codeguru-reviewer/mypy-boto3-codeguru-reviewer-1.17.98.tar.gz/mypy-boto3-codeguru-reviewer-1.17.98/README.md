...
[boto3.CodeGuruReviewer 1.17.98](https://boto3.amazonaws.com/v1/documentation/api/1.17.98/reference/services/codeguru-reviewer.html#CodeGuruReviewer)
...
def check_value(value: EncryptionOptionType) -> bool:
    ...
```
