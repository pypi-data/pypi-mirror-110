...
class CodeReviewCompletedWaiter(Boto3Waiter):
    ...
    def wait(self, *, CodeReviewArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/codeguru-reviewer.html#CodeGuruReviewer.Waiter.CodeReviewCompletedWaiter)
...
class RepositoryAssociationSucceededWaiter(Boto3Waiter):
    ...
    def wait(self, *, AssociationArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/codeguru-reviewer.html#CodeGuruReviewer.Waiter.RepositoryAssociationSucceededWaiter)
