...
class OptIP(Option):
    ...
    def __set__(self, instance, value):
        try:
            ...
            raise AdapterValidationException("Invalid address. Provided address is not valid IPv4 or IPv6 address.")
    ...
    def __set__(self, instance, value):
        try:
            ...
            if 0 <= value <= 65535:  # max port number is 65535
                ...
                raise AdapterValidationException("Invalid option. Port value should be between 0 and 65536.")
        except ValueError:
            raise AdapterValidationException("Invalid option. Cannot cast '{}' to integer.".format(value))
...
class OptBool(Option):
    ...
    def __set__(self, instance, value):
        ...
        if value.lower() == "true":
            ...
            raise AdapterValidationException("Invalid value. It should be true or false.")
...
class OptFloat(Option):
    ...
    def __set__(self, instance, value):
        try:
            ...
            raise AdapterValidationException("Invalid option. Cannot cast '{}' to float.".format(value))
...
class OptString(Option):
    ...
    def __set__(self, instance, value):
        try:
            ...
            raise AdapterValidationException("Invalid option. Cannot cast '{}' to string.".format(value))
...
class OptItems(Option):
    ...
    def __set__(self, instance, value):
        ...
        #     raise AdapterValidationException("Cannot set {},you must select {}".format(value, self.default))
        self.value = value


class OptDict:
    def __init__(self, require=False, selected=False, default=None):
