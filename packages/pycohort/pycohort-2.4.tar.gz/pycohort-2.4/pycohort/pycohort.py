...
#     user_retention_abs = cohorts['TotalAccounts'].unstack(0)
...
#     %matplotlib inline
    ...
    # No to scientific rounding:
    pd.set_option('display.float_format', lambda x: '%.3f' % x)

    # Parameter tuning for the visualization:
    ...
    sns.heatmap(df.T, mask=df.T.isnull(), annot=True, fmt='.2f', cmap='OrRd_r')
