...
def distance_distribution_mixed(al, B, verbose=1):
    r"""distance_distribution_mixed(array_link al, ndarray B, int verbose=1)"""
    return _oalib.distance_distribution_mixed(al, B, verbose)
...
class ndarray(object):
    r"""
    Proxy of C++ ndarray< double > class.
    Proxy of C++ ndarray< double > class.
    """

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    data = property(_oalib.ndarray_data_get, _oalib.ndarray_data_set, doc=r"""data : p.double""")
    dims = property(_oalib.ndarray_dims_get, _oalib.ndarray_dims_set, doc=r"""dims : std::vector<(int,std::allocator<(int)>)>""")
    k = property(_oalib.ndarray_k_get, _oalib.ndarray_k_set, doc=r"""k : int""")
    n = property(_oalib.ndarray_n_get, _oalib.ndarray_n_set, doc=r"""n : int""")
    cumdims = property(_oalib.ndarray_cumdims_get, _oalib.ndarray_cumdims_set, doc=r"""cumdims : std::vector<(int,std::allocator<(int)>)>""")
    cumprod = property(_oalib.ndarray_cumprod_get, _oalib.ndarray_cumprod_set, doc=r"""cumprod : std::vector<(int,std::allocator<(int)>)>""")

    def __init__(self, dimsx):
        r"""__init__(ndarray self, intVector dimsx) -> ndarray"""
        _oalib.ndarray_swiginit(self, _oalib.new_ndarray(dimsx))

    def initialize(self, value):
        r"""initialize(ndarray self, double const value)"""
        return _oalib.ndarray_initialize(self, value)

    def info(self):
        r"""info(ndarray self)"""
        return _oalib.ndarray_info(self)

    def idxstring(self, linear_idx):
        r"""idxstring(ndarray self, int linear_idx) -> std::string"""
        return _oalib.ndarray_idxstring(self, linear_idx)

    def totalsize(self):
        r"""totalsize(ndarray self) -> long"""
        return _oalib.ndarray_totalsize(self)

    def show(self):
        r"""show(ndarray self)"""
        return _oalib.ndarray_show(self)

    def linear2idx(self, *args):
        r"""
        linear2idx(ndarray self, int ndx, int * nidx=None)
        linear2idx(ndarray self, int ndx, intVector nidx)
        """
        return _oalib.ndarray_linear2idx(self, *args)

    def getlinearidx(self, idx):
        r"""getlinearidx(ndarray self, int * idx) -> int"""
        return _oalib.ndarray_getlinearidx(self, idx)

    def setconstant(self, val):
        r"""setconstant(ndarray self, double val)"""
        return _oalib.ndarray_setconstant(self, val)

    def set(self, idx, val):
        r"""set(ndarray self, int * idx, double val)"""
        return _oalib.ndarray_set(self, idx, val)

    def setlinear(self, idx, val):
        r"""setlinear(ndarray self, int idx, double val)"""
        return _oalib.ndarray_setlinear(self, idx, val)

    def getlinear(self, idx):
        r"""getlinear(ndarray self, int idx) -> double"""
        return _oalib.ndarray_getlinear(self, idx)

    def get(self, idx):
        r"""get(ndarray self, int * idx) -> double"""
        return _oalib.ndarray_get(self, idx)
    __swig_destroy__ = _oalib.delete_ndarray

# Register ndarray in _oalib:
_oalib.ndarray_swigregister(ndarray)
...
class ndarray_double(object):
    ...
    def __init__(self, dimsx):
        r"""__init__(ndarray_double self, intVector dimsx) -> ndarray_double"""
        _oalib.ndarray_double_swiginit(self, _oalib.new_ndarray_double(dimsx))
...
class ndarray_long(object):
    ...
    def __init__(self, dimsx):
        r"""__init__(ndarray_long self, intVector dimsx) -> ndarray_long"""
        _oalib.ndarray_long_swiginit(self, _oalib.new_ndarray_long(dimsx))
