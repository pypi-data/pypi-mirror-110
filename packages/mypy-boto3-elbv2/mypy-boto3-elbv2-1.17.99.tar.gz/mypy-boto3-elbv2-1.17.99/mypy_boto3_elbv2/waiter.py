...
class LoadBalancerAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.LoadBalancerAvailableWaiter)
...
class LoadBalancerExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.LoadBalancerExistsWaiter)
...
class LoadBalancersDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.LoadBalancersDeletedWaiter)
...
class TargetDeregisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.TargetDeregisteredWaiter)
...
class TargetInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.TargetInServiceWaiter)
