...
def pyminer_analysis(infile=None,
    ...
    adj_call_string = 'mat_to_adj_list.py -i '+infile+' -o '+out_adj+' -id_list '+os.path.join(temp,'ID_list.txt ')+' -num_pos_cor_cutoff '+str(num_pos_cor_cutoff)
    if rho_cutoff!=None:
