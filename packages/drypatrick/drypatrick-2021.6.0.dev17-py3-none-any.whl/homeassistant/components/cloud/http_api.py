...
_CLOUD_ERRORS = {
    ...
    asyncio.TimeoutError: (
        HTTP_BAD_GATEWAY,
        "Unable to reach the Claret Assistant cloud.",
    ),
    aiohttp.ClientError: (
        HTTP_INTERNAL_SERVER_ERROR,
...
class CloudLoginView(HomeAssistantView):
    """Login to Claret Assistant cloud."""
...
class CloudLogoutView(HomeAssistantView):
    """Log out of the Claret Assistant cloud."""
...
class CloudRegisterView(HomeAssistantView):
    """Register on the Claret Assistant cloud."""
    ...
    if changes.get(PREF_ALEXA_REPORT_STATE):
        ...
        try:
            ...
            connection.send_error(
                msg["id"],
                "alexa_relink",
                "Please go to the Alexa app and re-link the Claret Assistant "
    ...
    with async_timeout.timeout(10):
        try:
            ...
            connection.send_error(
                msg["id"],
                "alexa_relink",
                "Please go to the Alexa app and re-link the Claret Assistant skill.",
            )
            return
