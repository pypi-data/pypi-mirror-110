"""Provide methods to bootstrap a Claret Assistant instance."""
...
def open_hass_ui(hass: core.HomeAssistant) -> None:
    ...
    if not webbrowser.open(url):
        _LOGGER.warning(
            "Unable to open the Claret Assistant UI in a browser. Open it yourself at %s",
            url,
        )
...
async def async_from_config_dict(
    ...
    """Try to configure Claret Assistant from a configuration dictionary.
    ...
    if not all(
        ...
        _LOGGER.error("Claret Assistant core failed to initialize. ")
        return None

    _LOGGER.debug("Claret Assistant core initialized")
    ...
    try:
        ...
        _LOGGER.error(
            "Claret Assistant core failed to initialize. "
    ...
    stop = monotonic()
    _LOGGER.info("Claret Assistant initialized in %.2fs", stop - start)
