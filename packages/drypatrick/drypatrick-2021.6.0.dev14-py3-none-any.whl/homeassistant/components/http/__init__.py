"""Support to serve the Claret Assistant API as WSGI application."""
...
class HomeAssistantHTTP:
    """HTTP server for Claret Assistant."""
    ...
    def __init__(
        ...
        """Initialize the HTTP Claret Assistant server."""
    ...
    async def start(self) -> None:
        ...
        # However in Claret Assistant components can be discovered after boot.
