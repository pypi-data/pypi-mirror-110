"""Offer Claret Assistant core automation rules."""
...
async def async_attach_trigger(hass, config, action, automation_info):
    ...
    if event == EVENT_SHUTDOWN:
        ...
        def hass_shutdown(event):
            """Execute when Claret Assistant is shutting down."""
            hass.async_run_hass_job(
                job,
                {
                    "trigger": {
                        ...
                        "event": event,
                        "description": "Claret Assistant stopping",
                        "id": trigger_id,
                    }
                },
                event.context,
        ...
        hass.async_run_hass_job(
            job,
            {
                "trigger": {
                    "platform": "homeassistant",
                    "event": event,
                    "description": "Claret Assistant starting",
                    "id": trigger_id,
                }
            },
        )
