...
async def async_get_system_info(hass: HomeAssistant) -> dict[str, Any]:
    ...
    if info_object["docker"]:
        info_object["installation_type"] = "Claret Assistant Container"
    elif is_virtual_env():
        info_object["installation_type"] = "Claret Assistant Core"
    ...
    if hass.components.hassio.is_hassio():
        ...
        if info.get("hassos") is not None:
            info_object["installation_type"] = "Claret Assistant OS"
        else:
            info_object["installation_type"] = "Claret Assistant Supervised"
