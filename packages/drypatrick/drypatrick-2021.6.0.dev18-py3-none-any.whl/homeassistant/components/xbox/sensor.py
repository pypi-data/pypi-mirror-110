...
def async_update_friends(
    ...
    # Process new favorites, add them to Claret Assistant
    new_entities = []
    ...
    # Process deleted favorites, remove them from Claret Assistant
...
async def async_remove_entities(
    ...
    """Remove friend sensors from Claret Assistant."""
