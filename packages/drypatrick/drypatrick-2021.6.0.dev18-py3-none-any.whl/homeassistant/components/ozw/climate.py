...
# Map Z-Wave HVAC Mode to Claret Assistant value
...
# Map Claret Assistant HVAC Mode to Z-Wave value
...
class ZWaveClimateEntity(ZWaveDeviceEntity, ClimateEntity):
    ...
    def _set_modes_and_presets(self):
        """Convert Z-Wave Thermostat modes into Claret Assistant modes and presets."""
        all_modes = {}
