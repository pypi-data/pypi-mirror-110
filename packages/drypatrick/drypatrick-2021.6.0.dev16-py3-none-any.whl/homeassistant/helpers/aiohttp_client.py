...
WARN_CLOSE_MSG = "closes the Claret Assistant aiohttp session"
...
def _async_register_clientsession_shutdown(
    ...
    """Register ClientSession close on Claret Assistant shutdown or config entry unload.
...
def _async_register_default_clientsession_shutdown(
    ...
    """Register default ClientSession close on Claret Assistant shutdown.
