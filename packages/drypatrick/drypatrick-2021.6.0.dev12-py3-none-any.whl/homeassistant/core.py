"""
Core components of Claret Assistant.

Claret Assistant is a Home Automation framework for observing the state
...
class CoreState(enum.Enum):
    """Represent the current state of Claret Assistant."""
...
class HomeAssistant:
    """Root object of the Claret Assistant home automation."""
    ...
    def __init__(self) -> None:
        """Initialize new Claret Assistant object."""
    ...
    def is_running(self) -> bool:
        """Return if Claret Assistant is running."""
        return self.state in (CoreState.starting, CoreState.running)

    @property
    def is_stopping(self) -> bool:
        """Return if Claret Assistant is stopping."""
        return self.state in (CoreState.stopping, CoreState.final_write)

    def start(self) -> int:
        """Start Claret Assistant.
        ...
        # Run forever
        # Block until stopped
        _LOGGER.info("Starting Claret Assistant core loop")
        self.loop.run_forever()
        return self.exit_code

    async def async_run(self, *, attach_signals: bool = True) -> int:
        """Claret Assistant main entry point.

        Start Claret Assistant and block until stopped.

        This method is a coroutine.
        """
        if self.state != CoreState.not_running:
            raise RuntimeError("Claret Assistant is already running")
    ...
    async def async_start(self) -> None:
        ...
        This method is a coroutine.
        """
        _LOGGER.info("Starting Claret Assistant")
        ...
        try:
            ...
            _LOGGER.warning(
                "Something is blocking Claret Assistant from wrapping up the "
        ...
        if self.state != CoreState.starting:
            _LOGGER.warning(
                "Claret Assistant startup has been interrupted. "
    ...
    def stop(self) -> None:
        """Stop Claret Assistant and shuts down all threads."""
    ...
    async def async_stop(self, exit_code: int = 0, *, force: bool = False) -> None:
        ...
        if not force:
            ...
            if self.state == CoreState.starting:
                # This may not work
                _LOGGER.warning(
                    "Stopping Claret Assistant before startup has completed may fail"
                )
...
class Config:
    """Configuration settings for Claret Assistant."""
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        ...
        # If Claret Assistant is running in safe mode
    ...
    def distance(self, lat: float, lon: float) -> float | None:
        """Calculate distance from Claret Assistant.
