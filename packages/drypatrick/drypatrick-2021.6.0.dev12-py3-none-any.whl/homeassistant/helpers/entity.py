...
class Entity(ABC):
    """An abstract class for Claret Assistant entities."""
    ...
    # DO NOT OVERWRITE
    # These properties and methods are either managed by Claret Assistant or they
    ...
    async def async_update_ha_state(self, force_refresh: bool = False) -> None:
        """Update Claret Assistant with current state of entity.
    ...
    async def async_remove(self, *, force_remove: bool = False) -> None:
        """Remove entity from Claret Assistant.
