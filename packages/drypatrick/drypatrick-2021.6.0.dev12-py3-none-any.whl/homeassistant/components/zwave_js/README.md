...
This document describes the architecture of Z-Wave JS in Claret Assistant and how the integration is connected all the way to the Z-Wave USB stick controller.
...
Represents Z-Wave devices in Claret Assistant and allows control.
...
Both apps are available as Claret Assistant add-ons. There are also Docker containers etc.
