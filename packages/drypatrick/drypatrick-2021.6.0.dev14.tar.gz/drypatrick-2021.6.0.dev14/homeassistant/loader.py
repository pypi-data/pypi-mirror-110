"""
The methods for loading Claret Assistant integrations.
...
CUSTOM_WARNING = (
    ...
    "been tested by Claret Assistant. This component might "
    "cause stability problems, be sure to disable it if you "
    "experience issues with Claret Assistant"
)
CUSTOM_WARNING_VERSION_MISSING = (
    "No 'version' key in the manifest file for "
    "custom integration '%s'. As of Claret Assistant "
...
class Integration:
    """An integration in Claret Assistant."""
