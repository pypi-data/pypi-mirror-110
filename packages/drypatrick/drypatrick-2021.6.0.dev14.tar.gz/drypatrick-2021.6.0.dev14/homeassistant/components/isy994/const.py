...
# ISY Scenes are more like Switches than Claret Assistant Scenes
...
# Do not use the Claret Assistant consts for the states here - we're matching exact API
# responses, not using them for Claret Assistant states
