...
class MySensorsDevice:
    ...
    async def async_will_remove_from_hass(self):
        """Remove this entity from Claret Assistant."""
    ...
    def unique_id(self) -> str:
        """Return a unique ID for use in Claret Assistant."""
        return f"{self.gateway_id}-{self.node_id}-{self.child_id}-{self.value_type}"

    @property
    def device_info(self) -> DeviceInfo:
        """Return a dict that allows Claret Assistant to puzzle all entities belonging to a node together."""
        return {
