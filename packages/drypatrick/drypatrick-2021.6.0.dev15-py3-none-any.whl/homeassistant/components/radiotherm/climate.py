...
# Mappings from radiotherm json data codes to and from Claret Assistant state
# flags.  CODE is the thermostat integer code and these map to and
# from Claret Assistant state flags.
...
class RadioThermostat(ClimateEntity):
    ...
    def update(self):
        ...
        # to a bare minimum or we'll hit the Claret Assistant 10 sec warning.  We
