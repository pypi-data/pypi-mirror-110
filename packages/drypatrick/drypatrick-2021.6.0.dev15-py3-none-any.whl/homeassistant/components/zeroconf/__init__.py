"""Support for exposing Claret Assistant via Zeroconf."""
...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    """Set up Zeroconf and make Claret Assistant discoverable."""
    ...
    async def _async_zeroconf_hass_start(_event: Event) -> None:
        """Expose Claret Assistant on zeroconf when it starts.
...
async def _async_register_hass_zc_service(
    ...
    try:
        ...
        _LOGGER.error(
            "Claret Assistant instance with identical name present in the local network"
        )
