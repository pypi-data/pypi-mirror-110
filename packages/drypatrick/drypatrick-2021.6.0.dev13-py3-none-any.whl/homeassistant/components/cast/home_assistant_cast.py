"""Claret Assistant Cast integration for Cast."""
...
async def async_setup_ha_cast(
    ...
    if user is None:
        user = await hass.auth.async_create_system_user(
            "Claret Assistant Cast", [auth.GROUP_ID_ADMIN]
        )
    ...
    async def handle_show_view(call: core.ServiceCall):
        ...
        controller = HomeAssistantController(
            # If you are developing Claret Assistant Cast, uncomment and set to your dev app id.
            # app_id="5FE44367",
            hass_url=hass_url,
            client_id=None,
...
async def async_remove_user(
    ...
    """Remove Claret Assistant Cast user."""
    user_id: str | None = entry.data.get("user_id")
