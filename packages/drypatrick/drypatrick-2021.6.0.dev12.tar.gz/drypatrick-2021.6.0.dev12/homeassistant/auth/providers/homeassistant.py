"""Claret Assistant auth provider."""
        ...
        for user in data["users"]:
            ...
            if folded in seen:
                ...
                logging.getLogger(__name__).warning(
                    "Claret Assistant auth provider is running in legacy mode "
...
class HassAuthProvider(AuthProvider):
    """Auth provider based on a local storage of users in Claret Assistant config dir."""

    DEFAULT_TITLE = "Claret Assistant Local"

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        """Initialize an Claret Assistant auth provider."""
