...
def add_switch_entities(new_unique_ids, coordinator, add_entities):
    ...
    Args:
        new_unique_ids (set): Unique identifiers of entities to be added to Claret Assistant.
        coordinator (DataUpdateCoordinator): Data coordinator of this platform.
        add_entities (function): Method called to add entities to Claret Assistant.
    """
    new_entities = []
