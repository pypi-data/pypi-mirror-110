"""Script to manage users for the Claret Assistant auth provider."""
import argparse
import asyncio
import logging
import os
...
def run(args):
    """Handle Claret Assistant auth provider script."""
    parser = argparse.ArgumentParser(description="Manage Claret Assistant users")
