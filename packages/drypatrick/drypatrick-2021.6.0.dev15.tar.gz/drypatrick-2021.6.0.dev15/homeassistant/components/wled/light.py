...
def async_update_segments(
    ...
    # Process new segments, add them to Claret Assistant
    new_entities = []
    ...
    # Process deleted segments, remove them from Claret Assistant
...
async def async_remove_entity(
    ...
    """Remove WLED segment light from Claret Assistant."""
