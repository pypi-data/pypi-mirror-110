...
class AlexaEntity:
    ...
    def description(self):
        ...
        return f"{description} via Claret Assistant".translate(TRANSLATION_TABLE)
    ...
    def default_display_categories(self):
        ...
        This can be overridden by the user in the Claret Assistant configuration.
    ...
    def serialize_discovery(self):
        ...
        result = {
            ...
            "manufacturerName": "Claret Assistant",
            "additionalAttributes": {
                "manufacturer": "Claret Assistant",
