...
# Unfortunately the Claret Assistant UI does not easily expose a way to remove a
...
class HyperionPriorityLight(HyperionBaseLight):
    ...
    def _allow_priority_update(self, priority: dict[str, Any] | None = None) -> bool:
        ...
        # Black is treated as 'off' (and Claret Assistant does not support selecting black
