...
class ShellyDeviceWrapper(update_coordinator.DataUpdateCoordinator):
    """Wrapper for a Shelly device with Claret Assistant specific functions."""
    ...
    def _handle_ha_stop(self, _):
        """Handle Claret Assistant stopping."""
...
class ShellyDeviceRestWrapper(update_coordinator.DataUpdateCoordinator):
    """Rest Wrapper for a Shelly device with Claret Assistant specific functions."""
