...
class PyocsAutoConfig:
    ...
    def __init__(self):
        ...
        self.kb = pyocs_confluence.PyocsConfluence()
    ...
    def get_ruler_for_customer_excel(self, ocs_num, excel_para, workspace):
        ...
        download_link = self.kb.get_download_link_of_dt_by_customer(ocs_demand.get_ocs_customer())
        if download_link:
    ...
    def auto_config(self, project_name: str, uni: UniteInterface, test: str, message: str, is_make_bin: str):
        ...
        map_list = self.kb.get_code_mapping_info_by_project(project_name)
