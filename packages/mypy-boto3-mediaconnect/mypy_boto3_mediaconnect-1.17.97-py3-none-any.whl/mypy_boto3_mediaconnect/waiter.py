...
class FlowActiveWaiter(Boto3Waiter):
    ...
    def wait(self, *, FlowArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/mediaconnect.html#MediaConnect.Waiter.FlowActiveWaiter)
...
class FlowDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, *, FlowArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/mediaconnect.html#MediaConnect.Waiter.FlowDeletedWaiter)
...
class FlowStandbyWaiter(Boto3Waiter):
    ...
    def wait(self, *, FlowArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/mediaconnect.html#MediaConnect.Waiter.FlowStandbyWaiter)
