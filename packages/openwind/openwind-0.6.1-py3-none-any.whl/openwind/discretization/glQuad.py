...
class GLQuad:
    """
    Calculate the quantities for the GaussLobato quadrature.

    This quadrature is based on the Gauss-Lobato technique applied to
    Lagrangian polynomials taken on the precise quadrature points.
    ...
    pts : array of r+1 float
        the point position on the element
    weigth : array of r+1 float
        the weight of each node on this element
    ...
    def lagran_polys_derivate(self):
        """Compute de derivate of the lagrange polynomials
        """
        positions = self.pts
