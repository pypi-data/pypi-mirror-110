...
# TODO: Implement support for time series code generation
...
def generate_full_script(child_run: Run) -> str:
    ...
    if is_timeseries:
        ...
        output.append("\n")
        output.append(get_preprocessor_code(pipeline))
        output.append("\n")
        output.append(get_modelwrapper_code(pipeline))
        output.append("\n")
        output.append(get_build_model_pipeline_code())
    output.append("\n")
...
def get_preprocessor_code(sklearn_pipeline: Pipeline) -> str:
...
def get_modelwrapper_code(sklearn_pipeline: Pipeline) -> str:
...
def get_build_model_pipeline_code() -> str:
