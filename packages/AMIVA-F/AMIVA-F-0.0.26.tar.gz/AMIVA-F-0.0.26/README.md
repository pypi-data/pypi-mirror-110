...
1. Open the terminal and enter the following commands.<br> 
Accept everytime with **y** if you get prompted to continue<br>
2. Install pip
...
7. In my case, the default site where packages where installed through pip was:
 ...
 In your case this might differ. python.xx specifies the python version you used.<br>
 (in my case python3.8) while /user/ will be your specific username. 
