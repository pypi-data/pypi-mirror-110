...
1. Open the terminal and enter the following commands. Accept everytime with **y** if you get prompted to continue<br>
2. 	sudo apt-get install python3-pip
_(optional step if you already have pip installed skip)_
3. 	sudo apt-get install default-jdk
4. 	sudo apt-get install python3-tk
5. 	sudo apt-get install pymol
6. 	pip install AMIVA-F
7. In my case, the default site where packages where installed through pip was:

	cd /home/user/.local/lib/pythonx.x/site-packages/AMIVA-F/
In your case this might differ. python.xx specifies the python version you used (in my case python3.8) while /user/ will be your specific username. 
Alternatively you can try:
	cd ~/.local/lib/pythonx.x/site-packages/AMIVA-F/
8. Open AMIVA-F
	pythonx.x AMIVA-F.py
_Again specifiy the python version you use here. e.g Python3.8 AMIVA-F.py_
...
_If you are interested in the mutation Methionine(M) at position 82 to Lysine(K)_ 
