...
class Entry_formular:
    def __init__(self, master):
        ...
        self.label4 = tk.Label(self.frame, text="Allowed range:\n35 - 2725", font="helvetica 10 italic")
...
class Entryfield:
    def __init__(self, master):
        ...
        self.wekabtnoutputfile = tk.Button(self.frame6_1, text="Save mutation prediction", borderwidth=4, command=self.outputfilemutant)
        self.wekabtnoutputfile.grid(row=3, column=3, sticky="we")
        self.exitamiva = tk.Button(self.frame6_1, text="Exit AMIVA-F", command=self.exiting_amiva, borderwidth=4)
        self.exitamiva.grid(row=3, column=4, sticky="we")
