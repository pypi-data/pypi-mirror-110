...
class StockTrading:
    ...
    def get_stock_trading_data(self):
        ...
        turn = data.copy()
        all_data = vix_index.merge(amt, on='trade_date', how='outer').merge(turn, on='trade_date', how='outer').rename(
            columns={"VIX.GI": "VIX"})
...
if __name__ == '__main__':
    StockTrading('2010-01-01', '2021-04-23', is_increment=0).get_construct_result()