...
class SectorIndexCalculator:
    ...
    def get_construct_result(self):
        ...
        if self.write2db:
            ...
            df = sector_return.reset_index().rename(columns={"大金融": "BIGFINANCE", "消费": "CONSUMING",
                                                             "周期": "CYCLE", "制造": "MANUFACTURE"})

            df.to_sql('sector_return', engine, index=False, if_exists='append')

        return sector_return


if __name__ == '__main__':
    res = SectorIndexCalculator('20210529', '20210609', write2db=True).get_construct_result()
