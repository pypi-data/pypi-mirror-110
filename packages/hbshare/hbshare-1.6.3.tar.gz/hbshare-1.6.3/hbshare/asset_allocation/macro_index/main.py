...
class EconomyIncreaseIndex:
    ...
    def draw_picture_excavator(self):
    ...
    def draw_picture_jy_curr_index(self):
    ...
    def draw_picture_kq_index(self):
...
if __name__ == '__main__':
    # CurrencyIndex(end_date='20210610').draw_picture_pledged_repo()
    ...
    # EconomyIncreaseIndex(end_date='20210517').draw_picture_jy_curr_index()
