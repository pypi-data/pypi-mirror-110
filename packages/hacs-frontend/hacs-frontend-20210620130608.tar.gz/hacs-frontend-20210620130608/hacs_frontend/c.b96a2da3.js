      ...
      <app-header-layout has-scrolling-region>
        ...
        <ha-config-section .narrow=${this.narrow} .isWide=${this.isWide}>
          ...
          <div slot="introduction">
            ${this.isWide||0===this.hacs.updates.length&&0===(null===(t=this.hacs.messages)||void 0===t?void 0:t.length)?this.hacs.localize("entry.intro"):""}
          </div>

          ${0!==(null===(e=this.hacs.messages)||void 0===e?void 0:e.length)?c`
                ...
                ></hacs-section-navigation>
              `:""}
          ${0!==(null===(i=this.hacs.updates)||void 0===i?void 0:i.length)?c` <ha-card>
