      ...
      >
        <div class=${n({content:!0,narrow:this.narrow})}>
          ...
          ${this._releaseNotes.length>0?this._releaseNotes.map(s=>t`
                    <ha-expansion-panel
                      .header=${s.name?`${s.tag}: ${s.name}`:s.tag}
                      outlined
