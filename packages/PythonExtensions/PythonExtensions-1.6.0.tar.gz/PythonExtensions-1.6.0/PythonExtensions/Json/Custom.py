...
class PlacePosition(Point):
    ...
    @overload
    def Update(self, pic: 'PlacePosition', img: Size, view: Size) -> 'PlacePosition': ...
    # def Update(self, pic: 'PlacePosition', img: Size, view: Size, AnyValue: Any) -> 'PlacePosition': ...

    @overload
    def Update(self, pic: 'PlacePosition', img: Size, view: Size, OnlyZero: Any) -> 'PlacePosition': ...

    @overload
    def Update(self, pic: 'PlacePosition', img: Size, view: Size, ZeroOrMore: Any) -> 'PlacePosition': ...

    @overload
    def Update(self, pic: 'PlacePosition', img: Size, view: Size, ZeroOrLess: Any) -> 'PlacePosition': ...
