...
['PySocks>=1.5.6,!=1.5.7,<2.0.0',
 ...
 'java-access-bridge-wrapper>=0.3.2,<0.4.0',
 ...
 'pillow>=8.0.1,<9.0.0',
 'pynput-robocorp-fork>=3.0.0,<4.0.0',
 ...
 'rpaframework-core>=6.2.2,<7.0.0',
 'rpaframework-dialogs>=0.3.1,<0.4.0',
 'rpaframework-pdf>=0.6.0,<0.7.0',
