...
class Satellite(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, norad_cat_id, name, operator, countries, telemetries, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, norad_cat_id, name, *args, **kwargs):  # noqa: E501
        """Satellite - a model defined in OpenAPI
