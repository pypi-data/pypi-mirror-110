...
from v_cloud_market_cli_common.utils.vsyschain.error import throw_error
from v_cloud_market_cli_common.utils.service_error import WalletDecryptionException, WalletEncryptionException
...
class WalletCipher:
    ...
    def decrypt(self, raw):
        ...
        try:
            ...
            msg = "Failed to decrypt info string"
            throw_error(msg, WalletDecryptionException)
