...
import azureml.contrib.automl.dnn.vision.classification.common.classification_utils as cls_utils
...
def test_score_validation_data(monkeypatch):
    ...
    with tempfile.TemporaryDirectory() as tmp_output_dir:
        ...
        with monkeypatch.context() as m:
            m.setattr(cls_utils, 'load_model_from_artifacts', MagicMock())
