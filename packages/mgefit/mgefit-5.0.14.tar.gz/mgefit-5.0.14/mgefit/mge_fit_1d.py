...
class mge_fit_1d:
    ...
    Michele Cappellari, Astrophysics, University of Oxford, UK
    ...
    .sol:
        ...
        - If the fit was done to the projected surface density profile
          ``(Msun/pc^2)`` the Gaussians central surface densities
        ...
        - If the fit was done to the intrinsic density profile ``(Msun/pc^3)``
          the Gaussians central densities ``(Msun/pc^3)`` are still given by::
        ...
        - In either case, one can convert between densities in ``(Msun/pc^3)``
          ...
          (equation 6 of the readme_mge_fit_sectors.pdf)::
