...
OUTPUTS (attributes of the sectors_photometry class):
    ...
    ANGLE = Vector containing the polar angle of the surface brightness
        measurements, taken from the galaxy major axis (in degrees).
...
OPTIONAL INPUT KEYWORDS:
    ...
    MASK - Boolean image mask with the same dimension as IMG.
        ...
        This keyword is just an alternative way of specifying the BADPIXELS
        (Note: MASK = ~BADPIXELS)
    ...
    SECTOR_WIDTH - Scalar giving the width of the sectors in degrees of
        eccentric anomaly (default: 5 degrees)
