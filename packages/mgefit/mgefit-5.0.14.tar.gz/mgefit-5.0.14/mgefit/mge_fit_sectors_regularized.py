...
#   V2.0.3: When plot=True a single plot is created at the end.
#       A plot can be produced after the function is finished.
#       Print best solution at the end. MC, Oxford, 14 February 2017
#   V2.0.4: Changed imports for mgefit package. MC, Oxford, 17 April 2018    
#
################################################################################
...
class mge_fit_sectors_regularized:
    ...
    def __init__(self, radius, angle, counts, eps, qbounds=None, plot=False, **kwargs):
