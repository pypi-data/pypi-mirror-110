...
class MarketplaceMeteringClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/meteringmarketplace.html#MarketplaceMetering.Client)
    ...
    def batch_meter_usage(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/meteringmarketplace.html#MarketplaceMetering.Client.batch_meter_usage)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/meteringmarketplace.html#MarketplaceMetering.Client.can_paginate)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/meteringmarketplace.html#MarketplaceMetering.Client.generate_presigned_url)
    ...
    def meter_usage(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/meteringmarketplace.html#MarketplaceMetering.Client.meter_usage)
    ...
    def register_usage(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/meteringmarketplace.html#MarketplaceMetering.Client.register_usage)
    ...
    def resolve_customer(self, *, RegistrationToken: str) -> ResolveCustomerResultTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/meteringmarketplace.html#MarketplaceMetering.Client.resolve_customer)
