...
class ListTableColumnsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/honeycode.html#Honeycode.Paginator.ListTableColumns.paginate)
...
class ListTableRowsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/honeycode.html#Honeycode.Paginator.ListTableRows.paginate)
...
class ListTablesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/honeycode.html#Honeycode.Paginator.ListTables.paginate)
...
class QueryTableRowsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/honeycode.html#Honeycode.Paginator.QueryTableRows.paginate)
