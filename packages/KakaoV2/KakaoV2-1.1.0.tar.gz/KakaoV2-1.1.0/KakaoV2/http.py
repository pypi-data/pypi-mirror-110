import requests, aiohttp, json, asyncio, ssl, socket, struct
from aiohttp.client import request
from bson import encode
from .channel import Channel
from .message import Message
from .error import AuthException, PasscodeException
from .utils import get_xvc, Packet, CryptoManager, Writer
class HTTP:
    ...
    async def upload(self, data, dataType, userId):
        path = requests.post("https://up-m.talk.kakao.com/upload", headers={
                "A": "win32/3.2.6/kr",
            },
            data={
