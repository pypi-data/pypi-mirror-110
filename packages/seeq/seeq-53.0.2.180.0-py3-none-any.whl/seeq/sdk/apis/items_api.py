...
class ItemsApi(object):
    ...
    def archive_item(self, **kwargs):
        ...
        :param str archived_reason: The reason for archiving the item. Can be one of OBSOLETE_SQLV1, BY_USER, DATASOURCE_CLEANUP, BY_MIGRATION, BY_PARENT_ITEM, BY_SANDBOX_MODE, or NONE
