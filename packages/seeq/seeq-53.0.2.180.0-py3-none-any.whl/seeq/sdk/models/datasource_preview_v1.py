...
class DatasourcePreviewV1(object):
    ...
    def __init__(self, datasource_class=None, datasource_id=None, href=None, id=None, is_archived=False, is_redacted=False, name=None, translation_key=None, type=None):
        """
