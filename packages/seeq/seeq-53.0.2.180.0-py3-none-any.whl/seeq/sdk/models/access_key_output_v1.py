...
class AccessKeyOutputV1(object):
    ...
    def __init__(self, created_at=None, description=None, effective_permissions=None, href=None, id=None, is_admin=False, is_archived=False, is_redacted=False, key_id=None, last_used=None, name=None, password=None, status_message=None, translation_key=None, type=None, user_id=None):
        """
