...
class ContentOutputV1(object):
    ...
    def __init__(self, archived=False, date_range=None, description=None, effective_permissions=None, hash_code=None, height=None, href=None, id=None, is_archived=False, is_redacted=False, name=None, report=None, scale=None, selector=None, source_workbook=None, source_worksheet=None, source_workstep=None, status_message=None, summary_type=None, summary_value=None, timezone=None, translation_key=None, type=None, width=None):
        """
