...
class ItemSearchPreviewV1(object):
    ...
    def __init__(self, ancestors=None, datasource=None, description=None, has_children=False, href=None, id=None, is_archived=False, is_redacted=False, name=None, source_value_unit_of_measure=None, translation_key=None, type=None, value_unit_of_measure=None):
        """
