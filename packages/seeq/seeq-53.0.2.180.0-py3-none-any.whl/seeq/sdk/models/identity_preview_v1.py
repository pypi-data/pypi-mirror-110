...
class IdentityPreviewV1(object):
    ...
    def __init__(self, datasource=None, email=None, href=None, id=None, is_archived=False, is_enabled=False, is_redacted=False, is_remote_group_editable=False, name=None, translation_key=None, type=None, username=None, username_readable=False):
        """
