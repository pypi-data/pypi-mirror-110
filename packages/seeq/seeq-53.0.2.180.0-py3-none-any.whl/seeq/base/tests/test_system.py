...
def test_calculate_default_optimal_heap_sizes():
    ...
    test_matrix = [
        ...
        # P  Total Appsr JvmL PG   NetL Rend Proxy Sup OS   SrCch
        [8, 4000, 1000, 250, 2250, 250, 500, 100, 300, 250, 100],
        [8, 8000, 2750, 500, 2250, 500, 1000, 100, 300, 500, 100],
        [8, 12000, 5500, 750, 2250, 750, 1500, 100, 300, 750, 100],
        [8, 16000, 7508, 1000, 2992, 1000, 2000, 100, 300, 1000, 100],
        [8, 32000, 15516, 2000, 5984, 2000, 4000, 100, 300, 2000, 100],
        [8, 64000, 35532, 4000, 11968, 4000, 4000, 100, 300, 4000, 100],
        [8, 128000, 75564, 8000, 23936, 8000, 4000, 100, 300, 8000, 100],
        [8, 256000, 155628, 16000, 47872, 16000, 4000, 100, 300, 16000, 100],

        # 64-bit, 64 cpu cores for screenshot purposes
        [64, 4000, 1000, 250, 2250, 250, 500, 800, 300, 250, 640],
        [64, 8000, 2000, 500, 2250, 500, 1000, 800, 300, 500, 640],
        [64, 12000, 4260, 750, 2250, 750, 1500, 800, 300, 750, 640],
        [64, 16000, 6268, 1000, 2992, 1000, 2000, 800, 300, 1000, 640],
        [64, 32000, 14276, 2000, 5984, 2000, 4000, 800, 300, 2000, 640],
        [64, 64000, 30292, 4000, 11968, 4000, 8000, 800, 300, 4000, 640],
        [64, 128000, 62324, 8000, 23936, 8000, 16000, 800, 300, 8000, 640],
        [64, 256000, 126388, 16000, 47872, 16000, 32000, 800, 300, 16000, 640],
        [64, 512000, 286516, 32000, 95744, 32000, 32000, 800, 300, 32000, 640],
    ]
