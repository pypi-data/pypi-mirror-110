...
class ItemsApi(object):
    ...
    def search_items(self, **kwargs):
        ...
        :param str scope: An ID that limits the results to those which are in the global scope or are scoped to the item referenced by the ID. <br>The following item types can act as a scope: <b>Workbook</b><br>If the scope is set to the Empty GUID then the scoped items are excluded
    ...
    def search_workbench(self, **kwargs):
        """
        Get workbench items matching the specified filters.
    ...
    def search_workbench_with_http_info(self, **kwargs):
        ...
        all_params = ['ids', 'types', 'folder_id', 'filter', 'is_archived', 'only_pinned', 'text_search', 'sort_order', 'limit', 'offset', 'is_exact', 'root']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
