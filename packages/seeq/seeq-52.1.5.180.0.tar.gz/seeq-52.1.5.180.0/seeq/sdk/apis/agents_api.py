...
"""
    ...
    OpenAPI spec version: 52.1.5-SNAPSHOT
...
class AgentsApi(object):
    ...
    def archive_agent(self, **kwargs):
        ...
        :param str agent_name: The name of the agent (required)
    ...
    def archive_connector(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: The name of the agent (required)
        :param str connector_name: The name of the connector (required)
        :return: StatusMessageBase
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: StatusMessageBase
    ...
    def create_or_update_agent(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: Name of the agent to create or update (required)
    ...
    def create_or_update_connector(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: Name of the agent where connector resides (required)
        :param str connector_name: Name of the connector to create or update (required)
    ...
    def get_agent(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: Name of the agent to get (required)
        :return: AgentOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: AgentOutputV1
    ...
    def get_connector(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: Name of the agent to get (required)
        :param str connector_name: Name of the connector to get (required)
        :return: ConnectorOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ConnectorOutputV1
    ...
    def index(self, **kwargs):
        """
        Request indexing of the given connection.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.index(agent_name=agent_name_value, datasource_class=datasource_class_value, datasource_id=datasource_id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: The ID of the agent (required)
    ...
    def index_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.index_with_http_info(agent_name=agent_name_value, datasource_class=datasource_class_value, datasource_id=datasource_id_value, callback=callback_function)
        ...
        all_params = ['agent_name', 'datasource_class', 'datasource_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'agent_name' is set
        if ('agent_name' not in params) or (params['agent_name'] is None):
            raise ValueError("Missing the required parameter `agent_name` when calling `index`")
        ...
        return self.api_client.call_api('/agents/{agentName}/{datasourceClass}/{datasourceId}/index', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def restart_agent(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: Name of the agent to restart (required)
        :return: StatusMessageBase
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: StatusMessageBase
    ...
    def restart_connector(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str agent_name: Name of the agent (required)
        :param str connector_name: Name of the connector to restart (required)
        :return: StatusMessageBase
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: StatusMessageBase
