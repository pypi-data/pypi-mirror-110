...
class AssetTreeOutputV1(object):
    ...
    def __init__(self, children=None, created_by=None, description=None, graph_limit=None, has_items_before_offset_present=False, item=None, limit=None, manually_added=None, next=None, offset=None, prev=None, status_message=None, tree_type=None):
        """
