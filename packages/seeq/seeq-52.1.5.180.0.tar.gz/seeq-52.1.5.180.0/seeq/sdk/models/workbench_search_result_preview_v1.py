...
class WorkbenchSearchResultPreviewV1(object):
    ...
    def __init__(self, ancestors=None, corporate=False, created_at=None, creator=None, data=None, description=None, effective_permissions=None, headline=None, id=None, is_pinned=False, name=None, owner=None, parent_folder_id=None, renderer=None, type=None, unmodifiable=False, updated_at=None):
        """
