...
class FormulaRunOutputV1(object):
    ...
    def __init__(self, capsules=None, errors=None, items=None, metadata=None, regression_output=None, return_type=None, samples=None, scalar=None, status_message=None, table=None, upgrade_details=None, warning_count=None, warning_logs=None):
        """
