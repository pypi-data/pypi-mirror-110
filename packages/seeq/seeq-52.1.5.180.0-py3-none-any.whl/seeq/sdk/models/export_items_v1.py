...
class ExportItemsV1(object):
    ...
    def __init__(self, autoupdate_time_range=False, capsule_time=False, export_capsules=False, export_name=None, format=None, grid_enabled=True, grid_origin=None, grid_size=None, items=None, original_timestamps_enabled=False, scoped_to=None, statistics_enabled=True, swap_in=None, swap_out=None, time_zone=None, worksheet_link=None):
        """
