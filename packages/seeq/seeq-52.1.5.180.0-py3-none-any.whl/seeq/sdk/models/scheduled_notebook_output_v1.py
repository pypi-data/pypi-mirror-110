...
class ScheduledNotebookOutputV1(object):
    ...
    def __init__(self, average_run_time=None, description=None, effective_permissions=None, enabled=False, file_path=None, href=None, id=None, is_archived=False, is_redacted=False, label=None, name=None, project=None, run_user=None, schedules=None, status_message=None, timezone=None, total_run_time=None, type=None):
        """
    ...
    def href(self):
        """
        Gets the href of this ScheduledNotebookOutputV1.
        The href that can be used to interact with the item

        :return: The href of this ScheduledNotebookOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ScheduledNotebookOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this ScheduledNotebookOutputV1.
        :type: str
        """
        if href is None:
