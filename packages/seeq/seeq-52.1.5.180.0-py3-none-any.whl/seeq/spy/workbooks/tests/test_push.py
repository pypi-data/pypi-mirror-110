...
def test_owner():
    ...
    try:
        ...
        _confirm(user_janna.username, False)

        push_df3 = spy.workbooks.push(workbooks, owner=spy.workbooks.FORCE_ME_AS_OWNER)
        _confirm(test_common.ADMIN_USER_NAME, True)
