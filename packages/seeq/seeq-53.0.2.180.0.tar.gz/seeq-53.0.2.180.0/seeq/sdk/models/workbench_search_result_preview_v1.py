...
class WorkbenchSearchResultPreviewV1(object):
    ...
    def __init__(self, ancestors=None, corporate=False, created_at=None, creator=None, data=None, description=None, effective_permissions=None, headline=None, href=None, id=None, is_archived=False, is_pinned=False, name=None, owner=None, parent_folder_id=None, renderer=None, type=None, unmodifiable=False, updated_at=None):
        """
    ...
    def href(self):
        """
        Gets the href of this WorkbenchSearchResultPreviewV1.
        The href that can be used to interact with the item

        :return: The href of this WorkbenchSearchResultPreviewV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this WorkbenchSearchResultPreviewV1.
        The href that can be used to interact with the item

        :param href: The href of this WorkbenchSearchResultPreviewV1.
        :type: str
        """
        if href is None:
