...
class ConnectionOutputV1(object):
    ...
    def __init__(self, agent_name=None, backups=None, connection_id=None, connector_name=None, created_at=None, datasource_id=None, description=None, effective_permissions=None, enabled=False, href=None, id=None, indexing_connection=False, is_archived=False, json=None, max_concurrent_requests=None, max_results_per_requests=None, name=None, propagation_pending=False, pull_connection=False, status_message=None, transforms=None, type=None, updated_at=None):
        """
    ...
    def href(self):
        """
        Gets the href of this ConnectionOutputV1.
        The href that can be used to interact with the item

        :return: The href of this ConnectionOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this ConnectionOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this ConnectionOutputV1.
        :type: str
        """
        if href is None:
