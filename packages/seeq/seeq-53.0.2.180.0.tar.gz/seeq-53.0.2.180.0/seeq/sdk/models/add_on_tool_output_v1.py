...
class AddOnToolOutputV1(object):
    ...
    def __init__(self, description=None, effective_permissions=None, href=None, icon_class=None, id=None, is_archived=False, link_type=None, name=None, reuse_window=False, sort_key=None, status_message=None, target_url=None, type=None, window_details=None):
        """
    ...
    def href(self):
        """
        Gets the href of this AddOnToolOutputV1.
        The href that can be used to interact with the item

        :return: The href of this AddOnToolOutputV1.
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        """
        Sets the href of this AddOnToolOutputV1.
        The href that can be used to interact with the item

        :param href: The href of this AddOnToolOutputV1.
        :type: str
        """
        if href is None:
