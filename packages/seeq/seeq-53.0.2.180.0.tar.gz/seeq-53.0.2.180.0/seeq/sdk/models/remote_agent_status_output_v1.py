...
class RemoteAgentStatusOutputV1(object):
    ...
    def __init__(self, available_versions=None, base_version=None, current_version=None, free_disk_space=None, name=None, pending_progress=None, pending_status=None, pending_version=None, platform=None, platform_architecture=None, platform_version=None, status=None, updates_enabled=False):
        """
