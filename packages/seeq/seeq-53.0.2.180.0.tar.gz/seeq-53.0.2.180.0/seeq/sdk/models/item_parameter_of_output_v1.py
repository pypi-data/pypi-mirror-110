...
class ItemParameterOfOutputV1(object):
    ...
    def __init__(self, ancestors=None, has_children=False, href=None, id=None, is_archived=False, is_generated=False, is_redacted=False, name=None, parameter_of=None, translation_key=None, type=None):
        """
