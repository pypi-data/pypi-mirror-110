...
class PluginOutputV1(object):
    ...
    def __init__(self, category=None, description=None, effective_permissions=None, entry_point=None, host=None, href=None, icon=None, id=None, identifier=None, is_archived=False, is_redacted=False, name=None, options=None, status_message=None, translation_key=None, type=None, version=None):
        """
