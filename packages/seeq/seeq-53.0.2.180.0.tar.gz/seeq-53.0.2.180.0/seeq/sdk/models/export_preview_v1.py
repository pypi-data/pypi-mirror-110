...
class ExportPreviewV1(object):
    ...
    def __init__(self, autoupdate_time_range=False, created_at=None, href=None, id=None, is_archived=False, is_redacted=False, name=None, scoped_to=None, translation_key=None, type=None, updated_at=None):
        """
