...
class ItemOutputV1(object):
    ...
    def __init__(self, ancillaries=None, cached=False, datasource=None, description=None, effective_permissions=None, href=None, id=None, is_archived=False, is_redacted=False, name=None, properties=None, scoped_to=None, status_message=None, translation_key=None, type=None):
        """
