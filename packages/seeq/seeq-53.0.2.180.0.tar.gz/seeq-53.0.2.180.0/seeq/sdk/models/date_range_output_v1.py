...
class DateRangeOutputV1(object):
    ...
    def __init__(self, archived=False, background=False, condition=None, content=None, cron_schedule=None, date_range=None, description=None, effective_permissions=None, enabled=False, formula=None, href=None, id=None, is_archived=False, is_redacted=False, name=None, report=None, status_message=None, translation_key=None, type=None):
        """
