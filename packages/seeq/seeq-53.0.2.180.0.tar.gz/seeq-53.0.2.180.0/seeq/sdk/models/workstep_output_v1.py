...
class WorkstepOutputV1(object):
    ...
    def __init__(self, created_at=None, data=None, description=None, effective_permissions=None, href=None, id=None, is_archived=False, is_redacted=False, last=None, name=None, next=None, previous=None, status_message=None, translation_key=None, type=None):
        """
