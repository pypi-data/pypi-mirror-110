...
class TopdeskConnector:
	...
	def operational_activities_by_type(self, activity_type: str = None, ammount: int = 5, start_offset: int = 0) -> list:
		"""
		...
		"""
		params = f"query=type.name=='{activity_type}'&pageSize={ammount}&pageStart={start_offset}&fields=all"
