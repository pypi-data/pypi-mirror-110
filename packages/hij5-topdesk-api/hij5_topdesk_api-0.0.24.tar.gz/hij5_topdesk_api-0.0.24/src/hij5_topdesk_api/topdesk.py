...
class TopdeskConnector:
	...
	def operational_activities_by_type(self, activity_type: str = None, ammount: int = 5) -> dict:
		"""
		...
		"""
		params = f"query=type.name=='{activity_type}'&pageSize={ammount}&fields=all"
		headers = self.headers.copy()
		headers['Accept'] = "application/x.topdesk-om-activity-v1+json"
		return self.make_request('get', 'operationalActivities', params=params, headers=headers)
