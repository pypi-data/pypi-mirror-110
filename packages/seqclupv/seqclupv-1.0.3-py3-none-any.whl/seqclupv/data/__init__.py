"""
    This package contains three data sets, namely:
    ...
    Additionally, the package contains the original source code provided at the start of the project as a Jupyter
    Notebook.
"""
