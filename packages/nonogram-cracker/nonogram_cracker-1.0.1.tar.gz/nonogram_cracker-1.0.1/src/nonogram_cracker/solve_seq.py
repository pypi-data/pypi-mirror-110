from .helpers.is_solved import is_solved
    ...
    while changed:
        ...
        for i in range(len(solution)):
            ...
            if is_unidentified(sol_val) or is_empty(sol_val):
                ...
                suspect_jives_with_known_solution = (
                ...
                if has_prime_suspect and suspect_jives_with_known_solution:
