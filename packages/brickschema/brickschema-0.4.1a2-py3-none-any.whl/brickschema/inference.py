...
for Allegro with 'pip install brickschema[allegro]"
    ...
    def expand(self, graph):
        ...
        logging.info("starting agraph server")
        check_error(
            agraph.exec_run(
...
/tmp/input.ttl",
        ...
        logging.info("materializing input file")
        check_error(
            agraph.exec_run(
...
--rule all",
        ...
        logging.info("exporting reasoned graph")
        check_error(
            agraph.exec_run(
