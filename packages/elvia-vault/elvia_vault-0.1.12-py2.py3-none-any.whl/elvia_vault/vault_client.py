...
class VaultClient():
    ...
    def encrypt_secret(self, transit_path: str, key_name: str,  plaintext: str) -> str:
        ...
        plaintext: str, only supports base64 encoded string
        ...
        return self._client.secrets.transit.encrypt_data(key_name, plaintext, mount_point=transit_path)
    ...
    def decrypt_secret(self, transit_path: str, key_name: str, ciphertext: str) -> str:
        ...
        transit_path: str, {system}/transit (usually)
        key_name: str, name of the backend key
        ciphertext: str, what was returned from encrypt_secret
        ...
        return self._client.secrets.transit.decrypt_data(key_name, ciphertext, mount_point=transit_path)
