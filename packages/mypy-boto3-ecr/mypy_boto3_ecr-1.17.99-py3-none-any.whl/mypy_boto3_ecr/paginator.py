...
class DescribeImageScanFindingsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/ecr.html#ECR.Paginator.DescribeImageScanFindings.paginate)
...
class DescribeImagesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/ecr.html#ECR.Paginator.DescribeImages.paginate)
...
class DescribeRepositoriesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/ecr.html#ECR.Paginator.DescribeRepositories.paginate)
...
class GetLifecyclePolicyPreviewPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/ecr.html#ECR.Paginator.GetLifecyclePolicyPreview.paginate)
...
class ListImagesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/ecr.html#ECR.Paginator.ListImages.paginate)
