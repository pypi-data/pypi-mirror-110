...
class CodeBindingExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/schemas.html#Schemas.Waiter.CodeBindingExistsWaiter)
