...
UPLOAD_URL = (
    'https://atu.decentralization.gov.ua/static/%D0%9F%D0%BE%D1%80%D1'
    '%96%D0%B2%D0%BD%D1%8F%D0%BB%D1%8C%D0%BD%D0%B0%20%D1%82%D0%B0%D0%'
    'B1%D0%BB%D0%B8%D1%86%D1%8F%20%D0%BC%D1%96%D0%B6%20%D0%9A%D0%BE%D'
    '0%B4%D0%B8%D1%84%D1%96%D0%BA%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%BC'
    '%20%D1%82%D0%B0%20%D0%9A%D0%9E%D0%90%D0%A2%D0%A3%D0%A3.xlsx'
)
PARSER_VERSION = 'v1'
...
class KATOTTG_TO_KOATUUImportRunner(BaseImportRunner):
    ...
    def run_merge(self):
        ...
        with open(state['parsed_file'], 'r') as file:
            ...
            existeds = find_by_codes(seeker_registry,
            ...
            for katottg, koatuu in chunk:
                ...
                item.codes[KOATUU_SEEKER.name] = koatuu
                updateds.add(item)
