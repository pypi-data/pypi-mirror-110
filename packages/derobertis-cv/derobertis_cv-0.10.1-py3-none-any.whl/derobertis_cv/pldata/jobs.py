    ...
    jobs = [
        ...
        EmploymentModel(
            ...
            [
                ...
                "Independently architect and execute large projects to improve the Scala monolith and React Native "
                "mobile and web applications",
                "Optimize organizational engineering practices by contributing to discussions and documentation",
