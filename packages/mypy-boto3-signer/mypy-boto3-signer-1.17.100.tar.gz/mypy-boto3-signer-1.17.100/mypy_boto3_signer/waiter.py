...
class SuccessfulSigningJobWaiter(Boto3Waiter):
    ...
    def wait(self, *, jobId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/signer.html#signer.Waiter.SuccessfulSigningJobWaiter)
