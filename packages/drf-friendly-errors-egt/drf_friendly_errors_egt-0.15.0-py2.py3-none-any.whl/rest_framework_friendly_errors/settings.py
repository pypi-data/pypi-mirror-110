...
VALIDATION_FAILED_MESSAGE = USER_SETTINGS.get(
    "VALIDATION_FAILED_MESSAGE", _("Validation Failed")
)

CATCH_ALL_EXCEPTIONS = USER_SETTINGS.get("CATCH_ALL_EXCEPTIONS", False)
...
FRIENDLY_FIELD_ERRORS = {
    ...
    "DecimalField": {
        ...
        "min_value": 2071,
        "max_value": 2061,
        "max_whole_digits": 2011,
        "max_digits": 2012,
        "max_decimal_places": 2013,
    },
    "ChoiceField": {
        "required": 2004,
        "null": 2024,
    ...
    "DictField": {"required": 2006, "null": 2026, "not_a_dict": 2131, "empty": 2015},
    ...
    "CitixenGroupPermissionRelatedField": {
        "required": 2007,
        "null": 2027,
        "does_not_exist": 2151,
        "incorrect_type": 2161,
...
FRIENDLY_FIELD_ERRORS = update_field_settings(
    FRIENDLY_FIELD_ERRORS, USER_FRIENDLY_FIELD_ERRORS
)
