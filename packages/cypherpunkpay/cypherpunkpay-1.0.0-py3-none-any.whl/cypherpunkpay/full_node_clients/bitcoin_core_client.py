...
class BitcoinCoreClient(object):
    ...
    def create_wallet_idempotent(self, xpub):
                        ...
                        [
                            {
                                ...
                                "timestamp": int(utc_ago(days=2, hours=12).timestamp()),
                                "watchonly": True,
                                "internal": False,
                                "active": True,
                                "range": [0, 256]
    ...
    def get_address_credits(self, wallet_fingerprint: str, address: str, current_height: int) -> [AddressCredits, None]:
        ...
        # log.debug(f'total_6={total_6}')
        # log.debug(f'total_5={total_5}')
        # log.debug(f'total_4={total_4}')
        # log.debug(f'total_3={total_3}')
        # log.debug(f'total_2={total_2}')
        # log.debug(f'total_1={total_1}')
        # log.debug(f'total_0={total_0}')
