...
# 秒
xdatetime.get().reinforce_timestamp(mold="S")
>> 1624268054

# 毫秒
xdatetime.get().reinforce_timestamp(mold="M")
>> 1624268054630

# 微秒
xdatetime.get().reinforce_timestamp(mold="I")
>> 1624268054630874
```
...
```python
# 秒
xdatetime.get("2021-06-21 17:31:46").timestamp
>> 1624267906.0

# 秒
xdatetime.get("2021-06-21 17:31:46").reinforce_timestamp(mold="S")
>> 1624267906

# 毫秒
xdatetime.get("2021-06-21 17:31:46").reinforce_timestamp(mold="M")
>> 1624267906000

# 微秒
xdatetime.get("2021-06-21 17:31:46").reinforce_timestamp(mold="I")
>> 1624267906000000
```
...
```python
# 字符串转对象
object_string = "{'name': '中国', 'age': 100000}"
xstring.dispose(object_string).string_to_objects()
...
# 对象转字符串
object_string = {'name': '中国', 'age': 100000}
xstring.dispose(object_string).objects_to_string()

# 这个地方需要说明下，转换的结果字符串为字节串
b'{"age":100000,"name":"\xe4\xb8\xad\xe5\x9b\xbd"}'
```
...
```python
# 字节串转字符串
bytes_to_string = b'1254'
xstring.dispose(bytes_to_string).bytes_to_string()
...
```python
# 字符串转字节串
bytes_to_string = "1254"
xstring.dispose(bytes_to_string).string_to_bytes()
