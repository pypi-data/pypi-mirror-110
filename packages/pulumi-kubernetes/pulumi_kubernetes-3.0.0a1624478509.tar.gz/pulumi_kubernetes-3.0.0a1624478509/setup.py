...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'kubernetes', '3.0.0-alpha.1624478509+0fa6631d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource kubernetes 3.0.0-alpha.1624478509+0fa6631d`
                """)
            else:
                raise
