...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'kubernetes', '3.0.0-alpha.1624383106+4d0777af'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource kubernetes 3.0.0-alpha.1624383106+4d0777af`
                """)
            else:
                raise
