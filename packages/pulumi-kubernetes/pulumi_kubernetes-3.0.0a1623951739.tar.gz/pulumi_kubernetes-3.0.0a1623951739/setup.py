...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'kubernetes', '3.0.0-alpha.1623951739+2b3d2c15'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource kubernetes 3.0.0-alpha.1623951739+2b3d2c15`
                """)
            else:
                raise
