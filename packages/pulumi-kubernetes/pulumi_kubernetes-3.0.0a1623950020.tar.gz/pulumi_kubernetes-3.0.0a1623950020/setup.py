...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'kubernetes', '3.0.0-alpha.1623950020+9b2b0ee9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource kubernetes 3.0.0-alpha.1623950020+9b2b0ee9`
                """)
            else:
                raise
