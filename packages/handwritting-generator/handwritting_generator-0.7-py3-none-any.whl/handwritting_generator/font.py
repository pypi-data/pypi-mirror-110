...
f14=Font(os.path.join(DIR,'Werner13-Regular.ttf'),True,True,False,list('.,;:"()«»! '),1.0)
...
f36=Font(os.path.join(DIR,'Werner32.ttf'),True,False,True,list('!%+,./"[]:;()'),1.2)
f37=Font(os.path.join(DIR,'Werner33.ttf'),True,False,True,list('!%+,./"[]():;'),1.2)
...
f=[f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f13,f14,f15,f16,f17,f18,f19,f20,f21,f22,f23,f25,f27,f28,f29,f30,f31,f33,f34,f35,f36,f37,f39,f40]