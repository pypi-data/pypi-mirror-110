...
f6=Font(os.path.join(DIR,'ofont.ru_Shlapak Script.otf'),True,True,True,list('+.,;-:"()/!? '),1)
...
f19=Font(os.path.join(DIR,'Werner15-Regular.ttf'),True,False,True,list('+.,;:"()! '),1.3)
f20=Font(os.path.join(DIR,'Werner16-Regular.ttf'),True,False,True,list(' +%,./()[]:;'),1.1)
f21=Font(os.path.join(DIR,'Werner17-Regular.ttf'),True,True,False,list(' +%,./()[]:;'),1.5)
f22=Font(os.path.join(DIR,'bimbo.regular.ttf'),True,True,False,list(' +%,.-/()[]:;'),0.8)
...
f34=Font(os.path.join(DIR,'Werner23-Regular.ttf'),True,False,True,list('!%/,./()[]:;'),1.1)
