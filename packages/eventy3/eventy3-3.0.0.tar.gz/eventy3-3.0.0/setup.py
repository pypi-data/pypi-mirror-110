...
setup(
    ...
    description="Qotto/eventy",  # Optional
...
# Denotes that our long_description is in Markdown; valid values are
    ...
    # project.
    author="Qotto dev team",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    # TODO: Maybe "eventy@qotto.net" email address?
    ...
    #
    packages=find_packages(exclude=["docs", "tests", "recipes", "examples"]),  # Required
    # Specify which Python versions you support. In contrast to the
    # 'Programming Language' classifiers above, 'pip install' will check this
    # and refuse to install the project if the version does not match. If you
    # do not support Python 2, you can simplify this to '>=3.5' or similar, see
    # https://packaging.python.org/guides/distributing-packages-using-setuptools/#python-requires
    python_requires=">=3.7",  # , !=3.0.*, !=3.1.*, !=3.2.*, !=3.3.*, !=3.4.*, <4",
