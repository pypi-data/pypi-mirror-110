...
from wave_pay.exceptions import AuthenticationError, AuthorizationError, NotFoundError, RequestTimeoutError, \
    UpgradeRequiredError, TooManyRequestsError, ServerError, ServiceUnavailableError, GatewayTimeoutError, \
    UnexpectedError
from wave_pay.exceptions.http import InvalidResponseError
from wave_pay.exceptions.http.timeout_error import ConnectTimeoutError, ReadTimeoutError
