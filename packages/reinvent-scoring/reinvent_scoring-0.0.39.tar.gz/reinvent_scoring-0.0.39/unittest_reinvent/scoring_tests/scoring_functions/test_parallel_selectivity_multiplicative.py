...
class Test_parallel_selectivity_multiplicative_function(unittest.TestCase):
    ...
    def test_selectivity_multiplicative_1(self):
        smiles = [celecoxib for i in range(2)]
    ...
    def test_selectivity_multiplicative_2(self):
        smiles = [random_compound for i in range(2)]
        score = self.sf_instance.get_final_score(smiles=smiles)
        self.assertAlmostEqual(score.total_score[0], 0.105, 3)
