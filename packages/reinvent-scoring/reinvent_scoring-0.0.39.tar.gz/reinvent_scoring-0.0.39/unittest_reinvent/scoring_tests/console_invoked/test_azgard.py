...
from unittest_reinvent.scoring_tests.fixtures.azdock_fixtures import aspirin, paracetamol, caffeine
...
class Test_structural_AZgard(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        azgard_conf["workflow"]["steps"][3]["input"]["sources"][0]["source"] = AZGARD_UNITTEST_NIBR_NEGATIVE_IMAGE
