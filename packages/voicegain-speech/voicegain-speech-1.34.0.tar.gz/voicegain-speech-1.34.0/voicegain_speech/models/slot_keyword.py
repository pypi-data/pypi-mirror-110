...
class SlotKeyword(object):
    ...
    def __init__(self, required=False, tag=None, local_vars_configuration=None):  # noqa: E501
        """SlotKeyword - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def required(self):
        """Gets the required of this SlotKeyword.  # noqa: E501

        if required is set to true, this keyword **must** be in the phrase  # noqa: E501

        :return: The required of this SlotKeyword.  # noqa: E501
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this SlotKeyword.

        if required is set to true, this keyword **must** be in the phrase  # noqa: E501

        :param required: The required of this SlotKeyword.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this SlotKeyword.  # noqa: E501

        Tag of the keyword to be found within the phrase match  # noqa: E501

        :return: The tag of this SlotKeyword.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this SlotKeyword.

        Tag of the keyword to be found within the phrase match  # noqa: E501

        :param tag: The tag of this SlotKeyword.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SlotKeyword):
            return False
