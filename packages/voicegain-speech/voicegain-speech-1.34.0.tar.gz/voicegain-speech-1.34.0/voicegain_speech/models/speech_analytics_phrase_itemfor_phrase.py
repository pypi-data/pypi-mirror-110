...
class SpeechAnalyticsPhraseItemforPhrase(object):
    ...
    def __init__(self, channel=None, end_idx=None, end_time=None, start_idx=None, start_time=None, phrase=None, score=None, slots=None, tag=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsPhraseItemforPhrase - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def channel(self):
        """Gets the channel of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501


        :return: The channel of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this SpeechAnalyticsPhraseItemforPhrase.


        :param channel: The channel of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: str
        """
        allowed_values = ["caller", "agent"]  # noqa: E501
    ...
    @property
    def end_idx(self):
        """Gets the end_idx of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        ...
        :return: The end_idx of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: str
        """
    ...
    def end_idx(self, end_idx):
        """Sets the end_idx of this SpeechAnalyticsPhraseItemforPhrase.

        End index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param end_idx: The end_idx of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501

        end time in msec since start of audio  # noqa: E501

        :return: The end_time of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: int
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this SpeechAnalyticsPhraseItemforPhrase.

        end time in msec since start of audio  # noqa: E501

        :param end_time: The end_time of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_idx(self):
        """Gets the start_idx of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :return: The start_idx of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: str
        """
    ...
    def start_idx(self, start_idx):
        """Sets the start_idx of this SpeechAnalyticsPhraseItemforPhrase.

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param start_idx: The start_idx of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501

        start time in msec since start of audio  # noqa: E501

        :return: The start_time of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: int
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this SpeechAnalyticsPhraseItemforPhrase.

        start time in msec since start of audio  # noqa: E501

        :param start_time: The start_time of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: int
        """
    ...
    @property
    def phrase(self):
        """Gets the phrase of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501

        Sequence of words that constitute this phrase match  # noqa: E501

        :return: The phrase of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: str
        """
        return self._phrase
    ...
    def phrase(self, phrase):
        """Sets the phrase of this SpeechAnalyticsPhraseItemforPhrase.

        Sequence of words that constitute this phrase match  # noqa: E501

        :param phrase: The phrase of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def score(self):
        """Gets the score of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501

        _(coming soon)_ Score reflecting how close the phrase match is. 1.0 is the closest match.  # noqa: E501

        :return: The score of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: float
        """
        return self._score
    ...
    def score(self, score):
        """Sets the score of this SpeechAnalyticsPhraseItemforPhrase.

        _(coming soon)_ Score reflecting how close the phrase match is. 1.0 is the closest match.  # noqa: E501

        :param score: The score of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: float
        """
    ...
    @property
    def slots(self):
        """Gets the slots of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501


        :return: The slots of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
    ...
    def slots(self, slots):
        """Sets the slots of this SpeechAnalyticsPhraseItemforPhrase.


        :param slots: The slots of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
    ...
    @property
    def tag(self):
        """Gets the tag of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501

        Tag associated with the phrase  # noqa: E501

        :return: The tag of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this SpeechAnalyticsPhraseItemforPhrase.

        Tag associated with the phrase  # noqa: E501

        :param tag: The tag of this SpeechAnalyticsPhraseItemforPhrase.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsPhraseItemforPhrase):
            return False
