...
class AsrSettingsTranscriptionSA(object):
    ...
    openapi_types = {
        ...
        'hints': 'list[str]',
        'lang_model': 'str',
        'diarization': 'MinMaxSpeakersDiarization'
    }
    ...
    def __init__(self, acoustic_model_non_real_time=None, acoustic_model_real_time=None, confidence_threshold=0.01, max_alternatives=1, sensitivity=None, speech_context='normal', speed_vs_accuracy=None, hints=None, lang_model=None, diarization=None, local_vars_configuration=None):  # noqa: E501
        """AsrSettingsTranscriptionSA - a model defined in OpenAPI"""  # noqa: E501
    ...
    def acoustic_model_non_real_time(self):
        """Gets the acoustic_model_non_real_time of this AsrSettingsTranscriptionSA.  # noqa: E501
        ...
        :return: The acoustic_model_non_real_time of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model_non_real_time(self, acoustic_model_non_real_time):
        """Sets the acoustic_model_non_real_time of this AsrSettingsTranscriptionSA.

        (Optional) Name of an Acoustic Model that is to be used for offline and semi-real-time processing.  May include version number separated by `:` , for example, **Voicegain-BD_en-us:11** </br> If not provided a suitable default will be used.   # noqa: E501

        :param acoustic_model_non_real_time: The acoustic_model_non_real_time of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: str
        """
    ...
    def acoustic_model_real_time(self):
        """Gets the acoustic_model_real_time of this AsrSettingsTranscriptionSA.  # noqa: E501
        ...
        :return: The acoustic_model_real_time of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model_real_time(self, acoustic_model_real_time):
        """Sets the acoustic_model_real_time of this AsrSettingsTranscriptionSA.

        (Optional) Name of a real-time capable Acoustic Model.  May include version number separated by `:`, for example, **Voicegain-IVR_en-us:3**</br> If not provided a suitable default will be used.   # noqa: E501

        :param acoustic_model_real_time: The acoustic_model_real_time of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: str
        """
    ...
    def confidence_threshold(self):
        """Gets the confidence_threshold of this AsrSettingsTranscriptionSA.  # noqa: E501

        Hypotheses below this threshold will result in NOMATCH  # noqa: E501

        :return: The confidence_threshold of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: float
        """
    ...
    def confidence_threshold(self, confidence_threshold):
        """Sets the confidence_threshold of this AsrSettingsTranscriptionSA.

        Hypotheses below this threshold will result in NOMATCH  # noqa: E501

        :param confidence_threshold: The confidence_threshold of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: float
        """
    ...
    def max_alternatives(self):
        """Gets the max_alternatives of this AsrSettingsTranscriptionSA.  # noqa: E501

        number of recognition hypotheses to return as result (top N-Best)  # noqa: E501

        :return: The max_alternatives of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: int
        """
    ...
    def max_alternatives(self, max_alternatives):
        """Sets the max_alternatives of this AsrSettingsTranscriptionSA.

        number of recognition hypotheses to return as result (top N-Best)  # noqa: E501

        :param max_alternatives: The max_alternatives of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sensitivity(self):
        """Gets the sensitivity of this AsrSettingsTranscriptionSA.  # noqa: E501
        ...
        :return: The sensitivity of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: float
        """
    ...
    def sensitivity(self, sensitivity):
        """Sets the sensitivity of this AsrSettingsTranscriptionSA.

        Affects start-of-speech and end-of-speech detection. </br> 1 is most sensitive and corresponds to -90 dbFS </br> 0 is least sensitive and corresponds to -50 dbFS   # noqa: E501

        :param sensitivity: The sensitivity of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def speech_context(self):
        """Gets the speech_context of this AsrSettingsTranscriptionSA.  # noqa: E501
        ...
        :return: The speech_context of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: str
        """
    ...
    def speech_context(self, speech_context):
        """Sets the speech_context of this AsrSettingsTranscriptionSA.

        A \"hint\" to the acoustic model regarding what content to expect in speech: + normal - the default suitable to normal blend of speech + digits - use when expecting mainly digits in speech to enhance digit recognition    # noqa: E501

        :param speech_context: The speech_context of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: str
        """
    ...
    def speed_vs_accuracy(self):
        """Gets the speed_vs_accuracy of this AsrSettingsTranscriptionSA.  # noqa: E501

        between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use  # noqa: E501

        :return: The speed_vs_accuracy of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: float
        """
    ...
    def speed_vs_accuracy(self, speed_vs_accuracy):
        """Sets the speed_vs_accuracy of this AsrSettingsTranscriptionSA.

        between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use  # noqa: E501

        :param speed_vs_accuracy: The speed_vs_accuracy of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def hints(self):
        """Gets the hints of this AsrSettingsTranscriptionSA.  # noqa: E501
        ...
        :return: The hints of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: list[str]
        """
        return self._hints
    ...
    def hints(self, hints):
        """Sets the hints of this AsrSettingsTranscriptionSA.

        Can be provided to indicate that given words/phrases are more likely to appear in the audio input. No special characters allowed except for '_'   # noqa: E501

        :param hints: The hints of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def lang_model(self):
        """Gets the lang_model of this AsrSettingsTranscriptionSA.  # noqa: E501

        Name or UUID of the language model to use. If absent then will use default language model.  # noqa: E501

        :return: The lang_model of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: str
        """
    ...
    def lang_model(self, lang_model):
        """Sets the lang_model of this AsrSettingsTranscriptionSA.

        Name or UUID of the language model to use. If absent then will use default language model.  # noqa: E501

        :param lang_model: The lang_model of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def diarization(self):
        """Gets the diarization of this AsrSettingsTranscriptionSA.  # noqa: E501


        :return: The diarization of this AsrSettingsTranscriptionSA.  # noqa: E501
        :rtype: MinMaxSpeakersDiarization
        """
        return self._diarization

    @diarization.setter
    def diarization(self, diarization):
        """Sets the diarization of this AsrSettingsTranscriptionSA.


        :param diarization: The diarization of this AsrSettingsTranscriptionSA.  # noqa: E501
        :type: MinMaxSpeakersDiarization
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsTranscriptionSA):
            return False
