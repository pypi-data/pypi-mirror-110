...
class AsrSettingsRecognitionGrammarsEtc(object):
    ...
    def __init__(self, complete_timeout=2000, grammars=None, greg_experiment=None, incomplete_timeout=5000, lang_model=None, no_input_timeout=10000, start_input_timers=True, local_vars_configuration=None):  # noqa: E501
        """AsrSettingsRecognitionGrammarsEtc - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def grammars(self):
        """Gets the grammars of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501

        Grammars, either GRXML, inline JJSGF grammars, built-in grammar names, or GREG grammar ids (if GREG is used it has to be single and the only one).</br> It is possible to use a special type of grammar: ``` { \"type\" :  BUILT-IN, \"name\" :  \"transcribe\"} ``` This grammar will enable large-vocabulary recognition.  This feature is meant to be mainly used in combination with other grammars.   # noqa: E501

        :return: The grammars of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :rtype: list[Grammar]
        """
    ...
    def grammars(self, grammars):
        """Sets the grammars of this AsrSettingsRecognitionGrammarsEtc.

        Grammars, either GRXML, inline JJSGF grammars, built-in grammar names, or GREG grammar ids (if GREG is used it has to be single and the only one).</br> It is possible to use a special type of grammar: ``` { \"type\" :  BUILT-IN, \"name\" :  \"transcribe\"} ``` This grammar will enable large-vocabulary recognition.  This feature is meant to be mainly used in combination with other grammars.   # noqa: E501

        :param grammars: The grammars of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :type: list[Grammar]
        """
    ...
    def greg_experiment(self):
        """Gets the greg_experiment of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        ...
        :return: The greg_experiment of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :rtype: str
        """
    ...
    def greg_experiment(self, greg_experiment):
        """Sets the greg_experiment of this AsrSettingsRecognitionGrammarsEtc.

        (optional) Id of the GREG Experiment used to capture the audio and the recognition result. GREG Experiment status needs to be IMPORTING for capture to happen. If the status is READY no capture will be done.   # noqa: E501

        :param greg_experiment: The greg_experiment of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def lang_model(self):
        """Gets the lang_model of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        ...
        :return: The lang_model of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :rtype: str
        """
    ...
    def lang_model(self, lang_model):
        """Sets the lang_model of this AsrSettingsRecognitionGrammarsEtc.

        (Only applicable if large-vocabulary recognition has been enabled by using the special transcribe grammar.) </br> Name or UUID of the language model to use. If absent then will use default language model.   # noqa: E501

        :param lang_model: The lang_model of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def no_input_timeout(self):
        """Gets the no_input_timeout of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :return: The no_input_timeout of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :rtype: int
        """
    ...
    def no_input_timeout(self, no_input_timeout):
        """Sets the no_input_timeout of this AsrSettingsRecognitionGrammarsEtc.

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :param no_input_timeout: The no_input_timeout of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def start_input_timers(self):
        """Gets the start_input_timers of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        ...
        :return: The start_input_timers of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :rtype: bool
        """
    ...
    def start_input_timers(self, start_input_timers):
        """Sets the start_input_timers of this AsrSettingsRecognitionGrammarsEtc.

        (Optional) By default input timers are started immediately after recognizer is ready to listen. This parameter can be used to disable automatic start of input timers. </br> Currently meant mainly for internal use only as there is no web api to start the input timers on demand.   # noqa: E501

        :param start_input_timers: The start_input_timers of this AsrSettingsRecognitionGrammarsEtc.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsRecognitionGrammarsEtc):
            return False
