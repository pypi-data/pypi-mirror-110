...
class PhoneAudioInputPrompt(object):
    ...
    def __init__(self, delay=None, text=None, local_vars_configuration=None):  # noqa: E501
        """PhoneAudioInputPrompt - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def delay(self):
        """Gets the delay of this PhoneAudioInputPrompt.  # noqa: E501

        time (in milliseconds) to wait after the call was answered before playing the prompt text  # noqa: E501

        :return: The delay of this PhoneAudioInputPrompt.  # noqa: E501
        :rtype: int
        """
        return self._delay
    ...
    def delay(self, delay):
        """Sets the delay of this PhoneAudioInputPrompt.

        time (in milliseconds) to wait after the call was answered before playing the prompt text  # noqa: E501

        :param delay: The delay of this PhoneAudioInputPrompt.  # noqa: E501
        :type: int
        """
    ...
    @property
    def text(self):
        """Gets the text of this PhoneAudioInputPrompt.  # noqa: E501

        text that will be converted to TTS and played  # noqa: E501

        :return: The text of this PhoneAudioInputPrompt.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this PhoneAudioInputPrompt.

        text that will be converted to TTS and played  # noqa: E501

        :param text: The text of this PhoneAudioInputPrompt.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhoneAudioInputPrompt):
            return False
