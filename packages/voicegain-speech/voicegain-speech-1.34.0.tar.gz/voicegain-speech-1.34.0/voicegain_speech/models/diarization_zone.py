...
class DiarizationZone(object):
    ...
    def __init__(self, spk=None, local_vars_configuration=None):  # noqa: E501
        """DiarizationZone - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def spk(self):
        """Gets the spk of this DiarizationZone.  # noqa: E501
        ...
        **(beta)** If diarization is enabled then this field will contain the speaker index for this zone. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.     # noqa: E501
        ...
        :return: The spk of this DiarizationZone.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this DiarizationZone.

        **(beta)** If diarization is enabled then this field will contain the speaker index for this zone. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.     # noqa: E501

        :param spk: The spk of this DiarizationZone.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiarizationZone):
            return False
