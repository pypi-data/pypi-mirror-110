...
class DiarizationZoneItem(object):
    ...
    def __init__(self, end_idx=None, end_time=None, start_idx=None, start_time=None, spk=None, local_vars_configuration=None):  # noqa: E501
        """DiarizationZoneItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end_idx(self):
        """Gets the end_idx of this DiarizationZoneItem.  # noqa: E501
        ...
        :return: The end_idx of this DiarizationZoneItem.  # noqa: E501
        :rtype: str
        """
    ...
    def end_idx(self, end_idx):
        """Sets the end_idx of this DiarizationZoneItem.

        End index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param end_idx: The end_idx of this DiarizationZoneItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this DiarizationZoneItem.  # noqa: E501

        end time in msec since start of audio  # noqa: E501

        :return: The end_time of this DiarizationZoneItem.  # noqa: E501
        :rtype: int
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this DiarizationZoneItem.

        end time in msec since start of audio  # noqa: E501

        :param end_time: The end_time of this DiarizationZoneItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_idx(self):
        """Gets the start_idx of this DiarizationZoneItem.  # noqa: E501

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :return: The start_idx of this DiarizationZoneItem.  # noqa: E501
        :rtype: str
        """
    ...
    def start_idx(self, start_idx):
        """Sets the start_idx of this DiarizationZoneItem.

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param start_idx: The start_idx of this DiarizationZoneItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def spk(self):
        """Gets the spk of this DiarizationZoneItem.  # noqa: E501

        **(beta)** If diarization is enabled then this field will contain the speaker index for this zone. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.     # noqa: E501

        :return: The spk of this DiarizationZoneItem.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this DiarizationZoneItem.

        **(beta)** If diarization is enabled then this field will contain the speaker index for this zone. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.     # noqa: E501

        :param spk: The spk of this DiarizationZoneItem.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiarizationZoneItem):
            return False
