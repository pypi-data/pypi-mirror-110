...
class SpeechAnalyticsPhraseData(object):
    ...
    def __init__(self, counts=None, list=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsPhraseData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def counts(self):
        """Gets the counts of this SpeechAnalyticsPhraseData.  # noqa: E501
    ...
    def counts(self, counts):
        """Sets the counts of this SpeechAnalyticsPhraseData.
    ...
    @property
    def list(self):
        """Gets the list of this SpeechAnalyticsPhraseData.  # noqa: E501

        List of all phrases detected with their locations in recording and transcript.  # noqa: E501

        :return: The list of this SpeechAnalyticsPhraseData.  # noqa: E501
        :rtype: list[SpeechAnalyticsPhraseItem]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this SpeechAnalyticsPhraseData.

        List of all phrases detected with their locations in recording and transcript.  # noqa: E501

        :param list: The list of this SpeechAnalyticsPhraseData.  # noqa: E501
        :type: list[SpeechAnalyticsPhraseItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsPhraseData):
            return False
