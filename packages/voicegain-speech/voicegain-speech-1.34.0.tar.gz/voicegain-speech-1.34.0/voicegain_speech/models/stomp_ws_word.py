...
class StompWsWord(object):
    ...
    @property
    def conf(self):
        """Gets the conf of this StompWsWord.  # noqa: E501

        confidence of the utterance  # noqa: E501

        :return: The conf of this StompWsWord.  # noqa: E501
        :rtype: float
        """
        return self._conf
    ...
    @conf.setter
    def conf(self, conf):
        """Sets the conf of this StompWsWord.

        confidence of the utterance  # noqa: E501

        :param conf: The conf of this StompWsWord.  # noqa: E501
        :type: float
        """
    ...
    @property
    def gap(self):
        """Gets the gap of this StompWsWord.  # noqa: E501

        gap in ms between start of this word and the end of the previous word  # noqa: E501

        :return: The gap of this StompWsWord.  # noqa: E501
        :rtype: int
        """
        return self._gap
    ...
    @gap.setter
    def gap(self, gap):
        """Sets the gap of this StompWsWord.

        gap in ms between start of this word and the end of the previous word  # noqa: E501

        :param gap: The gap of this StompWsWord.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start(self):
        """Gets the start of this StompWsWord.  # noqa: E501

        position of the start of the utterance in milliseconds from start of audio  # noqa: E501

        :return: The start of this StompWsWord.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this StompWsWord.

        position of the start of the utterance in milliseconds from start of audio  # noqa: E501

        :param start: The start of this StompWsWord.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def utt(self):
        """Gets the utt of this StompWsWord.  # noqa: E501

        utterance - the word that was recognized  # noqa: E501

        :return: The utt of this StompWsWord.  # noqa: E501
        :rtype: str
        """
        return self._utt
    ...
    @utt.setter
    def utt(self, utt):
        """Sets the utt of this StompWsWord.

        utterance - the word that was recognized  # noqa: E501

        :param utt: The utt of this StompWsWord.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StompWsWord):
            return False
