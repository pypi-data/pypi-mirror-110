...
class PhraseSpotItemLocation(object):
    ...
    openapi_types = {
        'channel': 'str',
        'dialogue': 'PhraseSpotItemLocationDialogue',
        'time': 'int'
    }
    ...
    def __init__(self, channel=None, dialogue=None, time=None, local_vars_configuration=None):  # noqa: E501
        """PhraseSpotItemLocation - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def channel(self):
        """Gets the channel of this PhraseSpotItemLocation.  # noqa: E501

        (optional) In which channel should the phrase be found. By default all channels are searched.   # noqa: E501

        :return: The channel of this PhraseSpotItemLocation.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this PhraseSpotItemLocation.

        (optional) In which channel should the phrase be found. By default all channels are searched.   # noqa: E501

        :param channel: The channel of this PhraseSpotItemLocation.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dialogue(self):
        """Gets the dialogue of this PhraseSpotItemLocation.  # noqa: E501


        :return: The dialogue of this PhraseSpotItemLocation.  # noqa: E501
        :rtype: PhraseSpotItemLocationDialogue
        """
        return self._dialogue

    @dialogue.setter
    def dialogue(self, dialogue):
        """Sets the dialogue of this PhraseSpotItemLocation.


        :param dialogue: The dialogue of this PhraseSpotItemLocation.  # noqa: E501
        :type: PhraseSpotItemLocationDialogue
        """
    ...
    @property
    def time(self):
        """Gets the time of this PhraseSpotItemLocation.  # noqa: E501

        (optional) if positive then means first x seconds, if negative then means last x seconds of the audio (only of OFF-LINE).  (Note: the negative restriction is not implemented yet.)   # noqa: E501

        :return: The time of this PhraseSpotItemLocation.  # noqa: E501
        :rtype: int
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this PhraseSpotItemLocation.

        (optional) if positive then means first x seconds, if negative then means last x seconds of the audio (only of OFF-LINE).  (Note: the negative restriction is not implemented yet.)   # noqa: E501

        :param time: The time of this PhraseSpotItemLocation.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhraseSpotItemLocation):
            return False
