...
class NewSpeechAnalyticsSessionResponsePoll(object):
    ...
    def __init__(self, url=None, local_vars_configuration=None):  # noqa: E501
        """NewSpeechAnalyticsSessionResponsePoll - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewSpeechAnalyticsSessionResponsePoll):
            return False
