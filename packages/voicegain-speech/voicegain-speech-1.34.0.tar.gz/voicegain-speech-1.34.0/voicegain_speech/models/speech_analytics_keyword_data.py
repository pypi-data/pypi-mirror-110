...
class SpeechAnalyticsKeywordData(object):
    ...
    openapi_types = {
        'counts': 'dict(str, str)',
        'list': 'list[SpeechAnalyticsKeywordItem]'
    }
    ...
    def __init__(self, counts=None, list=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsKeywordData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def counts(self):
        """Gets the counts of this SpeechAnalyticsKeywordData.  # noqa: E501

        Map from from keyword tag to the count of number spotted  # noqa: E501

        :return: The counts of this SpeechAnalyticsKeywordData.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._counts
    ...
    def counts(self, counts):
        """Sets the counts of this SpeechAnalyticsKeywordData.

        Map from from keyword tag to the count of number spotted  # noqa: E501

        :param counts: The counts of this SpeechAnalyticsKeywordData.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def list(self):
        """Gets the list of this SpeechAnalyticsKeywordData.  # noqa: E501

        List of all keywords spotted with their locations in recording and transcript.  # noqa: E501

        :return: The list of this SpeechAnalyticsKeywordData.  # noqa: E501
        :rtype: list[SpeechAnalyticsKeywordItem]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this SpeechAnalyticsKeywordData.

        List of all keywords spotted with their locations in recording and transcript.  # noqa: E501

        :param list: The list of this SpeechAnalyticsKeywordData.  # noqa: E501
        :type: list[SpeechAnalyticsKeywordItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsKeywordData):
            return False
