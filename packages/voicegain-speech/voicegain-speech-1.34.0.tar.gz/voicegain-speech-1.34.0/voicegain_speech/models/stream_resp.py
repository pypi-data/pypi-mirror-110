...
class StreamResp(object):
    ...
    def websocket_url(self):
        ...
        For WEBSOCKET, TWIML, and LAML protocols - URL to which the audio data should be sent to:</br> For WEBSOCKET the audio will be sent as binary stream.</br> For TWIML or LAML the websocket URL should be passed to the `<Stream>` command.   # noqa: E501
