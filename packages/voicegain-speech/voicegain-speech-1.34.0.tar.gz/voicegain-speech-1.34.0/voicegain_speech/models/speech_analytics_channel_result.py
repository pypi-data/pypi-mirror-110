...
class SpeechAnalyticsChannelResult(object):
    ...
    def __init__(self, age=None, audio_channel_selector=None, audio_zones=None, decibels=None, emotion=None, gender=None, is_agent=None, keywords=None, named_entities=None, overtalk=None, phrases=None, spk=None, spk_name=None, talk=None, transcribe_sid=None, local_vars_configuration=None):  # noqa: E501
    ...
    def audio_channel_selector(self):
        """Gets the audio_channel_selector of this SpeechAnalyticsChannelResult.  # noqa: E501

        indicates how this channel result corresponds to the original audio channel  # noqa: E501

        :return: The audio_channel_selector of this SpeechAnalyticsChannelResult.  # noqa: E501
        :rtype: str
        """
    ...
    def audio_channel_selector(self, audio_channel_selector):
        """Sets the audio_channel_selector of this SpeechAnalyticsChannelResult.

        indicates how this channel result corresponds to the original audio channel  # noqa: E501

        :param audio_channel_selector: The audio_channel_selector of this SpeechAnalyticsChannelResult.  # noqa: E501
        :type: str
        """
        allowed_values = ["left", "right", "mix"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and audio_channel_selector not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `audio_channel_selector` ({0}), must be one of {1}"  # noqa: E501
                .format(audio_channel_selector, allowed_values)
            )
