...
class SpeechAnalyticsEmotionItem(object):
    ...
    def __init__(self, end_idx=None, end_time=None, start_idx=None, start_time=None, mood=None, sentiment=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsEmotionItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end_idx(self):
        """Gets the end_idx of this SpeechAnalyticsEmotionItem.  # noqa: E501
        ...
        :return: The end_idx of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :rtype: str
        """
    ...
    def end_idx(self, end_idx):
        """Sets the end_idx of this SpeechAnalyticsEmotionItem.

        End index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param end_idx: The end_idx of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this SpeechAnalyticsEmotionItem.  # noqa: E501

        end time in msec since start of audio  # noqa: E501

        :return: The end_time of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :rtype: int
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this SpeechAnalyticsEmotionItem.

        end time in msec since start of audio  # noqa: E501

        :param end_time: The end_time of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_idx(self):
        """Gets the start_idx of this SpeechAnalyticsEmotionItem.  # noqa: E501

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :return: The start_idx of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :rtype: str
        """
    ...
    def start_idx(self, start_idx):
        """Sets the start_idx of this SpeechAnalyticsEmotionItem.

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param start_idx: The start_idx of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this SpeechAnalyticsEmotionItem.  # noqa: E501

        start time in msec since start of audio  # noqa: E501

        :return: The start_time of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :rtype: int
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this SpeechAnalyticsEmotionItem.

        start time in msec since start of audio  # noqa: E501

        :param start_time: The start_time of this SpeechAnalyticsEmotionItem.  # noqa: E501
        :type: int
        """
    ...
    def mood(self):
        ...
        Map from mood enum values to number in (0.0, 1.0) range  # noqa: E501
    ...
    def sentiment(self):
        ...
        value of the sentiment from -1.0 (mad/angry) to +1.0 (happy/satisfied)  # noqa: E501
    ...
    def sentiment(self, sentiment):
        ...
        if (self.local_vars_configuration.client_side_validation and
                sentiment is not None and sentiment > 1.0):  # noqa: E501
            raise ValueError("Invalid value for `sentiment`, must be a value less than or equal to `1.0`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sentiment is not None and sentiment < -1.0):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsEmotionItem):
            return False
