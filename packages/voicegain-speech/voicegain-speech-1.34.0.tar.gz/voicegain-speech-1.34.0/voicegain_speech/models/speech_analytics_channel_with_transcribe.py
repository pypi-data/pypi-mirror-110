...
class SpeechAnalyticsChannelWithTranscribe(object):
    ...
    def audio_channel_selector(self):
        """Gets the audio_channel_selector of this SpeechAnalyticsChannelWithTranscribe.  # noqa: E501


        :return: The audio_channel_selector of this SpeechAnalyticsChannelWithTranscribe.  # noqa: E501
    ...
    def audio_channel_selector(self, audio_channel_selector):
        """Sets the audio_channel_selector of this SpeechAnalyticsChannelWithTranscribe.


        :param audio_channel_selector: The audio_channel_selector of this SpeechAnalyticsChannelWithTranscribe.  # noqa: E501
    ...
    def transcribe_session_id(self):
        """Gets the transcribe_session_id of this SpeechAnalyticsChannelWithTranscribe.  # noqa: E501

        session id for the transcription session handling this channel  # noqa: E501

        :return: The transcribe_session_id of this SpeechAnalyticsChannelWithTranscribe.  # noqa: E501
        :rtype: str
        """
        return self._transcribe_session_id

    @transcribe_session_id.setter
    def transcribe_session_id(self, transcribe_session_id):
        """Sets the transcribe_session_id of this SpeechAnalyticsChannelWithTranscribe.

        session id for the transcription session handling this channel  # noqa: E501

        :param transcribe_session_id: The transcribe_session_id of this SpeechAnalyticsChannelWithTranscribe.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                transcribe_session_id is not None and len(transcribe_session_id) > 48):
            raise ValueError("Invalid value for `transcribe_session_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                transcribe_session_id is not None and len(transcribe_session_id) < 16):
            raise ValueError("Invalid value for `transcribe_session_id`, length must be greater than or equal to `16`")  # noqa: E501

        self._transcribe_session_id = transcribe_session_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsChannelWithTranscribe):
            return False
