...
class SpeechAnalyticsBaseResult(object):
    ...
    @property
    def account_id(self):
        """Gets the account_id of this SpeechAnalyticsBaseResult.  # noqa: E501

        Voicegain Account Id  # noqa: E501

        :return: The account_id of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this SpeechAnalyticsBaseResult.

        Voicegain Account Id  # noqa: E501

        :param account_id: The account_id of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def async_mode(self):
        """Gets the async_mode of this SpeechAnalyticsBaseResult.  # noqa: E501


        :return: The async_mode of this SpeechAnalyticsBaseResult.  # noqa: E501
    ...
    def async_mode(self, async_mode):
        """Sets the async_mode of this SpeechAnalyticsBaseResult.


        :param async_mode: The async_mode of this SpeechAnalyticsBaseResult.  # noqa: E501
    ...
    @property
    def context_id(self):
        """Gets the context_id of this SpeechAnalyticsBaseResult.  # noqa: E501

        Voicegain Account Context  # noqa: E501

        :return: The context_id of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this SpeechAnalyticsBaseResult.

        Voicegain Account Context  # noqa: E501

        :param context_id: The context_id of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def creator(self):
        """Gets the creator of this SpeechAnalyticsBaseResult.  # noqa: E501

        Id of the user who started this Speech Analytics session  # noqa: E501

        :return: The creator of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: str
        """
    ...
    def creator(self, creator):
        """Sets the creator of this SpeechAnalyticsBaseResult.

        Id of the user who started this Speech Analytics session  # noqa: E501

        :param creator: The creator of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def duration_sec(self):
        """Gets the duration_sec of this SpeechAnalyticsBaseResult.  # noqa: E501

        duration [in seconds] of the audio that was transcribed  # noqa: E501

        :return: The duration_sec of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: float
        """
    ...
    def duration_sec(self, duration_sec):
        """Sets the duration_sec of this SpeechAnalyticsBaseResult.

        duration [in seconds] of the audio that was transcribed  # noqa: E501

        :param duration_sec: The duration_sec of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: float
        """
    ...
    @property
    def label(self):
        """Gets the label of this SpeechAnalyticsBaseResult.  # noqa: E501
        ...
        :return: The label of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this SpeechAnalyticsBaseResult.

        Short label assigned to the speech Analytics session. May be displayed in a table to make identifying a session easier.  # noqa: E501

        :param label: The label of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def metadata(self):
        """Gets the metadata of this SpeechAnalyticsBaseResult.  # noqa: E501
        ...
        :return: The metadata of this SpeechAnalyticsBaseResult.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this SpeechAnalyticsBaseResult.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this SpeechAnalyticsBaseResult.  # noqa: E501
    ...
    @property
    def persist(self):
        """Gets the persist of this SpeechAnalyticsBaseResult.  # noqa: E501

        Time (in msec) to retain the result/outcome data. Once this time expires the result will be deleted.   # noqa: E501

        :return: The persist of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: float
        """
    ...
    def persist(self, persist):
        """Sets the persist of this SpeechAnalyticsBaseResult.

        Time (in msec) to retain the result/outcome data. Once this time expires the result will be deleted.   # noqa: E501

        :param persist: The persist of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sa_session_id(self):
        """Gets the sa_session_id of this SpeechAnalyticsBaseResult.  # noqa: E501

        id of the Speech Analytics session  # noqa: E501

        :return: The sa_session_id of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: str
        """
    ...
    def sa_session_id(self, sa_session_id):
        """Sets the sa_session_id of this SpeechAnalyticsBaseResult.

        id of the Speech Analytics session  # noqa: E501

        :param sa_session_id: The sa_session_id of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start_time(self):
        """Gets the start_time of this SpeechAnalyticsBaseResult.  # noqa: E501

        start time of Speech Analytics session  # noqa: E501

        :return: The start_time of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this SpeechAnalyticsBaseResult.

        start time of Speech Analytics session  # noqa: E501

        :param start_time: The start_time of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this SpeechAnalyticsBaseResult.  # noqa: E501

        Tags associated with the Speech Analytics session. Each tag is a string with max length of 64 characters.  # noqa: E501

        :return: The tags of this SpeechAnalyticsBaseResult.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this SpeechAnalyticsBaseResult.

        Tags associated with the Speech Analytics session. Each tag is a string with max length of 64 characters.  # noqa: E501

        :param tags: The tags of this SpeechAnalyticsBaseResult.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def topics(self):
        """Gets the topics of this SpeechAnalyticsBaseResult.  # noqa: E501

        List of Topic Scores - a single call/transcript may have 1 or more identified in it  # noqa: E501

        :return: The topics of this SpeechAnalyticsBaseResult.  # noqa: E501
    ...
    def topics(self, topics):
        """Sets the topics of this SpeechAnalyticsBaseResult.

        List of Topic Scores - a single call/transcript may have 1 or more identified in it  # noqa: E501

        :param topics: The topics of this SpeechAnalyticsBaseResult.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsBaseResult):
            return False
