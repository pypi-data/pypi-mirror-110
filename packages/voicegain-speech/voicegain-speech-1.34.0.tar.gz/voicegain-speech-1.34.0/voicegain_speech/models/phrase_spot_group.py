...
class PhraseSpotGroup(object):
    ...
    attribute_map = {
        'group_tag': 'groupTag',
        'phrase_tags': 'phraseTags',
        'relation': 'relation'
    }

    def __init__(self, group_tag=None, phrase_tags=None, relation='any', local_vars_configuration=None):  # noqa: E501
        """PhraseSpotGroup - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._group_tag = None
        self._phrase_tags = None
        self._relation = None
        self.discriminator = None

        self.group_tag = group_tag
        self.phrase_tags = phrase_tags
        if relation is not None:
            self.relation = relation

    @property
    def group_tag(self):
        """Gets the group_tag of this PhraseSpotGroup.  # noqa: E501

        Tag used to identify this Phrase group  # noqa: E501

        :return: The group_tag of this PhraseSpotGroup.  # noqa: E501
        :rtype: str
        """
        return self._group_tag

    @group_tag.setter
    def group_tag(self, group_tag):
        """Sets the group_tag of this PhraseSpotGroup.

        Tag used to identify this Phrase group  # noqa: E501

        :param group_tag: The group_tag of this PhraseSpotGroup.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and group_tag is None:  # noqa: E501
            raise ValueError("Invalid value for `group_tag`, must not be `None`")  # noqa: E501

        self._group_tag = group_tag

    @property
    def phrase_tags(self):
        """Gets the phrase_tags of this PhraseSpotGroup.  # noqa: E501

        Tags of phrases that form this group  # noqa: E501

        :return: The phrase_tags of this PhraseSpotGroup.  # noqa: E501
        :rtype: list[str]
        """
        return self._phrase_tags

    @phrase_tags.setter
    def phrase_tags(self, phrase_tags):
        """Sets the phrase_tags of this PhraseSpotGroup.

        Tags of phrases that form this group  # noqa: E501

        :param phrase_tags: The phrase_tags of this PhraseSpotGroup.  # noqa: E501
        :type: list[str]
        """
        if self.local_vars_configuration.client_side_validation and phrase_tags is None:  # noqa: E501
            raise ValueError("Invalid value for `phrase_tags`, must not be `None`")  # noqa: E501

        self._phrase_tags = phrase_tags

    @property
    def relation(self):
        """Gets the relation of this PhraseSpotGroup.  # noqa: E501

        How the match of the individual phrases will be interpreted to trigger a match of the group: + any - any listed phrase will trigger group (OR). If used in REAL-TIME mode then each phrase match will result in a separate Phrase Group output. + all - all listed phrases have to be detected (AND). If used in REAL-TIME mode then a Phrase Group will be output once when all phrases match. + sequence - all listed phrases have to be detected in the call in the given sequence. They have to occur in consecutive sentences in the text.   # noqa: E501

        :return: The relation of this PhraseSpotGroup.  # noqa: E501
        :rtype: str
        """
    ...
    def relation(self, relation):
        """Sets the relation of this PhraseSpotGroup.

        How the match of the individual phrases will be interpreted to trigger a match of the group: + any - any listed phrase will trigger group (OR). If used in REAL-TIME mode then each phrase match will result in a separate Phrase Group output. + all - all listed phrases have to be detected (AND). If used in REAL-TIME mode then a Phrase Group will be output once when all phrases match. + sequence - all listed phrases have to be detected in the call in the given sequence. They have to occur in consecutive sentences in the text.   # noqa: E501

        :param relation: The relation of this PhraseSpotGroup.  # noqa: E501
        :type: str
        """
        allowed_values = ["any", "all", "sequence"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and relation not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhraseSpotGroup):
            return False
