...
class KeywordSpotItem(object):
    ...
    def __init__(self, examples=None, expand=False, hide=False, tag=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def examples(self):
        """Gets the examples of this KeywordSpotItem.  # noqa: E501

        words or short phrases that need to match to spot the keyword  # noqa: E501

        :return: The examples of this KeywordSpotItem.  # noqa: E501
        :rtype: list[KeywordSpotExample]
        """
        return self._examples

    @examples.setter
    def examples(self, examples):
        """Sets the examples of this KeywordSpotItem.

        words or short phrases that need to match to spot the keyword  # noqa: E501

        :param examples: The examples of this KeywordSpotItem.  # noqa: E501
        :type: list[KeywordSpotExample]
        """
        if self.local_vars_configuration.client_side_validation and examples is None:  # noqa: E501
    ...
    @property
    def hide(self):
        """Gets the hide of this KeywordSpotItem.  # noqa: E501

        If true then do not return this keyword directly, intended for keywords which are part of a group,  where the goal is to return the group Tag not the individual keyword tags.    # noqa: E501

        :return: The hide of this KeywordSpotItem.  # noqa: E501
        :rtype: bool
        """
        return self._hide
    ...
    @hide.setter
    def hide(self, hide):
        """Sets the hide of this KeywordSpotItem.

        If true then do not return this keyword directly, intended for keywords which are part of a group,  where the goal is to return the group Tag not the individual keyword tags.    # noqa: E501

        :param hide: The hide of this KeywordSpotItem.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this KeywordSpotItem.  # noqa: E501

        Tag to return if keyword in this category is spotted.  # noqa: E501

        :return: The tag of this KeywordSpotItem.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this KeywordSpotItem.

        Tag to return if keyword in this category is spotted.  # noqa: E501

        :param tag: The tag of this KeywordSpotItem.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordSpotItem):
            return False
