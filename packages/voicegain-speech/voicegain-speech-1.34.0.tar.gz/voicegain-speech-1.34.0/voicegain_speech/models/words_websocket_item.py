...
class WordsWebsocketItem(object):
    ...
    def __init__(self, conf=None, gap=None, spk=None, start=None, utt=None, _del=None, edit=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def conf(self):
        """Gets the conf of this WordsWebsocketItem.  # noqa: E501

        confidence of the utterance  # noqa: E501

        :return: The conf of this WordsWebsocketItem.  # noqa: E501
        :rtype: float
        """
        return self._conf
    ...
    @conf.setter
    def conf(self, conf):
        """Sets the conf of this WordsWebsocketItem.

        confidence of the utterance  # noqa: E501

        :param conf: The conf of this WordsWebsocketItem.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                conf is not None and conf > 1.0):  # noqa: E501
            raise ValueError("Invalid value for `conf`, must be a value less than or equal to `1.0`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                conf is not None and conf < 0.0):  # noqa: E501
            raise ValueError("Invalid value for `conf`, must be a value greater than or equal to `0.0`")  # noqa: E501

        self._conf = conf

    @property
    def gap(self):
        """Gets the gap of this WordsWebsocketItem.  # noqa: E501

        gap in ms between start of this word and the end of the previous word  # noqa: E501

        :return: The gap of this WordsWebsocketItem.  # noqa: E501
        :rtype: int
        """
        return self._gap
    ...
    @gap.setter
    def gap(self, gap):
        """Sets the gap of this WordsWebsocketItem.

        gap in ms between start of this word and the end of the previous word  # noqa: E501

        :param gap: The gap of this WordsWebsocketItem.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                gap is not None and gap < 0):  # noqa: E501
            raise ValueError("Invalid value for `gap`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def start(self):
        ...
        position of the start of the utterance in milliseconds from start of audio  # noqa: E501
    ...
    @property
    def utt(self):
        """Gets the utt of this WordsWebsocketItem.  # noqa: E501

        utterance - the word that was recognized  # noqa: E501

        :return: The utt of this WordsWebsocketItem.  # noqa: E501
        :rtype: str
        """
        return self._utt
    ...
    @utt.setter
    def utt(self, utt):
        """Sets the utt of this WordsWebsocketItem.

        utterance - the word that was recognized  # noqa: E501

        :param utt: The utt of this WordsWebsocketItem.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                utt is not None and len(utt) < 1):
    ...
    @property
    def _del(self):
        """Gets the _del of this WordsWebsocketItem.  # noqa: E501

        number of previously sent recognized words to delete  # noqa: E501

        :return: The _del of this WordsWebsocketItem.  # noqa: E501
        :rtype: float
        """
        return self.__del
    ...
    @_del.setter
    def _del(self, _del):
        """Sets the _del of this WordsWebsocketItem.

        number of previously sent recognized words to delete  # noqa: E501

        :param _del: The _del of this WordsWebsocketItem.  # noqa: E501
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and _del is None:  # noqa: E501
            raise ValueError("Invalid value for `_del`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                _del is not None and _del < 1):  # noqa: E501
            raise ValueError("Invalid value for `_del`, must be a value greater than or equal to `1`")  # noqa: E501

        self.__del = _del

    @property
    def edit(self):
        """Gets the edit of this WordsWebsocketItem.  # noqa: E501


        :return: The edit of this WordsWebsocketItem.  # noqa: E501
        :rtype: list[StompWsWord]
        """
        return self._edit

    @edit.setter
    def edit(self, edit):
        """Sets the edit of this WordsWebsocketItem.


        :param edit: The edit of this WordsWebsocketItem.  # noqa: E501
        :type: list[StompWsWord]
        """
