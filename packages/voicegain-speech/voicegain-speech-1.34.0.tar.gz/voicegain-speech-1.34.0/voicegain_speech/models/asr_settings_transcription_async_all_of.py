...
class AsrSettingsTranscriptionAsyncAllOf(object):
    ...
    def __init__(self, start_input_timers=False, local_vars_configuration=None):  # noqa: E501
        """AsrSettingsTranscriptionAsyncAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def start_input_timers(self):
        """Gets the start_input_timers of this AsrSettingsTranscriptionAsyncAllOf.  # noqa: E501
        ...
        :return: The start_input_timers of this AsrSettingsTranscriptionAsyncAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def start_input_timers(self, start_input_timers):
        """Sets the start_input_timers of this AsrSettingsTranscriptionAsyncAllOf.

        (Optional) By default input timers for transcription are disabled (set to false) which means  that START-OF-INPUT is generated at the very start of audio stream and the transcription will continue until the audio stream stops. This parameter can be used to enable input timers -- input timers are useful for generating NO-INPUT results (based on `noInputTimeout`)  plus for terminating transcription upon silence following the utterance (based on `completeTimeout`). </br> NOTE: the default value of startInputTimers for transcription is opposite of the default for recognition.         # noqa: E501

        :param start_input_timers: The start_input_timers of this AsrSettingsTranscriptionAsyncAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsTranscriptionAsyncAllOf):
            return False
