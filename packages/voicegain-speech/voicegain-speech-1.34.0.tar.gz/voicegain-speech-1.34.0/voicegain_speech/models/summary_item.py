...
class SummaryItem(object):
    ...
    def __init__(self, summary_fragment=None, end_idx=None, end_time=None, start_idx=None, start_time=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def summary_fragment(self):
        """Gets the summary_fragment of this SummaryItem.  # noqa: E501

        part of the summary  # noqa: E501

        :return: The summary_fragment of this SummaryItem.  # noqa: E501
        :rtype: str
        """
        return self._summary_fragment

    @summary_fragment.setter
    def summary_fragment(self, summary_fragment):
        """Sets the summary_fragment of this SummaryItem.

        part of the summary  # noqa: E501

        :param summary_fragment: The summary_fragment of this SummaryItem.  # noqa: E501
        :type: str
        """

        self._summary_fragment = summary_fragment

    @property
    def end_idx(self):
        """Gets the end_idx of this SummaryItem.  # noqa: E501
        ...
        :return: The end_idx of this SummaryItem.  # noqa: E501
        :rtype: str
        """
    ...
    def end_idx(self, end_idx):
        """Sets the end_idx of this SummaryItem.

        End index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param end_idx: The end_idx of this SummaryItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this SummaryItem.  # noqa: E501

        end time in msec since start of audio  # noqa: E501

        :return: The end_time of this SummaryItem.  # noqa: E501
        :rtype: int
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this SummaryItem.

        end time in msec since start of audio  # noqa: E501

        :param end_time: The end_time of this SummaryItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def start_idx(self):
        """Gets the start_idx of this SummaryItem.  # noqa: E501

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :return: The start_idx of this SummaryItem.  # noqa: E501
        :rtype: str
        """
    ...
    def start_idx(self, start_idx):
        """Sets the start_idx of this SummaryItem.

        Start index of a word.</br> This can be a simple index into a list of words, e.g. '5' indicating the 5th word - the first word index is '1'.</br> Alternatively it may be a complex index, e.g., 'lin=5&csec=2.3' where 'lin=5' indicates position '5' of a linear index, and 'csec=2.3' indicates combined sectional index with section #2 and word #3 in that section.  Combined sectional index e.g. identifies words within multiChannelWords field, where the two channel words are combined and then grouped into sections.   # noqa: E501

        :param start_idx: The start_idx of this SummaryItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this SummaryItem.  # noqa: E501

        start time in msec since start of audio  # noqa: E501

        :return: The start_time of this SummaryItem.  # noqa: E501
        :rtype: int
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this SummaryItem.

        start time in msec since start of audio  # noqa: E501

        :param start_time: The start_time of this SummaryItem.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SummaryItem):
            return False
