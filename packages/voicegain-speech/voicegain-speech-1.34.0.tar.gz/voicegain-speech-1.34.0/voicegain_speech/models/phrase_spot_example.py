...
class PhraseSpotExample(object):
    ...
    def sentence(self, sentence):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and sentence is None:  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhraseSpotExample):
            return False
