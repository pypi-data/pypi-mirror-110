...
class SpeechAnalyticsResultDetail(object):
    ...
    def __init__(self, channels=None, cr_answers_id=None, incidents=None, multi_channel_audio=None, multi_channel_diarization=None, multi_channel_words=None, phrase_groups=None, silence=None, single_channel_audio=None, summary=None, word_cloud=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def channels(self):
        """Gets the channels of this SpeechAnalyticsResultDetail.  # noqa: E501
        ...
        :return: The channels of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def channels(self, channels):
        """Sets the channels of this SpeechAnalyticsResultDetail.

        Speech analytics results specific to each channel.</br> Value of `channels[].audioChannelSelector` tells us how the channel corresponds to the original audio.   # noqa: E501

        :param channels: The channels of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    @property
    def incidents(self):
        """Gets the incidents of this SpeechAnalyticsResultDetail.  # noqa: E501

        List of detected incidents (silence, overtalk) during the call.   # noqa: E501

        :return: The incidents of this SpeechAnalyticsResultDetail.  # noqa: E501
        :rtype: list[Incident]
        """
    ...
    def incidents(self, incidents):
        """Sets the incidents of this SpeechAnalyticsResultDetail.

        List of detected incidents (silence, overtalk) during the call.   # noqa: E501

        :param incidents: The incidents of this SpeechAnalyticsResultDetail.  # noqa: E501
        :type: list[Incident]
        """
    ...
    def multi_channel_audio(self):
        """Gets the multi_channel_audio of this SpeechAnalyticsResultDetail.  # noqa: E501
        ...
        :return: The multi_channel_audio of this SpeechAnalyticsResultDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def multi_channel_audio(self, multi_channel_audio):
        """Sets the multi_channel_audio of this SpeechAnalyticsResultDetail.

        UUID of a Data Object containing multichannel audio if applicable. If diarization was performed then this will be simulated multichannel (stereo) audio.     Currently, multi-channel means dual-channel. </br> NOTE: `multiChannelAudio` data if present will be accompanied by `multiChannelDiarization` and `multiChannelWords` data. That data could also be obtained from the transcription session(s) referenced by `channels.transcribeSid`, however,  is provided here so that Web UI does not have to do extra processing to generate it.   # noqa: E501

        :param multi_channel_audio: The multi_channel_audio of this SpeechAnalyticsResultDetail.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def multi_channel_diarization(self):
        """Gets the multi_channel_diarization of this SpeechAnalyticsResultDetail.  # noqa: E501


        :return: The multi_channel_diarization of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def multi_channel_diarization(self, multi_channel_diarization):
        """Sets the multi_channel_diarization of this SpeechAnalyticsResultDetail.


        :param multi_channel_diarization: The multi_channel_diarization of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def multi_channel_words(self):
        """Gets the multi_channel_words of this SpeechAnalyticsResultDetail.  # noqa: E501
        ...
        :return: The multi_channel_words of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def multi_channel_words(self, multi_channel_words):
        """Sets the multi_channel_words of this SpeechAnalyticsResultDetail.

        Words data for multi-channel case ready to be consumed by web-ui. If we have real multi-channel input audio then the words will be merged from all channels. If the multi-channel is virtual, then the words data will be just a copy from transcription session.   # noqa: E501

        :param multi_channel_words: The multi_channel_words of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def phrase_groups(self):
        """Gets the phrase_groups of this SpeechAnalyticsResultDetail.  # noqa: E501


        :return: The phrase_groups of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def phrase_groups(self, phrase_groups):
        """Sets the phrase_groups of this SpeechAnalyticsResultDetail.


        :param phrase_groups: The phrase_groups of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    @property
    def silence(self):
        """Gets the silence of this SpeechAnalyticsResultDetail.  # noqa: E501


        :return: The silence of this SpeechAnalyticsResultDetail.  # noqa: E501
        :rtype: Silence
        """
    ...
    def silence(self, silence):
        """Sets the silence of this SpeechAnalyticsResultDetail.


        :param silence: The silence of this SpeechAnalyticsResultDetail.  # noqa: E501
        :type: Silence
        """
    ...
    def single_channel_audio(self):
        """Gets the single_channel_audio of this SpeechAnalyticsResultDetail.  # noqa: E501

        UUID of a Data Object containing single channel audio if applicable.   # noqa: E501

        :return: The single_channel_audio of this SpeechAnalyticsResultDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def single_channel_audio(self, single_channel_audio):
        """Sets the single_channel_audio of this SpeechAnalyticsResultDetail.

        UUID of a Data Object containing single channel audio if applicable.   # noqa: E501

        :param single_channel_audio: The single_channel_audio of this SpeechAnalyticsResultDetail.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def summary(self):
        """Gets the summary of this SpeechAnalyticsResultDetail.  # noqa: E501

        Most characteristic sentences from the transcript. Can be used as a summary for the entire text.  # noqa: E501

        :return: The summary of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def summary(self, summary):
        """Sets the summary of this SpeechAnalyticsResultDetail.

        Most characteristic sentences from the transcript. Can be used as a summary for the entire text.  # noqa: E501

        :param summary: The summary of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    @property
    def word_cloud(self):
        """Gets the word_cloud of this SpeechAnalyticsResultDetail.  # noqa: E501

        Components of the Word Cloud (combined accross channels)  # noqa: E501

        :return: The word_cloud of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def word_cloud(self, word_cloud):
        """Sets the word_cloud of this SpeechAnalyticsResultDetail.

        Components of the Word Cloud (combined accross channels)  # noqa: E501

        :param word_cloud: The word_cloud of this SpeechAnalyticsResultDetail.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsResultDetail):
            return False
