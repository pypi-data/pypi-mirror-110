...
class WordCloudItem(object):
    ...
    def __init__(self, freq=None, phrase=None, local_vars_configuration=None):  # noqa: E501
        """WordCloudItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def freq(self):
        """Gets the freq of this WordCloudItem.  # noqa: E501

        number of times the word/phrase occurs  # noqa: E501

        :return: The freq of this WordCloudItem.  # noqa: E501
        :rtype: int
        """
        return self._freq
    ...
    @freq.setter
    def freq(self, freq):
        """Sets the freq of this WordCloudItem.

        number of times the word/phrase occurs  # noqa: E501

        :param freq: The freq of this WordCloudItem.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                freq is not None and freq < 1):  # noqa: E501
            raise ValueError("Invalid value for `freq`, must be a value greater than or equal to `1`")  # noqa: E501

        self._freq = freq

    @property
    def phrase(self):
        """Gets the phrase of this WordCloudItem.  # noqa: E501

        word or short phrase  # noqa: E501

        :return: The phrase of this WordCloudItem.  # noqa: E501
        :rtype: str
        """
        return self._phrase
    ...
    def phrase(self, phrase):
        """Sets the phrase of this WordCloudItem.

        word or short phrase  # noqa: E501

        :param phrase: The phrase of this WordCloudItem.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                phrase is not None and len(phrase) > 128):
            raise ValueError("Invalid value for `phrase`, length must be less than or equal to `128`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                phrase is not None and len(phrase) < 1):
            raise ValueError("Invalid value for `phrase`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordCloudItem):
            return False
