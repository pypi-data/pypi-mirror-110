...
class AsrSettingsTranscriptionDefaultTimeouts(object):
    ...
    def __init__(self, complete_timeout=-1, no_input_timeout=15000, local_vars_configuration=None):  # noqa: E501
        """AsrSettingsTranscriptionDefaultTimeouts - a model defined in OpenAPI"""  # noqa: E501
    ...
    def complete_timeout(self):
        """Gets the complete_timeout of this AsrSettingsTranscriptionDefaultTimeouts.  # noqa: E501
        ...
        :return: The complete_timeout of this AsrSettingsTranscriptionDefaultTimeouts.  # noqa: E501
        :rtype: int
        """
    ...
    def complete_timeout(self, complete_timeout):
        """Sets the complete_timeout of this AsrSettingsTranscriptionDefaultTimeouts.

        (Applies to Real-Time transcription only)</br> Timeout in milliseconds that determines when transcription will stop.  Kicks in once speech has been detected. The timeout threshold is applied to the duration of non-speech following most recent speech. </br> Any value <= 0 means that the timeout will be ignored and transcription will continue until the audio stream is stopped.   # noqa: E501

        :param complete_timeout: The complete_timeout of this AsrSettingsTranscriptionDefaultTimeouts.  # noqa: E501
        :type: int
        """
    ...
    def no_input_timeout(self):
        """Gets the no_input_timeout of this AsrSettingsTranscriptionDefaultTimeouts.  # noqa: E501
        ...
        :return: The no_input_timeout of this AsrSettingsTranscriptionDefaultTimeouts.  # noqa: E501
        :rtype: int
        """
    ...
    def no_input_timeout(self, no_input_timeout):
        """Sets the no_input_timeout of this AsrSettingsTranscriptionDefaultTimeouts.

        (Applies to Real-Time transcription only)</br> Time in milliseconds to wait for speech in audio to start. The wait starts either from:</br> (a) the start of audio if `startInputTimers==true`(the default) </br> (b) other point in time when input timers are enabled (e.g. when prompt finishes playing in `<Connect><Stream>` use case)</br> If the timeout expires due to no speech input then the transcription will be terminated.</br> Any value <= 0 means that the timeout will be ignored. Default value is 15 seconds.   # noqa: E501

        :param no_input_timeout: The no_input_timeout of this AsrSettingsTranscriptionDefaultTimeouts.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsTranscriptionDefaultTimeouts):
            return False
