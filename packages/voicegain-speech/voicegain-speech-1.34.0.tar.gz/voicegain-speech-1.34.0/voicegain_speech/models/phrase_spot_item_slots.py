...
class PhraseSpotItemSlots(object):
    ...
    """
    openapi_types = {
        'entities': 'list[SlotEntity]',
        'keywords': 'list[SlotKeyword]'
    }
    ...
    def __init__(self, entities=None, keywords=None, local_vars_configuration=None):  # noqa: E501
        """PhraseSpotItemSlots - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def entities(self):
        """Gets the entities of this PhraseSpotItemSlots.  # noqa: E501

        Named Entities to be found in the phrase match  # noqa: E501

        :return: The entities of this PhraseSpotItemSlots.  # noqa: E501
        :rtype: list[SlotEntity]
        """
        return self._entities

    @entities.setter
    def entities(self, entities):
        """Sets the entities of this PhraseSpotItemSlots.

        Named Entities to be found in the phrase match  # noqa: E501

        :param entities: The entities of this PhraseSpotItemSlots.  # noqa: E501
        :type: list[SlotEntity]
        """
    ...
    @property
    def keywords(self):
        """Gets the keywords of this PhraseSpotItemSlots.  # noqa: E501

        Keywords to be found in the phrase match  # noqa: E501

        :return: The keywords of this PhraseSpotItemSlots.  # noqa: E501
        :rtype: list[SlotKeyword]
        """
        return self._keywords

    @keywords.setter
    def keywords(self, keywords):
        """Sets the keywords of this PhraseSpotItemSlots.

        Keywords to be found in the phrase match  # noqa: E501

        :param keywords: The keywords of this PhraseSpotItemSlots.  # noqa: E501
        :type: list[SlotKeyword]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhraseSpotItemSlots):
            return False
