...
class AsyncRecognitionCallbackResponse(object):
    ...
    def __init__(self, stop=False, local_vars_configuration=None):  # noqa: E501
        """AsyncRecognitionCallbackResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def stop(self):
        """Gets the stop of this AsyncRecognitionCallbackResponse.  # noqa: E501

        (Optional) If set to true then the recognition will terminate even if this was not the final callback. Meant to be used with continuous recognition.   # noqa: E501

        :return: The stop of this AsyncRecognitionCallbackResponse.  # noqa: E501
        :rtype: bool
        """
        return self._stop
    ...
    @stop.setter
    def stop(self, stop):
        """Sets the stop of this AsyncRecognitionCallbackResponse.

        (Optional) If set to true then the recognition will terminate even if this was not the final callback. Meant to be used with continuous recognition.   # noqa: E501

        :param stop: The stop of this AsyncRecognitionCallbackResponse.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncRecognitionCallbackResponse):
            return False
