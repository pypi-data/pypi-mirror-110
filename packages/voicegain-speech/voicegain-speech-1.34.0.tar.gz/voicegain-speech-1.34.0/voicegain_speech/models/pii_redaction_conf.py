...
class PIIRedactionConf(object):
    ...
    def named_entity(self):
        """Gets the named_entity of this PIIRedactionConf.  # noqa: E501
    ...
    @named_entity.setter
    def named_entity(self, named_entity):
        """Sets the named_entity of this PIIRedactionConf.
    ...
    def redact_audio(self, redact_audio):
        ...
        :type: str
        """
        allowed_values = ["silence", "beep"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and redact_audio not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `redact_audio` ({0}), must be one of {1}"  # noqa: E501
                .format(redact_audio, allowed_values)
            )
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PIIRedactionConf):
            return False
