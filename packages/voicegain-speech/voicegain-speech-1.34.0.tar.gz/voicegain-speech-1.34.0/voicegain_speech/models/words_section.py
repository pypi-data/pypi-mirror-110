...
class WordsSection(object):
    ...
    def __init__(self, spk=None, start=None, words=None, local_vars_configuration=None):  # noqa: E501
        """WordsSection - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def spk(self):
        """Gets the spk of this WordsSection.  # noqa: E501
        ...
        **(beta)** If diarization is enabled then this field will contain the speaker index for this word. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.   Value of 0 may also be output for the `spk` if the system cannot assign diarization.   # noqa: E501
        ...
        :return: The spk of this WordsSection.  # noqa: E501
        :rtype: int
        """
        return self._spk
    ...
    @spk.setter
    def spk(self, spk):
        """Sets the spk of this WordsSection.

        **(beta)** If diarization is enabled then this field will contain the speaker index for this word. Speaker index is an integer from `1` up to at most `diarization.maxSpeakers`.   Value of 0 may also be output for the `spk` if the system cannot assign diarization.   # noqa: E501

        :param spk: The spk of this WordsSection.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordsSection):
            return False
