...
class SpeechAnalyticsPhraseGroupData(object):
    ...
    openapi_types = {
        'counts': 'dict(str, str)',
        'list': 'list[SpeechAnalyticsPhraseGroupItem]'
    }
    ...
    def __init__(self, counts=None, list=None, local_vars_configuration=None):  # noqa: E501
        """SpeechAnalyticsPhraseGroupData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def counts(self):
        """Gets the counts of this SpeechAnalyticsPhraseGroupData.  # noqa: E501

        Map from from phrase group tag to the count of number spotted  # noqa: E501

        :return: The counts of this SpeechAnalyticsPhraseGroupData.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._counts
    ...
    def counts(self, counts):
        """Sets the counts of this SpeechAnalyticsPhraseGroupData.

        Map from from phrase group tag to the count of number spotted  # noqa: E501

        :param counts: The counts of this SpeechAnalyticsPhraseGroupData.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def list(self):
        """Gets the list of this SpeechAnalyticsPhraseGroupData.  # noqa: E501

        List of all phrase groups detected with their locations in recording and transcript.  # noqa: E501

        :return: The list of this SpeechAnalyticsPhraseGroupData.  # noqa: E501
        :rtype: list[SpeechAnalyticsPhraseGroupItem]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this SpeechAnalyticsPhraseGroupData.

        List of all phrase groups detected with their locations in recording and transcript.  # noqa: E501

        :param list: The list of this SpeechAnalyticsPhraseGroupData.  # noqa: E501
        :type: list[SpeechAnalyticsPhraseGroupItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsPhraseGroupData):
            return False
