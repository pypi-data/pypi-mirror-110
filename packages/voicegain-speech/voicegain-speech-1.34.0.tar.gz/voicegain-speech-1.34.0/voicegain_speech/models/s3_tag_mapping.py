...
class S3TagMapping(object):
    ...
    """
    openapi_types = {
        'map_value_to': 'CallAttributes',
        'tag_key': 'str'
    }

    attribute_map = {
        'map_value_to': 'mapValueTo',
        'tag_key': 'tagKey'
    }

    def __init__(self, map_value_to=None, tag_key=None, local_vars_configuration=None):  # noqa: E501
        """S3TagMapping - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._map_value_to = None
        self._tag_key = None
        self.discriminator = None

        if map_value_to is not None:
            self.map_value_to = map_value_to
        if tag_key is not None:
            self.tag_key = tag_key

    @property
    def map_value_to(self):
        """Gets the map_value_to of this S3TagMapping.  # noqa: E501


        :return: The map_value_to of this S3TagMapping.  # noqa: E501
        :rtype: CallAttributes
        """
        return self._map_value_to

    @map_value_to.setter
    def map_value_to(self, map_value_to):
        """Sets the map_value_to of this S3TagMapping.


        :param map_value_to: The map_value_to of this S3TagMapping.  # noqa: E501
        :type: CallAttributes
        """

        self._map_value_to = map_value_to

    @property
    def tag_key(self):
        """Gets the tag_key of this S3TagMapping.  # noqa: E501

        name of the tag attached to S3 object  # noqa: E501

        :return: The tag_key of this S3TagMapping.  # noqa: E501
        :rtype: str
        """
    ...
    def tag_key(self, tag_key):
        """Sets the tag_key of this S3TagMapping.

        name of the tag attached to S3 object  # noqa: E501

        :param tag_key: The tag_key of this S3TagMapping.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                tag_key is not None and len(tag_key) > 128):
            raise ValueError("Invalid value for `tag_key`, length must be less than or equal to `128`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                tag_key is not None and len(tag_key) < 1):
            raise ValueError("Invalid value for `tag_key`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, S3TagMapping):
            return False
