...
class DemoAllOf(object):
    ...
    def __init__(self, end_date=None, start_date=None, token=None, local_vars_configuration=None):  # noqa: E501
        """DemoAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end_date(self):
        """Gets the end_date of this DemoAllOf.  # noqa: E501

        End date of the demo data (furthest in the past). For example 30 days ago.  # noqa: E501

        :return: The end_date of this DemoAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_date(self, end_date):
        """Sets the end_date of this DemoAllOf.

        End date of the demo data (furthest in the past). For example 30 days ago.  # noqa: E501

        :param end_date: The end_date of this DemoAllOf.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def start_date(self):
        """Gets the start_date of this DemoAllOf.  # noqa: E501

        Start date of the demo data (closest to now). Typically today.  # noqa: E501

        :return: The start_date of this DemoAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this DemoAllOf.

        Start date of the demo data (closest to now). Typically today.  # noqa: E501

        :param start_date: The start_date of this DemoAllOf.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def token(self):
        """Gets the token of this DemoAllOf.  # noqa: E501

        Token that has to be provided in order to be able to create the demo integration. Will be matched agains the token stored on the account. This is order to allow only the approved accounts to use the data provided in the demo integration.   # noqa: E501

        :return: The token of this DemoAllOf.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this DemoAllOf.

        Token that has to be provided in order to be able to create the demo integration. Will be matched agains the token stored on the account. This is order to allow only the approved accounts to use the data provided in the demo integration.   # noqa: E501

        :param token: The token of this DemoAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DemoAllOf):
            return False
