...
class AsrSettingsTranscriptionDefaults(object):
    ...
    def acoustic_model_non_real_time(self):
        """Gets the acoustic_model_non_real_time of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        ...
        :return: The acoustic_model_non_real_time of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model_non_real_time(self, acoustic_model_non_real_time):
        """Sets the acoustic_model_non_real_time of this AsrSettingsTranscriptionDefaults.

        (Optional) Name of an Acoustic Model that is to be used for offline and semi-real-time processing.  May include version number separated by `:` , for example, **Voicegain-BD_en-us:11** </br> If not provided a suitable default will be used.   # noqa: E501

        :param acoustic_model_non_real_time: The acoustic_model_non_real_time of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :type: str
        """
    ...
    def acoustic_model_real_time(self):
        """Gets the acoustic_model_real_time of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        ...
        :return: The acoustic_model_real_time of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model_real_time(self, acoustic_model_real_time):
        """Sets the acoustic_model_real_time of this AsrSettingsTranscriptionDefaults.

        (Optional) Name of a real-time capable Acoustic Model.  May include version number separated by `:`, for example, **Voicegain-IVR_en-us:3**</br> If not provided a suitable default will be used.   # noqa: E501

        :param acoustic_model_real_time: The acoustic_model_real_time of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :type: str
        """
    ...
    def confidence_threshold(self):
        """Gets the confidence_threshold of this AsrSettingsTranscriptionDefaults.  # noqa: E501

        Hypotheses below this threshold will result in NOMATCH  # noqa: E501

        :return: The confidence_threshold of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :rtype: float
        """
    ...
    def confidence_threshold(self, confidence_threshold):
        """Sets the confidence_threshold of this AsrSettingsTranscriptionDefaults.

        Hypotheses below this threshold will result in NOMATCH  # noqa: E501

        :param confidence_threshold: The confidence_threshold of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :type: float
        """
    ...
    def max_alternatives(self):
        """Gets the max_alternatives of this AsrSettingsTranscriptionDefaults.  # noqa: E501

        number of recognition hypotheses to return as result (top N-Best)  # noqa: E501

        :return: The max_alternatives of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :rtype: int
        """
    ...
    def max_alternatives(self, max_alternatives):
        """Sets the max_alternatives of this AsrSettingsTranscriptionDefaults.

        number of recognition hypotheses to return as result (top N-Best)  # noqa: E501

        :param max_alternatives: The max_alternatives of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sensitivity(self):
        """Gets the sensitivity of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        ...
        :return: The sensitivity of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :rtype: float
        """
    ...
    def sensitivity(self, sensitivity):
        """Sets the sensitivity of this AsrSettingsTranscriptionDefaults.

        Affects start-of-speech and end-of-speech detection. </br> 1 is most sensitive and corresponds to -90 dbFS </br> 0 is least sensitive and corresponds to -50 dbFS   # noqa: E501

        :param sensitivity: The sensitivity of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def speed_vs_accuracy(self):
        """Gets the speed_vs_accuracy of this AsrSettingsTranscriptionDefaults.  # noqa: E501

        between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use  # noqa: E501

        :return: The speed_vs_accuracy of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :rtype: float
        """
    ...
    def speed_vs_accuracy(self, speed_vs_accuracy):
        """Sets the speed_vs_accuracy of this AsrSettingsTranscriptionDefaults.

        between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use  # noqa: E501

        :param speed_vs_accuracy: The speed_vs_accuracy of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def no_input_timeout(self):
        """Gets the no_input_timeout of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        ...
        :return: The no_input_timeout of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :rtype: int
        """
    ...
    def no_input_timeout(self, no_input_timeout):
        """Sets the no_input_timeout of this AsrSettingsTranscriptionDefaults.

        (Applies to Real-Time transcription only)</br> Time in milliseconds to wait for speech in audio to start. The wait starts either from:</br> (a) the start of audio if `startInputTimers==true`(the default) </br> (b) other point in time when input timers are enabled (e.g. when prompt finishes playing in `<Connect><Stream>` use case)</br> If the timeout expires due to no speech input then the transcription will be terminated.</br> Any value <= 0 means that the timeout will be ignored. Default value is 15 seconds.   # noqa: E501

        :param no_input_timeout: The no_input_timeout of this AsrSettingsTranscriptionDefaults.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsTranscriptionDefaults):
            return False
