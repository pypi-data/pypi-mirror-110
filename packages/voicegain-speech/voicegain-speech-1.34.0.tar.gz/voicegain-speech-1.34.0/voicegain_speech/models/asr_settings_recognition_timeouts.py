...
class AsrSettingsRecognitionTimeouts(object):
    ...
    def __init__(self, complete_timeout=2000, incomplete_timeout=5000, lang_model=None, no_input_timeout=10000, local_vars_configuration=None):  # noqa: E501
        """AsrSettingsRecognitionTimeouts - a model defined in OpenAPI"""  # noqa: E501
    ...
    def complete_timeout(self):
        """Gets the complete_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        ...
        :return: The complete_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :rtype: int
        """
    ...
    def complete_timeout(self, complete_timeout):
        """Sets the complete_timeout of this AsrSettingsRecognitionTimeouts.

        ASR complete timeout (in msec). Kicks in after grammar match has been completed and no more valid input is possible.  # noqa: E501

        :param complete_timeout: The complete_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :type: int
        """
    ...
    def incomplete_timeout(self):
        """Gets the incomplete_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        ...
        :return: The incomplete_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :rtype: int
        """
    ...
    def incomplete_timeout(self, incomplete_timeout):
        """Sets the incomplete_timeout of this AsrSettingsRecognitionTimeouts.

        ASR incomplete timeout (in msec). Kicks in when start-of-speech was detected. Lasts until grammar allows for more valid input.  # noqa: E501

        :param incomplete_timeout: The incomplete_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def lang_model(self):
        """Gets the lang_model of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        ...
        :return: The lang_model of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :rtype: str
        """
    ...
    def lang_model(self, lang_model):
        """Sets the lang_model of this AsrSettingsRecognitionTimeouts.

        (Only applicable if large-vocabulary recognition has been enabled by using the special transcribe grammar.) </br>   Name or UUID of the language model to use. If absent then will use default language model.   # noqa: E501

        :param lang_model: The lang_model of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def no_input_timeout(self):
        """Gets the no_input_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :return: The no_input_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :rtype: int
        """
    ...
    def no_input_timeout(self, no_input_timeout):
        """Sets the no_input_timeout of this AsrSettingsRecognitionTimeouts.

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :param no_input_timeout: The no_input_timeout of this AsrSettingsRecognitionTimeouts.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsRecognitionTimeouts):
            return False
