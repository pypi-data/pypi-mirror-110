...
class PhraseSpotItemLocationDialogue(object):
    ...
    def __init__(self, built_in=None, dialogue_act=None, local_vars_configuration=None):  # noqa: E501
        """PhraseSpotItemLocationDialogue - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._built_in = None
        self._dialogue_act = None
    ...
    @property
    def built_in(self):
        """Gets the built_in of this PhraseSpotItemLocationDialogue.  # noqa: E501

        Custom dialog acts defined by Voicegain. Specify one or more if applicable.  # noqa: E501

        :return: The built_in of this PhraseSpotItemLocationDialogue.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def built_in(self, built_in):
        """Sets the built_in of this PhraseSpotItemLocationDialogue.

        Custom dialog acts defined by Voicegain. Specify one or more if applicable.  # noqa: E501

        :param built_in: The built_in of this PhraseSpotItemLocationDialogue.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["CallerIntent", "Statement", "NonUnderstandingSignal", "Thanking", "Apology", "ApologyResponse", "Question", "QuestionYesNo", "QuestionWH", "Answer", "AnswerYesNo", "AnswerYes", "AnswerNo"]  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                not set(built_in).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
                "Invalid values for `built_in` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(built_in) - set(allowed_values))),  # noqa: E501
    ...
    def dialogue_act(self):
        """Gets the dialogue_act of this PhraseSpotItemLocationDialogue.  # noqa: E501

        Advanced setting. Use values from https://web.stanford.edu/~jurafsky/ws97/manual.august1.html, first table, column SWBD.</br> Specify one or more if applicable.   # noqa: E501

        :return: The dialogue_act of this PhraseSpotItemLocationDialogue.  # noqa: E501
        :rtype: list[str]
        """
        return self._dialogue_act

    @dialogue_act.setter
    def dialogue_act(self, dialogue_act):
        """Sets the dialogue_act of this PhraseSpotItemLocationDialogue.

        Advanced setting. Use values from https://web.stanford.edu/~jurafsky/ws97/manual.august1.html, first table, column SWBD.</br> Specify one or more if applicable.   # noqa: E501

        :param dialogue_act: The dialogue_act of this PhraseSpotItemLocationDialogue.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhraseSpotItemLocationDialogue):
            return False
