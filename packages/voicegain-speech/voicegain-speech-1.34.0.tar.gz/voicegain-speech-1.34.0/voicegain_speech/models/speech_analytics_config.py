...
class SpeechAnalyticsConfig(object):
    ...
    @property
    def account_id(self):
        """Gets the account_id of this SpeechAnalyticsConfig.  # noqa: E501


        :return: The account_id of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this SpeechAnalyticsConfig.


        :param account_id: The account_id of this SpeechAnalyticsConfig.  # noqa: E501
        :type: str
        """
    ...
    @property
    def context_id(self):
        """Gets the context_id of this SpeechAnalyticsConfig.  # noqa: E501

        (Needed only if making a request using MAC Authentication. Otherwise will be taken from JWT.)  # noqa: E501

        :return: The context_id of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this SpeechAnalyticsConfig.

        (Needed only if making a request using MAC Authentication. Otherwise will be taken from JWT.)  # noqa: E501

        :param context_id: The context_id of this SpeechAnalyticsConfig.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def sa_conf_id(self):
        """Gets the sa_conf_id of this SpeechAnalyticsConfig.  # noqa: E501


        :return: The sa_conf_id of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: str
        """
        return self._sa_conf_id

    @sa_conf_id.setter
    def sa_conf_id(self, sa_conf_id):
        """Sets the sa_conf_id of this SpeechAnalyticsConfig.


        :param sa_conf_id: The sa_conf_id of this SpeechAnalyticsConfig.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and sa_conf_id is None:  # noqa: E501
            raise ValueError("Invalid value for `sa_conf_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sa_conf_id is not None and len(sa_conf_id) > 48):
            raise ValueError("Invalid value for `sa_conf_id`, length must be less than or equal to `48`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sa_conf_id is not None and len(sa_conf_id) < 16):
            raise ValueError("Invalid value for `sa_conf_id`, length must be greater than or equal to `16`")  # noqa: E501

        self._sa_conf_id = sa_conf_id
    ...
    def overtalk_single_duration_maximum_threshold(self):
        ...
        :return: The overtalk_single_duration_maximum_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def overtalk_single_duration_maximum_threshold(self, overtalk_single_duration_maximum_threshold):
        """Sets the overtalk_single_duration_maximum_threshold of this SpeechAnalyticsConfig.

        Duration-based threshold (in milliseconds) used to determine if an overtalk incident has occured.  Applies to maximun duration of single/individual cases of overtalk.   # noqa: E501

        :param overtalk_single_duration_maximum_threshold: The overtalk_single_duration_maximum_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def overtalk_total_percentage_threshold(self):
        """Gets the overtalk_total_percentage_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The overtalk_total_percentage_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def overtalk_total_percentage_threshold(self, overtalk_total_percentage_threshold):
        """Sets the overtalk_total_percentage_threshold of this SpeechAnalyticsConfig.

        Percentage-based threshold used to determine if an overtalk incident has occured.  Applies to total overtalk expressed as percentage of the call duration.   # noqa: E501

        :param overtalk_total_percentage_threshold: The overtalk_total_percentage_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def phrase_groups(self):
        """Gets the phrase_groups of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The phrase_groups of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    def phrase_groups(self, phrase_groups):
        """Sets the phrase_groups of this SpeechAnalyticsConfig.

        Group of phrases/intents. Can be used to detect combinations of phrases in the caller.</br> By default there are no phrase groups.   # noqa: E501

        :param phrase_groups: The phrase_groups of this SpeechAnalyticsConfig.  # noqa: E501
    ...
    @property
    def published(self):
        """Gets the published of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The published of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: bool
        """
    ...
    def published(self, published):
        """Sets the published of this SpeechAnalyticsConfig.

        Specifies if Speech Analytics configuration can be used outside its context.</br> For built-in configurations, specifies if the configuration is visible to end-users of Voicegain. Only user with \"cmp\" role is able to see built-in configurations that are not published.   # noqa: E501

        :param published: The published of this SpeechAnalyticsConfig.  # noqa: E501
        :type: bool
        """
    ...
    def silence_single_duration_maximum_threshold(self):
        """Gets the silence_single_duration_maximum_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The silence_single_duration_maximum_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def silence_single_duration_maximum_threshold(self, silence_single_duration_maximum_threshold):
        """Sets the silence_single_duration_maximum_threshold of this SpeechAnalyticsConfig.

        Duration-based threshold (in milliseconds) used to determine if a silence incident has occured.  Applies to maximun duration of single/individual cases of silence.   # noqa: E501

        :param silence_single_duration_maximum_threshold: The silence_single_duration_maximum_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def silence_total_percentage_threshold(self):
        """Gets the silence_total_percentage_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        ...
        :return: The silence_total_percentage_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def silence_total_percentage_threshold(self, silence_total_percentage_threshold):
        """Sets the silence_total_percentage_threshold of this SpeechAnalyticsConfig.

        Percentage-based threshold used to determine if a silence incident has occured.  Applies to total silence expressed as percentage of the call duration.   # noqa: E501

        :param silence_total_percentage_threshold: The silence_total_percentage_threshold of this SpeechAnalyticsConfig.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpeechAnalyticsConfig):
            return False
