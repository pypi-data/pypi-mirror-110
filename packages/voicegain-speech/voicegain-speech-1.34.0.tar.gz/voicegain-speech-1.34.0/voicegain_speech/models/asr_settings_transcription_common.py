...
class AsrSettingsTranscriptionCommon(object):
    ...
    def acoustic_model_non_real_time(self):
        """Gets the acoustic_model_non_real_time of this AsrSettingsTranscriptionCommon.  # noqa: E501
        ...
        :return: The acoustic_model_non_real_time of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model_non_real_time(self, acoustic_model_non_real_time):
        """Sets the acoustic_model_non_real_time of this AsrSettingsTranscriptionCommon.

        (Optional) Name of an Acoustic Model that is to be used for offline and semi-real-time processing.  May include version number separated by `:` , for example, **Voicegain-BD_en-us:11** </br> If not provided a suitable default will be used.   # noqa: E501

        :param acoustic_model_non_real_time: The acoustic_model_non_real_time of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: str
        """
    ...
    def acoustic_model_real_time(self):
        """Gets the acoustic_model_real_time of this AsrSettingsTranscriptionCommon.  # noqa: E501
        ...
        :return: The acoustic_model_real_time of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model_real_time(self, acoustic_model_real_time):
        """Sets the acoustic_model_real_time of this AsrSettingsTranscriptionCommon.

        (Optional) Name of a real-time capable Acoustic Model.  May include version number separated by `:`, for example, **Voicegain-IVR_en-us:3**</br> If not provided a suitable default will be used.   # noqa: E501

        :param acoustic_model_real_time: The acoustic_model_real_time of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: str
        """
    ...
    def confidence_threshold(self):
        """Gets the confidence_threshold of this AsrSettingsTranscriptionCommon.  # noqa: E501

        Hypotheses below this threshold will result in NOMATCH  # noqa: E501

        :return: The confidence_threshold of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: float
        """
    ...
    def confidence_threshold(self, confidence_threshold):
        """Sets the confidence_threshold of this AsrSettingsTranscriptionCommon.

        Hypotheses below this threshold will result in NOMATCH  # noqa: E501

        :param confidence_threshold: The confidence_threshold of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: float
        """
    ...
    def max_alternatives(self):
        """Gets the max_alternatives of this AsrSettingsTranscriptionCommon.  # noqa: E501

        number of recognition hypotheses to return as result (top N-Best)  # noqa: E501

        :return: The max_alternatives of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: int
        """
    ...
    def max_alternatives(self, max_alternatives):
        """Sets the max_alternatives of this AsrSettingsTranscriptionCommon.

        number of recognition hypotheses to return as result (top N-Best)  # noqa: E501

        :param max_alternatives: The max_alternatives of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sensitivity(self):
        """Gets the sensitivity of this AsrSettingsTranscriptionCommon.  # noqa: E501
        ...
        :return: The sensitivity of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: float
        """
    ...
    def sensitivity(self, sensitivity):
        """Sets the sensitivity of this AsrSettingsTranscriptionCommon.

        Affects start-of-speech and end-of-speech detection. </br> 1 is most sensitive and corresponds to -90 dbFS </br> 0 is least sensitive and corresponds to -50 dbFS   # noqa: E501

        :param sensitivity: The sensitivity of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def speed_vs_accuracy(self):
        """Gets the speed_vs_accuracy of this AsrSettingsTranscriptionCommon.  # noqa: E501

        between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use  # noqa: E501

        :return: The speed_vs_accuracy of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: float
        """
    ...
    def speed_vs_accuracy(self, speed_vs_accuracy):
        """Sets the speed_vs_accuracy of this AsrSettingsTranscriptionCommon.

        between 0.0 and 1.0 - tradeoff between accuracy and speed/resource use  # noqa: E501

        :param speed_vs_accuracy: The speed_vs_accuracy of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def hints(self):
        """Gets the hints of this AsrSettingsTranscriptionCommon.  # noqa: E501
        ...
        :return: The hints of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: list[str]
        """
        return self._hints
    ...
    def hints(self, hints):
        """Sets the hints of this AsrSettingsTranscriptionCommon.

        Can be provided to indicate that given words/phrases are more likely to appear in the audio input. No special characters allowed except for '_'   # noqa: E501

        :param hints: The hints of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def lang_model(self):
        """Gets the lang_model of this AsrSettingsTranscriptionCommon.  # noqa: E501

        Name or UUID of the language model to use. If absent then will use default language model.  # noqa: E501

        :return: The lang_model of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :rtype: str
        """
    ...
    def lang_model(self, lang_model):
        """Sets the lang_model of this AsrSettingsTranscriptionCommon.

        Name or UUID of the language model to use. If absent then will use default language model.  # noqa: E501

        :param lang_model: The lang_model of this AsrSettingsTranscriptionCommon.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsTranscriptionCommon):
            return False
