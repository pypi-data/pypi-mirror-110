...
class CallbackReqReco(object):
    ...
    def __init__(self, auth_conf=None, uri=None, local_vars_configuration=None):  # noqa: E501
        """CallbackReqReco - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def auth_conf(self):
        """Gets the auth_conf of this CallbackReqReco.  # noqa: E501
        ...
        :return: The auth_conf of this CallbackReqReco.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_conf(self, auth_conf):
        """Sets the auth_conf of this CallbackReqReco.

        Name of the authentication config for accessing the URI, if missing then no authentication will be attempted.</br> Can be defined via Voicegain Portal. **(Not implemented yet)**   # noqa: E501

        :param auth_conf: The auth_conf of this CallbackReqReco.  # noqa: E501
        :type: str
        """
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this CallbackReqReco.

        (Required) uri to which the callback should be made. Allows substitution of {sessionId} parameter.  # noqa: E501

        :param uri: The uri of this CallbackReqReco.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallbackReqReco):
            return False
