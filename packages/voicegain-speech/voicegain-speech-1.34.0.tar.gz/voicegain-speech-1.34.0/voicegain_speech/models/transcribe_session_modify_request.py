...
class TranscribeSessionModifyRequest(object):
    ...
    def __init__(self, metadata=None, persist=3600000, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def metadata(self):
        """Gets the metadata of this TranscribeSessionModifyRequest.  # noqa: E501
        ...
        :return: The metadata of this TranscribeSessionModifyRequest.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this TranscribeSessionModifyRequest.

        Metadata passed with the request to async transcription, recognition, or Speech Analytics. Consist of a list of named string values. Names in the list have to be unique. If duplicates are provided then only the last one will be retained. </br> Will be returned in callback. For transcription and Speech Analytics, the metadata will be saved together with the result.   # noqa: E501

        :param metadata: The metadata of this TranscribeSessionModifyRequest.  # noqa: E501
    ...
    @property
    def persist(self):
        """Gets the persist of this TranscribeSessionModifyRequest.  # noqa: E501
        ...
        :return: The persist of this TranscribeSessionModifyRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def persist(self, persist):
        """Sets the persist of this TranscribeSessionModifyRequest.

        Time (in msec) to retain the result/outcome data after processing has completed.  For Cloud, maximum persistence is 7 days. For On-Prem deployments data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available in the portal.       # noqa: E501

        :param persist: The persist of this TranscribeSessionModifyRequest.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TranscribeSessionModifyRequest):
            return False
