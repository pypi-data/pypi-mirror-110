...
class Websocket(object):
    ...
    def __init__(self, account_id=None, context_id=None, default=False, delay=0, jwt=None, messages=None, name=None, public=True, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def jwt(self):
        """Gets the jwt of this Websocket.  # noqa: E501

        Available only if `requireAuthentication` was set to true for this websocket.</br> If `requireAuthentication` was set to false then the `jwt` value will be null.</br> Note: this JWT will only work for this websocket. It will not work for any other websocket, nor for API access.   # noqa: E501

        :return: The jwt of this Websocket.  # noqa: E501
        :rtype: str
        """
        return self._jwt
    ...
    @jwt.setter
    def jwt(self, jwt):
        """Sets the jwt of this Websocket.

        Available only if `requireAuthentication` was set to true for this websocket.</br> If `requireAuthentication` was set to false then the `jwt` value will be null.</br> Note: this JWT will only work for this websocket. It will not work for any other websocket, nor for API access.   # noqa: E501

        :param jwt: The jwt of this Websocket.  # noqa: E501
        :type: str
        """
    ...
    def public(self):
        ...
        If true, then the websocket will be listed on public page in the Voicegain console  # noqa: E501
