...
class AsrCallbackApi(object):
    ...
    def asr_recognize_callback(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.asr_recognize_callback(async_req=True)
        >>> result = thread.get()
        ...
        :return: AsyncRecognitionCallbackResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.asr_recognize_callback_with_http_info(**kwargs)  # noqa: E501
    ...
    def asr_transcribe_callback(self, **kwargs):  # noqa: E501
        """Transcription Callback  # noqa: E501

        Needs to be implemented by the user of the API on a URL of your choice.</br> Receive speech transcription callback with results.</br> Request payload will contain either the intermediate or the final content of the transcription of the provided audio.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.asr_transcribe_callback(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param AsyncTranscriptionResponse async_transcription_response: ASR Transcribe Callback Payload, either incremental or full.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: AsyncTranscriptionCallbackResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.asr_transcribe_callback_with_http_info(**kwargs)  # noqa: E501

    def asr_transcribe_callback_with_http_info(self, **kwargs):  # noqa: E501
        """Transcription Callback  # noqa: E501

        Needs to be implemented by the user of the API on a URL of your choice.</br> Receive speech transcription callback with results.</br> Request payload will contain either the intermediate or the final content of the transcription of the provided audio.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.asr_transcribe_callback_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AsyncTranscriptionCallbackResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['async_transcription_response']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method asr_transcribe_callback" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'async_transcription_response' in local_var_params:
            body_params = local_var_params['async_transcription_response']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/customer/asr-transcribe-callback', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AsyncTranscriptionCallbackResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
