...
class SecurityApi(object):
    ...
    def security_jwt_get_with_http_info(self, aud, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('aud' in local_var_params and  # noqa: E501
                                                        len(local_var_params['aud']) > 128):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `aud` when calling `security_jwt_get`, length must be less than or equal to `128`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('context_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `context_id` when calling `security_jwt_get`, length must be greater than or equal to `16`")  # noqa: E501
        collection_formats = {}
