...
def parse_file(path, docstrings=False):
...
def parse(string, docstrings=False, filename='<unknown>',
...
def parse_pattern(pat, toplevel=False, docstrings=False):
...
def pat(pat, toplevel=False, docstrings=False):
