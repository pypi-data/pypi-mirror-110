...
class L2Step(AttackerStep):
    ...
    def step(self, x, g):
        ...
        scaled_g = g / (g_norm + TINY) # TODO - vanishing gradients!
        
        # print("NORMAL g_norm", g_norm.view(-1))
        # mask too large numbers 
        # scaled_g_norm = ch.norm(scaled_g.view(scaled_g.shape[0], -1), dim=1).view(-1, *([1]*l))
        # print("SCALED g_norm", scaled_g_norm.view(-1))
