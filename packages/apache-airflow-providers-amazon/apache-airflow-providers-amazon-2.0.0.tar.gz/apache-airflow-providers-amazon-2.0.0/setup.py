...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0', 'boto3>=1.15.0,<1.18.0', 'watchtower~=1.0.6'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-amazon/2.0.0/',
