...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SitesApi()
        api_instance.create_site  # this is an instance of the class Endpoint
        api_instance.create_site()  # this invokes api_instance.create_site.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_site.callable or self.callable in this class
