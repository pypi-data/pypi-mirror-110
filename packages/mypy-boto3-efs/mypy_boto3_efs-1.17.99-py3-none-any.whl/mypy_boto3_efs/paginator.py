...
class DescribeFileSystemsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/efs.html#EFS.Paginator.DescribeFileSystems.paginate)
...
class DescribeMountTargetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/efs.html#EFS.Paginator.DescribeMountTargets.paginate)
...
class DescribeTagsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/efs.html#EFS.Paginator.DescribeTags.paginate)
