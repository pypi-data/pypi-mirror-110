...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["call", "join_as", "params", "muted", "video_muted", "invite_hash"]

    ID = 0xb132ff7b
    QUALNAME = "functions.phone.JoinGroupCall"

    def __init__(self, *, call: "raw.base.InputGroupCall", join_as: "raw.base.InputPeer", params: "raw.base.DataJSON", muted: Union[None, bool] = None, video_muted: Union[None, bool] = None, invite_hash: Union[None, str] = None) -> None:
        self.call = call  # InputGroupCall
        self.join_as = join_as  # InputPeer
        self.params = params  # DataJSON
        self.muted = muted  # flags.0?true
        self.video_muted = video_muted  # flags.2?true
    ...
    def read(data: BytesIO, *args: Any) -> "JoinGroupCall":
        ...
        video_muted = True if flags & (1 << 2) else False
        ...
        return JoinGroupCall(call=call, join_as=join_as, params=params, muted=muted, video_muted=video_muted, invite_hash=invite_hash)
    ...
    def write(self) -> bytes:
        ...
        flags |= (1 << 2) if self.video_muted else 0
