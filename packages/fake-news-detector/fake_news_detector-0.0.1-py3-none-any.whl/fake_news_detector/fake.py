...
def german_fake(df,attribute_name,model_name):
    #for german uncomment below two lines of code
    ...
    import pickle
    loaded_model = pickle.load(open('/content/models/german_model_'+model_name+'.sav?raw=true', 'rb'))
...
def french_fake(df,attribute_name,model_name):
    ...
    import pickle
    loaded_model = pickle.load(open('/content/models/french_model_'+model_name+'.sav?raw=true', 'rb'))
    predicted_value = loaded_model.predict(x_train_scaled)
    '''
    if predicted_value[0]==0:
      print('true')
...
def italian_fake(df,attribute_name,model_name):
    ...
    import pickle
    loaded_model = pickle.load(open('/content/models/italian_model_'+model_name+'.sav?raw=true', 'rb'))
    predicted_value = loaded_model.predict(x_train_scaled)
    '''
    if predicted_value[0]==0:
      print('true')
...
def spanish_fake(df,attribute_name,model_name):
    ...
    import pickle
    loaded_model = pickle.load(open('/content/models/spanish_model_'+model_name+'.sav?raw=true', 'rb'))
    predicted_value = loaded_model.predict(x_train_scaled)
    '''
    if predicted_value[0]==0:
      print('true')
...
def english_fake(df,attribute_name,model_name):
    ...
    scaler = scaler.fit(df)
    x_train_scaled = scaler.transform(df)
    loaded_model = pickle.load(open('/content/models/english_model_'+model_name+'.sav?raw=true', 'rb'))
