...
class JobCompleteWaiter(Boto3Waiter):
    ...
    def wait(self, *, Id: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/elastictranscoder.html#ElasticTranscoder.Waiter.JobCompleteWaiter)
