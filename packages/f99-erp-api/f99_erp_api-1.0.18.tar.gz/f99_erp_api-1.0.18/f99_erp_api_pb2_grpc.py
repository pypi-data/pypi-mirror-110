...
class ErpServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.update_sale_orders_shipping_state = channel.stream_stream(
        '/ErpService/update_sale_orders_shipping_state',
        request_serializer=f99__erp__api__pb2.UpdateSaleOrdersShippingStateParams.SerializeToString,
        response_deserializer=f99__erp__api__pb2.UpdateSaleOrdersShippingStateResult.FromString,
        )
...
class ErpServiceServicer(object):
  ...
  def update_sale_orders_shipping_state(self, request_iterator, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_ErpServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'update_sale_orders_shipping_state': grpc.stream_stream_rpc_method_handler(
          servicer.update_sale_orders_shipping_state,
          request_deserializer=f99__erp__api__pb2.UpdateSaleOrdersShippingStateParams.FromString,
          response_serializer=f99__erp__api__pb2.UpdateSaleOrdersShippingStateResult.SerializeToString,
      ),
  }
