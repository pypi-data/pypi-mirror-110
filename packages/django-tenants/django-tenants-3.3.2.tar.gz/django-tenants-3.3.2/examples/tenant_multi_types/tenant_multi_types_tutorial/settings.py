# Django settings for tenant_multi_types_tutorial project.
import sys
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_DB', 'tenant_multi_types_tutorial'),
        'USER': os.environ.get('DATABASE_USER', 'tenant_multi_types_tutorial'),
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tenant_multi_types_tutorial.context_processors.settings',
            ],
            'loaders': (
