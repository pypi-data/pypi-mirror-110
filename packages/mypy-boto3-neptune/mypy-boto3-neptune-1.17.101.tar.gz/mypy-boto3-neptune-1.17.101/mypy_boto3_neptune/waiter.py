...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/neptune.html#Neptune.Waiter.DBInstanceAvailableWaiter)
...
class DBInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/neptune.html#Neptune.Waiter.DBInstanceDeletedWaiter)
