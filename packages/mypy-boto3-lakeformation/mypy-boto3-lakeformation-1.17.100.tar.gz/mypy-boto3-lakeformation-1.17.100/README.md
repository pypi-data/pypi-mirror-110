...
[boto3.LakeFormation 1.17.100](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/lakeformation.html#LakeFormation)
...
def get_structure() -> AddLFTagsToResourceResponseTypeDef:
    return {
      ...
    }
```
