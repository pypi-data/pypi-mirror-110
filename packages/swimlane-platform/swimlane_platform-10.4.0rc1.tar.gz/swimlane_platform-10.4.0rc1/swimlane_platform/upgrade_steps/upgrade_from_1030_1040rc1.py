...
class UpgradeFrom1030To1040rc1(UpgradeStep):
    FROM = semver.parse_version_info('10.3.0')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.4.0-rc1')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.3.0 To 10.4.0-rc1')
    def process(self):
        # type: () -> None
