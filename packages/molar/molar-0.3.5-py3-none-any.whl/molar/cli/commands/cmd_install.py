...
def config_env_vars(
    ...
    *,
    ...
    if postgres_password is None:
        postgres_password = Prompt.ask("Password for Postgres admin", password=True)
        while postgres_password == '':
            postgres_password = Prompt.ask("The password for Postgres admin can not be empty, please set a password:")
