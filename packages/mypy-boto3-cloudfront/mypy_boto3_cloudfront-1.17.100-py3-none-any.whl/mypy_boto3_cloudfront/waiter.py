...
class DistributionDeployedWaiter(Boto3Waiter):
    ...
    def wait(self, *, Id: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudfront.html#CloudFront.Waiter.DistributionDeployedWaiter)
...
class InvalidationCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudfront.html#CloudFront.Waiter.InvalidationCompletedWaiter)
...
class StreamingDistributionDeployedWaiter(Boto3Waiter):
    ...
    def wait(self, *, Id: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.100/reference/services/cloudfront.html#CloudFront.Waiter.StreamingDistributionDeployedWaiter)
