...
class IAdSec(metaclass=ABCMeta):
    ...
    def Analyse(self, section: ISection) -> ISolution:
        ...
        See "~/articles/glossary.html#results""Glossary/see
...
class ISection(metaclass=ABCMeta):
    """Represents a cross-section through a structural member of the specified material which can contain reinforcement.
    A section has a profile that describes its shape, size and orientation.
    
    See "~/articles/glossary.html#sectionsection""Glossary/see
    """
    ...
    def SubComponents(self) -> IList[ISubComponent]:
        ...
        See "~/articles/glossary.html#sub-componentsub-component""Glossary/see
        """
        pass
    ...
    def ReinforcementGroups(self) -> IList[IGroup]:
        ...
        See "~/articles/glossary.html#reinforcement""Glossary/see
        """
        pass
...
class IServiceability(metaclass=ABCMeta):
    ...
    See "~/articles/glossary.html#serviceability-resultserviceability-result""Glossary/see
    """
    ...
    def Check(self, deformation: IDeformation) -> IServiceabilityResult:
        ...
        :param deformation: The deformation for which the serviceability results are to be calculated.
...
class IStrength(metaclass=ABCMeta):
    ...
    See "~/articles/glossary.html#strength-resultstrength-result""Glossary/see
    """
...
class IWarning(metaclass=ABCMeta):
    """A notification with information about any unusual
    observation.
    """

    @property
    def RecordTime(self) -> str:
        """
        """
        pass
...
class IDeformation(metaclass=ABCMeta):
    ...
    See "~/articles/glossary.html#deformationdeformation""Glossary/see
    """

    @property
    def ZZ(self) -> Curvature:
        """The curvature about local z-axis. It follows the <a href="https://en.wikipedia.org/wiki/Right-hand_rule">right hand grip rule</a> about the axis.
        """
        pass
    ...
    def YY(self) -> Curvature:
        """The curvature about local y-axis. It follows the <a href="https://en.wikipedia.org/wiki/Right-hand_rule">right hand grip rule</a> about the axis.
        """
        pass
...
class ILoad(metaclass=ABCMeta):
    ...
    See "~/articles/glossary.html#loadload""Glossary/see
    """

    @property
    def ZZ(self) -> Moment:
        """The moment about the local z-axis. It follows the <a href="https://en.wikipedia.org/wiki/Right-hand_rule">right hand grip rule</a> about the axis.
        """
        pass
    ...
    @property
    def YY(self) -> Moment:
        """The moment about the local y-axis. It follows the <a href="https://en.wikipedia.org/wiki/Right-hand_rule">right hand grip rule</a> about the axis.
        """
        pass
...
See "~/articles/glossary.html#crackcrack""Glossary/see
    """
...
class IMomentRange(metaclass=ABCMeta):
    ...
    See "~/articles/glossary.html#moment-rangesmoment-range""Glossary/see
    """
...
class IServiceabilityResult(metaclass=ABCMeta):
    ...
    def Cracks(self) -> IList[ICrack]:
        """Crack results are calculated at bar positions or section surfaces
        depending on the "None IDesignCode""Design Code/see specifications.
        """
        pass
    ...
    def CrackingUtilisation(self) -> Ratio:
        ...
        in the same direction that would cause the section to crack.
        """
        pass
...
class IStiffness(metaclass=ABCMeta):
    ...
    See "~/articles/glossary.html#stiffnessstiffness""Glossary/see
    """
...
class IStrengthResult(metaclass=ABCMeta):
    """The result of strength analysis (ULS) calculated by "None !:IStrength".
    """
