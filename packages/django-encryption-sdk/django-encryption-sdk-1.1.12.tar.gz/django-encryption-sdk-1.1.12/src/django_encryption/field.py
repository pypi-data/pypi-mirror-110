...
class DataKeeperCharField(CharField):
    ...
    def __init__(self, *args, mask_type="auto", edk_key='default', raw_type='str', **kwargs):
        """
        mask_type: [num1] (*|**) [num2]
        num1:前num1位明文显示
        (*|**): *表示固定三个*，(即***)，**表示按遮挡长度显示*
    ...
    def to_python(self, value):
        ...
        return DataKeeper(cipher_text=value, mask_type=self.mask_type, edk_key=self.edk_key, field=self, raw_type=self.raw_type)
