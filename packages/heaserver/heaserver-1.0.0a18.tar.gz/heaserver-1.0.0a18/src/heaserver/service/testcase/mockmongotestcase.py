...
def get_test_case_cls(resource_path: str,
                      wstl_package: str,
                      fixtures: Dict[str, List[Dict[str, Any]]],
                      body_post: dict = None,
                      body_put: dict = None,
                      expected_one: dict = None,
                      expected_one_wstl: dict = None,
                      expected_one_properties_form: dict = None,
                      expected_one_duplicate_form: dict = None,
                      expected_all: dict = None,
                      expected_all_wstl: dict = None) -> Type[mongotestcase.MongoTestCase]:
    """
    ...
    :param resource_path: the resource being tested.
    :param wstl_package: the name of the package containing the wstl data package.
    ...
    def mock_mongo(app: web.Application, config: configparser.ConfigParser):
        return MockMongo(app, config, fixtures)
    ...
    class MockMongoTestCase(mongotestcase.MongoTestCase):
        ...
        async def get_application(self):
            return await runner.get_application(db=mock_mongo,
...
def get_test_case_cls_default(coll: str,
                              ...
                              get_all_actions: Optional[List[ActionSpec]] = None) -> Type[mongotestcase.MongoTestCase]:
