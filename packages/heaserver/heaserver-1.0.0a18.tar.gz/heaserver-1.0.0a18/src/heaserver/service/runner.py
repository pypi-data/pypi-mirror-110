...
from typing import Callable, Iterable, Optional, Union, AsyncIterator
...
def start(db: Callable[[web.Application, Optional[configparser.ConfigParser]], Database] = None,
    ...
    object, and then it calls AioHTTP's aiohttp.web.run_app method on it to launch the service.
...
async def get_application(db: Callable[[web.Application, Optional[configparser.ConfigParser]], Database] = None,
    ...
    """
    Gets the aiohttp application object for this microservice. It is called by start().
    ...
    await aiohttp_remote_setup(app, XForwardedRelaxed())
    return app
