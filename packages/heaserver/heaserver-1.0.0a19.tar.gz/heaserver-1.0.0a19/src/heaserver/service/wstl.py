...
class RuntimeWeSTLDocumentBuilder:
    ...
    def __init__(self, design_time_wstl: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    def has_run_time_action(self, name):
    ...
    def data(self, data) -> None:
        """
        Set the data object of the run-time WeSTL document.
    ...
    @property
    def design_time_document(self) -> dict:
        """
    ...
    def __make(self, name: str, path: Optional[str]=None, rel: Optional[List[str]] = None, root: Optional[str] = None) -> Dict[str, Any]:
        ...
        if not name:
            ...
            if tran is not None:
                ...
                rtn['rel'] = rel_ + [root_ + rel_i if not rel_i.startswith('/') else rel_i for rel_i in rel_]
            else:
...
def action(name: str,
    ...
    :param rel: a list of rels. Optional.
...
def builder_factory(package: Optional[str] = None, resource='wstl/all.json', loads=json.loads) -> Callable[
    ...
    def builder_factory_() -> RuntimeWeSTLDocumentBuilder:
        ...
        """
        return RuntimeWeSTLDocumentBuilder(data)

    return builder_factory_


def builder(package: str, resource='wstl/all.json', loads=json.loads) -> RuntimeWeSTLDocumentBuilder:
    """
    ...
    get_data API.
    """
    return builder_factory(package, resource=resource, loads=loads)()
