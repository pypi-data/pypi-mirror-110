...
def graph_avg(df_dict, n_m, con_data, exp_data, con_name, exp_name, data_path, hm_flag, log_flag, avg=False):
    """ Plot Formatting """
    ...
    avg_df = pd.DataFrame()
    avg_df["Time"] = [x * 2 for x in range(0, (n_m - 1))]
...
def graph_indiv(df_dict, n_m, repl_data, repl_name, data_path, log_flag):
    """ Graph Formatting """
    # You typically want your plot to be ~1.33x wider than tall.
    # Common sizes: (10, 7.5) and (12, 9)
    plt.figure(figsize=(10, 7.5))
