...
class _SPMAnalogOut(nanosurf.spmcontroller._SPMModule):
    ...
    def source(self, val):
        self.__source = val
        if isinstance(self.__source,nanosurf.spmcontroller.spmgenerator.SPMSineWaveGenerator):
        ...
        elif isinstance(self.__source,nanosurf.spmcontroller.spmchannelmux._SPMChannelMux):
