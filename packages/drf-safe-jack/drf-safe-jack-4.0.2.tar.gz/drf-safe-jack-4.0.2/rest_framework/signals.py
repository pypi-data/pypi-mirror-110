    ...
    try:
        ...
        if change:
            for i in change:
                ...
                if "last_modified" in i["field"] or u"最近更新时间" in i["field"] or isinstance(i["field"], list) or   u"创建时间" in i["field"]  or (not i['old']  and not i["new"]) or i['old'] == i['new'] or "id" in i["field"] :
                    continue
