...
class dbActions:
	def __init__(self, database, username, password=None, **kwargs):
		self.conn = psycopg2.connect(dbname=database, user=username, password=password, cursor_factory=extras.RealDictCursor, **kwargs)
