...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/docdb.html#DocDB.Waiter.DBInstanceAvailableWaiter)
...
class DBInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/docdb.html#DocDB.Waiter.DBInstanceDeletedWaiter)
