...
class APIClientBase:
    ...
    async def _async_request(
        ...
        try:
            ...
            return await asyncio.wait_for(
                self._unsafe_async_request(method, url, body, success_codes, error_subject, on_response_callback),
        ...
        except (aiohttp.ServerTimeoutError, requests.Timeout, asyncio.TimeoutError) as e:
    ...
    def _sync_request(
        ...
        try:
            ...
            return self._unsafe_sync_request(method, url, body, success_codes, error_subject, on_response_callback)
