...
class DescribeJobLogItemsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mgn.html#mgn.Paginator.DescribeJobLogItems.paginate)
...
class DescribeJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mgn.html#mgn.Paginator.DescribeJobs.paginate)
...
class DescribeReplicationConfigurationTemplatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mgn.html#mgn.Paginator.DescribeReplicationConfigurationTemplates.paginate)
...
class DescribeSourceServersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/mgn.html#mgn.Paginator.DescribeSourceServers.paginate)
