...
class QLattice:
    ...
    def sample_models(
        ...
        Arguments:
            input_names {Iterable[str]} -- The names of the input features.
...
def _get_community_qlattice_config(server: str = DEFAULT_SERVER) -> Config:
    ...
    return Config(data["qlattice_id"], data["api_token"], server)
