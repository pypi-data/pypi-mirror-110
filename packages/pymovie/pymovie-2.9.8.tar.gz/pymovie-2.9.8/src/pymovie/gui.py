...
# Form implementation generated from reading ui file 'PyMovieScrollable.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(-40, 0, 1670, 1020))
        ...
        self.horizontalLayout_101 = QtWidgets.QHBoxLayout(self.scrollAreaWidgetContents)
        self.horizontalLayout_101.setObjectName("horizontalLayout_101")
        self.splitterThree = QtWidgets.QSplitter(self.scrollAreaWidgetContents)
        ...
        self.layoutWidget_9 = QtWidgets.QWidget(self.splitterTwo)
        self.layoutWidget_9.setObjectName("layoutWidget_9")
        self.verticalLayout_47 = QtWidgets.QVBoxLayout(self.layoutWidget_9)
        ...
        self.infoButton = QtWidgets.QPushButton(self.layoutWidget_9)
        self.infoButton.setMinimumSize(QtCore.QSize(40, 0))
        self.infoButton.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.infoButton.setObjectName("infoButton")
        self.horizontalLayout_68.addWidget(self.infoButton)
        self.label_4 = QtWidgets.QLabel(self.layoutWidget_9)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_68.addWidget(self.label_4)
        self.fileInUseEdit = QtWidgets.QLineEdit(self.layoutWidget_9)
        self.fileInUseEdit.setObjectName("fileInUseEdit")
        self.horizontalLayout_68.addWidget(self.fileInUseEdit)
        self.verticalLayout_47.addLayout(self.horizontalLayout_68)
        ...
        self.saveApertureState = QtWidgets.QPushButton(self.layoutWidget_9)
        self.saveApertureState.setObjectName("saveApertureState")
        self.horizontalLayout_69.addWidget(self.saveApertureState)
        self.restoreApertureState = QtWidgets.QPushButton(self.layoutWidget_9)
        self.restoreApertureState.setObjectName("restoreApertureState")
        self.horizontalLayout_69.addWidget(self.restoreApertureState)
        self.editAperturesButton = QtWidgets.QPushButton(self.layoutWidget_9)
        self.editAperturesButton.setObjectName("editAperturesButton")
        self.horizontalLayout_69.addWidget(self.editAperturesButton)
        self.horizontalLayout_70 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_70.setObjectName("horizontalLayout_70")
        self.roiComboBox = QtWidgets.QComboBox(self.layoutWidget_9)
        ...
        self.horizontalLayout_70.addWidget(self.roiComboBox)
        self.selectApertureSizeLabel = QtWidgets.QLabel(self.layoutWidget_9)
        ...
        self.horizontalLayout_70.addWidget(self.selectApertureSizeLabel)
        self.horizontalLayout_69.addLayout(self.horizontalLayout_70)
        self.verticalLayout_47.addLayout(self.horizontalLayout_69)
        ...
        self.horizontalLayout_71.addWidget(self.label)
        self.thresh_inc_1 = QtWidgets.QRadioButton(self.layoutWidget_9)
        ...
        self.horizontalLayout_71.addWidget(self.thresh_inc_1)
        self.thresh_inc_10 = QtWidgets.QRadioButton(self.layoutWidget_9)
        self.thresh_inc_10.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.thresh_inc_10.setObjectName("thresh_inc_10")
        self.horizontalLayout_71.addWidget(self.thresh_inc_10)
        self.thresh_inc_100 = QtWidgets.QRadioButton(self.layoutWidget_9)
        self.thresh_inc_100.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.thresh_inc_100.setObjectName("thresh_inc_100")
        self.horizontalLayout_71.addWidget(self.thresh_inc_100)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_71.addItem(spacerItem)
        self.setMskthLabel = QtWidgets.QLabel(self.layoutWidget_9)
        ...
        self.horizontalLayout_71.addWidget(self.setMskthLabel)
        self.threshValueEdit = QtWidgets.QSpinBox(self.layoutWidget_9)
        self.threshValueEdit.setToolTip("")
        self.threshValueEdit.setMaximum(99999)
        self.threshValueEdit.setObjectName("threshValueEdit")
        self.horizontalLayout_71.addWidget(self.threshValueEdit)
        self.verticalLayout_47.addLayout(self.horizontalLayout_71)
        ...
        self.viewFieldsCheckBox = QtWidgets.QCheckBox(self.layoutWidget_9)
        self.viewFieldsCheckBox.setEnabled(False)
        self.viewFieldsCheckBox.setObjectName("viewFieldsCheckBox")
        self.verticalLayout_48.addWidget(self.viewFieldsCheckBox)
        self.processAsFieldsCheckBox = QtWidgets.QCheckBox(self.layoutWidget_9)
        self.processAsFieldsCheckBox.setEnabled(True)
        self.processAsFieldsCheckBox.setObjectName("processAsFieldsCheckBox")
        self.verticalLayout_48.addWidget(self.processAsFieldsCheckBox)
        self.topFieldFirstRadioButton = QtWidgets.QRadioButton(self.layoutWidget_9)
        ...
        self.verticalLayout_48.addWidget(self.topFieldFirstRadioButton)
        self.bottomFieldFirstRadioButton = QtWidgets.QRadioButton(self.layoutWidget_9)
        ...
        self.verticalLayout_48.addWidget(self.bottomFieldFirstRadioButton)
        self.horizontalLayout_72.addLayout(self.verticalLayout_48)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_72.addItem(spacerItem1)
        self.verticalLayout_49 = QtWidgets.QVBoxLayout()
        self.verticalLayout_49.setObjectName("verticalLayout_49")
        self.showImageControlCheckBox = QtWidgets.QCheckBox(self.layoutWidget_9)
        self.showImageControlCheckBox.setObjectName("showImageControlCheckBox")
        self.verticalLayout_49.addWidget(self.showImageControlCheckBox)
        self.horizontalLayout_73 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_73.setObjectName("horizontalLayout_73")
        self.satPixelSpinBox = QtWidgets.QSpinBox(self.layoutWidget_9)
        ...
        self.horizontalLayout_73.addWidget(self.satPixelSpinBox)
        self.satPixelLabel = QtWidgets.QLabel(self.layoutWidget_9)
        self.satPixelLabel.setObjectName("satPixelLabel")
        self.horizontalLayout_73.addWidget(self.satPixelLabel)
        self.verticalLayout_49.addLayout(self.horizontalLayout_73)
        self.demoMeanPushButton = QtWidgets.QPushButton(self.layoutWidget_9)
        self.demoMeanPushButton.setObjectName("demoMeanPushButton")
        self.verticalLayout_49.addWidget(self.demoMeanPushButton)
        self.horizontalLayout_72.addLayout(self.verticalLayout_49)
        self.verticalLayout_47.addLayout(self.horizontalLayout_72)
        self.tabWidget = QtWidgets.QTabWidget(self.layoutWidget_9)
        self.tabWidget.setUsesScrollButtons(True)
        self.tabWidget.setMovable(True)
        self.tabWidget.setObjectName("tabWidget")
        self.tab_19 = QtWidgets.QWidget()
        self.tab_19.setObjectName("tab_19")
        self.gridLayout_19 = QtWidgets.QGridLayout(self.tab_19)
        ...
        self.h1 = QtWidgets.QLabel(self.tab_19)
        self.h1.setEnabled(False)
        self.h1.setText("")
        self.h1.setObjectName("h1")
        self.gridLayout_19.addWidget(self.h1, 0, 3, 1, 1)
        self.verticalLayout_50 = QtWidgets.QVBoxLayout()
        self.verticalLayout_50.setObjectName("verticalLayout_50")
        self.readAviFileButton = QtWidgets.QPushButton(self.tab_19)
        self.readAviFileButton.setObjectName("readAviFileButton")
        self.verticalLayout_50.addWidget(self.readAviFileButton)
        self.createAVIWCSfolderButton = QtWidgets.QPushButton(self.tab_19)
        self.createAVIWCSfolderButton.setObjectName("createAVIWCSfolderButton")
        self.verticalLayout_50.addWidget(self.createAVIWCSfolderButton)
        self.line_15 = QtWidgets.QFrame(self.tab_19)
        ...
        self.verticalLayout_50.addWidget(self.line_15)
        self.selectAviWcsFolderButton = QtWidgets.QPushButton(self.tab_19)
        self.selectAviWcsFolderButton.setObjectName("selectAviWcsFolderButton")
        self.verticalLayout_50.addWidget(self.selectAviWcsFolderButton)
        self.readFitsFolderButton = QtWidgets.QPushButton(self.tab_19)
        ...
        self.verticalLayout_50.addWidget(self.readFitsFolderButton)
        ...
        self.metadataButton = QtWidgets.QPushButton(self.tab_19)
        self.metadataButton.setObjectName("metadataButton")
        self.verticalLayout_50.addWidget(self.metadataButton)
        self.enableAdvFrameStatusDisplay = QtWidgets.QCheckBox(self.tab_19)
        ...
        self.verticalLayout_50.addWidget(self.enableAdvFrameStatusDisplay)
        self.line_17 = QtWidgets.QFrame(self.tab_19)
        ...
        self.openBmpPushButton = QtWidgets.QPushButton(self.tab_19)
        self.openBmpPushButton.setObjectName("openBmpPushButton")
        self.verticalLayout_50.addWidget(self.openBmpPushButton)
        self.gridLayout_19.addLayout(self.verticalLayout_50, 0, 1, 1, 1)
        self.tabWidget.addTab(self.tab_19, "")
        self.tab_20 = QtWidgets.QWidget()
        self.tab_20.setObjectName("tab_20")
        self.gridLayout_20 = QtWidgets.QGridLayout(self.tab_20)
        self.gridLayout_20.setObjectName("gridLayout_20")
        spacerItem5 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_20.addItem(spacerItem5, 1, 4, 1, 1)
        self.lprofileButtonSpacingLabel_3 = QtWidgets.QLabel(self.tab_20)
        self.lprofileButtonSpacingLabel_3.setText("")
        self.lprofileButtonSpacingLabel_3.setObjectName("lprofileButtonSpacingLabel_3")
        self.gridLayout_20.addWidget(self.lprofileButtonSpacingLabel_3, 1, 3, 1, 1)
        self.vtiSpacerLabel_3 = QtWidgets.QLabel(self.tab_20)
        self.vtiSpacerLabel_3.setText("")
        self.vtiSpacerLabel_3.setObjectName("vtiSpacerLabel_3")
        self.gridLayout_20.addWidget(self.vtiSpacerLabel_3, 1, 2, 1, 1)
        ...
        self.vtiSelectLabel = QtWidgets.QLabel(self.tab_20)
        self.vtiSelectLabel.setObjectName("vtiSelectLabel")
        self.horizontalLayout_74.addWidget(self.vtiSelectLabel)
        self.vtiSelectComboBox = QtWidgets.QComboBox(self.tab_20)
        ...
        self.horizontalLayout_74.addWidget(self.vtiSelectComboBox)
        self.verticalLayout_51.addLayout(self.horizontalLayout_74)
        self.loadCustomProfilesButton = QtWidgets.QPushButton(self.tab_20)
        self.loadCustomProfilesButton.setObjectName("loadCustomProfilesButton")
        self.verticalLayout_51.addWidget(self.loadCustomProfilesButton)
        self.clearOcrDataButton = QtWidgets.QPushButton(self.tab_20)
        self.clearOcrDataButton.setObjectName("clearOcrDataButton")
        self.verticalLayout_51.addWidget(self.clearOcrDataButton)
        self.vtiHelpButton = QtWidgets.QPushButton(self.tab_20)
        self.vtiHelpButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.vtiHelpButton.setObjectName("vtiHelpButton")
        self.verticalLayout_51.addWidget(self.vtiHelpButton)
        self.gridLayout_20.addLayout(self.verticalLayout_51, 0, 1, 2, 3)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_20.addItem(spacerItem6, 0, 0, 1, 1)
        ...
        self.hotPixelHelpButton = QtWidgets.QPushButton(self.tab_21)
        self.hotPixelHelpButton.setObjectName("hotPixelHelpButton")
        self.verticalLayout_52.addWidget(self.hotPixelHelpButton)
        self.hotPixelEraseOff = QtWidgets.QRadioButton(self.tab_21)
        ...
        self.verticalLayout_52.addWidget(self.hotPixelEraseOff)
        self.hotPixelEraseFromList = QtWidgets.QRadioButton(self.tab_21)
        self.hotPixelEraseFromList.setObjectName("hotPixelEraseFromList")
        self.verticalLayout_52.addWidget(self.hotPixelEraseFromList)
        self.hotPixelErase3x3median = QtWidgets.QRadioButton(self.tab_21)
        self.hotPixelErase3x3median.setObjectName("hotPixelErase3x3median")
        self.verticalLayout_52.addWidget(self.hotPixelErase3x3median)
        self.hotPixelErase5x5median = QtWidgets.QRadioButton(self.tab_21)
        self.hotPixelErase5x5median.setObjectName("hotPixelErase5x5median")
        self.verticalLayout_52.addWidget(self.hotPixelErase5x5median)
        self.loadHotPixelProfileButton = QtWidgets.QPushButton(self.tab_21)
        self.loadHotPixelProfileButton.setObjectName("loadHotPixelProfileButton")
        self.verticalLayout_52.addWidget(self.loadHotPixelProfileButton)
        self.createHotPixelListButton = QtWidgets.QPushButton(self.tab_21)
        self.createHotPixelListButton.setObjectName("createHotPixelListButton")
        self.verticalLayout_52.addWidget(self.createHotPixelListButton)
        self.gridLayout_21.addLayout(self.verticalLayout_52, 0, 1, 1, 1)
        spacerItem10 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_21.addItem(spacerItem10, 1, 1, 1, 1)
        ...
        self.alignWithStarInfoButton = QtWidgets.QPushButton(self.tab_22)
        self.alignWithStarInfoButton.setObjectName("alignWithStarInfoButton")
        self.horizontalLayout_75.addWidget(self.alignWithStarInfoButton)
        self.alignWithTwoPointTrackInfoButton = QtWidgets.QPushButton(self.tab_22)
        self.alignWithTwoPointTrackInfoButton.setObjectName("alignWithTwoPointTrackInfoButton")
        self.horizontalLayout_75.addWidget(self.alignWithTwoPointTrackInfoButton)
        self.verticalLayout_53.addLayout(self.horizontalLayout_75)
        self.horizontalLayout_76 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_76.setObjectName("horizontalLayout_76")
        self.finderRedactTopLinesLabel = QtWidgets.QLabel(self.tab_22)
        ...
        self.horizontalLayout_76.addWidget(self.finderRedactTopLinesLabel)
        self.redactLinesTopEdit = QtWidgets.QLineEdit(self.tab_22)
        ...
        self.horizontalLayout_76.addWidget(self.redactLinesTopEdit)
        self.redactLinesBottomEdit = QtWidgets.QLineEdit(self.tab_22)
        ...
        self.horizontalLayout_76.addWidget(self.redactLinesBottomEdit)
        self.finderRedactBottomLinesLabel = QtWidgets.QLabel(self.tab_22)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_76.addWidget(self.finderRedactBottomLinesLabel)
        self.verticalLayout_53.addLayout(self.horizontalLayout_76)
        self.horizontalLayout_77 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_77.setObjectName("horizontalLayout_77")
        self.finderNumFramesLabel = QtWidgets.QLabel(self.tab_22)
        ...
        self.horizontalLayout_77.addWidget(self.finderNumFramesLabel)
        self.numFramesToStackEdit = QtWidgets.QLineEdit(self.tab_22)
        ...
        self.horizontalLayout_77.addWidget(self.numFramesToStackEdit)
        spacerItem12 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_77.addItem(spacerItem12)
        self.verticalLayout_53.addLayout(self.horizontalLayout_77)
        self.horizontalLayout_78 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_78.setObjectName("horizontalLayout_78")
        self.stackFramesButton = QtWidgets.QPushButton(self.tab_22)
        self.stackFramesButton.setObjectName("stackFramesButton")
        self.horizontalLayout_78.addWidget(self.stackFramesButton)
        self.openFinderPushButton = QtWidgets.QPushButton(self.tab_22)
        self.openFinderPushButton.setObjectName("openFinderPushButton")
        self.horizontalLayout_78.addWidget(self.openFinderPushButton)
        self.verticalLayout_53.addLayout(self.horizontalLayout_78)
        self.stackerProgressBar = QtWidgets.QProgressBar(self.tab_22)
        self.stackerProgressBar.setProperty("value", 0)
        self.stackerProgressBar.setObjectName("stackerProgressBar")
        self.verticalLayout_53.addWidget(self.stackerProgressBar)
        self.finderMethodEdit = QtWidgets.QLineEdit(self.tab_22)
        self.finderMethodEdit.setReadOnly(True)
        self.finderMethodEdit.setObjectName("finderMethodEdit")
        self.verticalLayout_53.addWidget(self.finderMethodEdit)
        self.gridLayout_22.addLayout(self.verticalLayout_53, 0, 1, 1, 1)
        spacerItem13 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_22.addItem(spacerItem13, 0, 2, 1, 1)
        spacerItem14 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_22.addItem(spacerItem14, 1, 1, 1, 1)
        self.tabWidget.addTab(self.tab_22, "")
        self.tab_23 = QtWidgets.QWidget()
        self.tab_23.setObjectName("tab_23")
        self.gridLayout_23 = QtWidgets.QGridLayout(self.tab_23)
        self.gridLayout_23.setObjectName("gridLayout_23")
        spacerItem15 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_23.addItem(spacerItem15, 0, 0, 1, 1)
        self.verticalLayout_54 = QtWidgets.QVBoxLayout()
        self.verticalLayout_54.setObjectName("verticalLayout_54")
        self.flipImagesLeftToRightCheckBox = QtWidgets.QCheckBox(self.tab_23)
        self.flipImagesLeftToRightCheckBox.setObjectName("flipImagesLeftToRightCheckBox")
        self.verticalLayout_54.addWidget(self.flipImagesLeftToRightCheckBox)
        self.flipImagesTopToBottomCheckBox = QtWidgets.QCheckBox(self.tab_23)
        self.flipImagesTopToBottomCheckBox.setObjectName("flipImagesTopToBottomCheckBox")
        self.verticalLayout_54.addWidget(self.flipImagesTopToBottomCheckBox)
        self.line_18 = QtWidgets.QFrame(self.tab_23)
        ...
        self.cascadeCheckBox = QtWidgets.QCheckBox(self.tab_23)
        ...
        self.verticalLayout_54.addWidget(self.cascadeCheckBox)
        self.horizontalLayout_79 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_79.setObjectName("horizontalLayout_79")
        self.plotSymbolSizeLabel = QtWidgets.QLabel(self.tab_23)
        ...
        self.horizontalLayout_79.addWidget(self.plotSymbolSizeLabel)
        self.plotSymbolSizeSpinBox = QtWidgets.QSpinBox(self.tab_23)
        ...
        self.horizontalLayout_79.addWidget(self.plotSymbolSizeSpinBox)
        self.verticalLayout_54.addLayout(self.horizontalLayout_79)
        self.line_19 = QtWidgets.QFrame(self.tab_23)
        ...
        self.verticalLayout_54.addWidget(self.line_19)
        self.horizontalLayout_80 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_80.setObjectName("horizontalLayout_80")
        self.gammaLabel = QtWidgets.QLabel(self.tab_23)
        self.gammaLabel.setObjectName("gammaLabel")
        self.horizontalLayout_80.addWidget(self.gammaLabel)
        self.gammaSettingOfCamera = QtWidgets.QDoubleSpinBox(self.tab_23)
        ...
        self.horizontalLayout_80.addWidget(self.gammaSettingOfCamera)
        self.verticalLayout_54.addLayout(self.horizontalLayout_80)
        self.gridLayout_23.addLayout(self.verticalLayout_54, 0, 1, 1, 1)
        spacerItem16 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_23.addItem(spacerItem16, 0, 2, 1, 1)
        spacerItem17 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_23.addItem(spacerItem17, 1, 1, 1, 1)
        ...
        self.gridLayout_24.addItem(spacerItem18, 0, 0, 1, 1)
        self.verticalLayout_55 = QtWidgets.QVBoxLayout()
        self.verticalLayout_55.setObjectName("verticalLayout_55")
        self.manualWcsButton = QtWidgets.QPushButton(self.tab_24)
        ...
        self.verticalLayout_55.addWidget(self.manualWcsButton)
        self.line_20 = QtWidgets.QFrame(self.tab_24)
        self.line_20.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_20.setLineWidth(5)
        self.line_20.setMidLineWidth(5)
        self.line_20.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_20.setObjectName("line_20")
        self.verticalLayout_55.addWidget(self.line_20)
        self.frameToFitsButton = QtWidgets.QPushButton(self.tab_24)
        ...
        self.verticalLayout_55.addWidget(self.frameToFitsButton)
        self.horizontalLayout_81 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_81.setObjectName("horizontalLayout_81")
        self.wcsRedactTopLinesLabel = QtWidgets.QLabel(self.tab_24)
        ...
        self.horizontalLayout_81.addWidget(self.wcsRedactTopLinesLabel)
        self.wcsRedactLinesTopEdit = QtWidgets.QLineEdit(self.tab_24)
        ...
        self.horizontalLayout_81.addWidget(self.wcsRedactLinesTopEdit)
        self.wcsRedactLinesBottomEdit = QtWidgets.QLineEdit(self.tab_24)
        ...
        self.horizontalLayout_81.addWidget(self.wcsRedactLinesBottomEdit)
        self.wcsRedactBottomLinesLabel = QtWidgets.QLabel(self.tab_24)
        self.wcsRedactBottomLinesLabel.setObjectName("wcsRedactBottomLinesLabel")
        self.horizontalLayout_81.addWidget(self.wcsRedactBottomLinesLabel)
        ...
        self.pixelHeightLabel = QtWidgets.QLabel(self.tab_24)
        ...
        self.horizontalLayout_82.addWidget(self.pixelHeightLabel)
        self.pixelHeightEdit = QtWidgets.QLineEdit(self.tab_24)
        ...
        self.horizontalLayout_82.addWidget(self.pixelHeightEdit)
        self.pixelWidthEdit = QtWidgets.QLineEdit(self.tab_24)
        ...
        self.horizontalLayout_82.addWidget(self.pixelWidthEdit)
        self.pixelWidthLabel = QtWidgets.QLabel(self.tab_24)
        ...
        self.horizontalLayout_82.addWidget(self.pixelWidthLabel)
        self.verticalLayout_55.addLayout(self.horizontalLayout_82)
        self.line_21 = QtWidgets.QFrame(self.tab_24)
        self.line_21.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_21.setLineWidth(5)
        self.line_21.setMidLineWidth(5)
        self.line_21.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_21.setObjectName("line_21")
        self.verticalLayout_55.addWidget(self.line_21)
        ...
        self.ucac4Label = QtWidgets.QLabel(self.tab_24)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_83.addWidget(self.ucac4Label)
        self.starIdEdit = QtWidgets.QLineEdit(self.tab_24)
        self.starIdEdit.setObjectName("starIdEdit")
        self.horizontalLayout_83.addWidget(self.starIdEdit)
        self.queryVizierButton = QtWidgets.QPushButton(self.tab_24)
        self.queryVizierButton.setObjectName("queryVizierButton")
        self.horizontalLayout_83.addWidget(self.queryVizierButton)
        ...
        self.coordinatesEdit = QtWidgets.QLineEdit(self.tab_24)
        ...
        self.horizontalLayout_84.addWidget(self.coordinatesEdit)
        self.saveTargetLocButton = QtWidgets.QPushButton(self.tab_24)
        self.saveTargetLocButton.setEnabled(False)
        self.saveTargetLocButton.setObjectName("saveTargetLocButton")
        self.horizontalLayout_84.addWidget(self.saveTargetLocButton)
        self.verticalLayout_55.addLayout(self.horizontalLayout_84)
        self.gridLayout_24.addLayout(self.verticalLayout_55, 0, 1, 1, 1)
        spacerItem19 = QtWidgets.QSpacerItem(180, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_24.addItem(spacerItem19, 0, 2, 1, 1)
        ...
        self.gridLayout_25 = QtWidgets.QGridLayout(self.tab_25)
        self.gridLayout_25.setObjectName("gridLayout_25")
        spacerItem21 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_25.addItem(spacerItem21, 0, 2, 1, 1)
        self.verticalLayout_56 = QtWidgets.QVBoxLayout()
        self.verticalLayout_56.setObjectName("verticalLayout_56")
        self.lunarCheckBox = QtWidgets.QCheckBox(self.tab_25)
        self.lunarCheckBox.setObjectName("lunarCheckBox")
        self.verticalLayout_56.addWidget(self.lunarCheckBox)
        self.useYellowMaskCheckBox = QtWidgets.QCheckBox(self.tab_25)
        self.useYellowMaskCheckBox.setObjectName("useYellowMaskCheckBox")
        self.verticalLayout_56.addWidget(self.useYellowMaskCheckBox)
        self.view3DButton = QtWidgets.QPushButton(self.tab_25)
        self.view3DButton.setObjectName("view3DButton")
        self.verticalLayout_56.addWidget(self.view3DButton)
        self.gridLayout_25.addLayout(self.verticalLayout_56, 0, 1, 1, 1)
        spacerItem22 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_25.addItem(spacerItem22, 0, 0, 1, 1)
        spacerItem23 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_25.addItem(spacerItem23, 1, 1, 1, 1)
        ...
        self.gridLayout_26.addItem(spacerItem24, 0, 2, 1, 1)
        spacerItem25 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_26.addItem(spacerItem25, 0, 0, 1, 1)
        self.verticalLayout_57 = QtWidgets.QVBoxLayout()
        self.verticalLayout_57.setObjectName("verticalLayout_57")
        self.toolButton = QtWidgets.QToolButton(self.tab_26)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.toolButton.setFont(font)
        self.toolButton.setObjectName("toolButton")
        self.verticalLayout_57.addWidget(self.toolButton)
        self.twoPointHelpButton = QtWidgets.QToolButton(self.tab_26)
        ...
        self.verticalLayout_57.addWidget(self.twoPointHelpButton)
        self.transportHelp = QtWidgets.QToolButton(self.tab_26)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_57.addWidget(self.transportHelp)
        self.documentationPushButton = QtWidgets.QPushButton(self.tab_26)
        self.documentationPushButton.setObjectName("documentationPushButton")
        self.verticalLayout_57.addWidget(self.documentationPushButton)
        self.gridLayout_26.addLayout(self.verticalLayout_57, 0, 1, 1, 1)
        spacerItem26 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_26.addItem(spacerItem26, 1, 1, 1, 1)
        self.tabWidget.addTab(self.tab_26, "")
        self.tab_27 = QtWidgets.QWidget()
        self.tab_27.setObjectName("tab_27")
        self.gridLayout_27 = QtWidgets.QGridLayout(self.tab_27)
        ...
        self.horizontalLayout_85.addItem(spacerItem27)
        self.appSizeToolButton = QtWidgets.QToolButton(self.tab_27)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.appSizeToolButton.setFont(font)
        self.appSizeToolButton.setObjectName("appSizeToolButton")
        self.horizontalLayout_85.addWidget(self.appSizeToolButton)
        spacerItem28 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_85.addItem(spacerItem28)
        self.verticalLayout_58.addLayout(self.horizontalLayout_85)
        ...
        self.frame_7 = QtWidgets.QFrame(self.tab_27)
        self.frame_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_7.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_7.setObjectName("frame_7")
        self.horizontalLayout_87 = QtWidgets.QHBoxLayout(self.frame_7)
        ...
        self.defAppSize51RadioButton = QtWidgets.QRadioButton(self.frame_7)
        ...
        self.verticalLayout_59.addWidget(self.defAppSize51RadioButton)
        self.defAppSize41RadioButton = QtWidgets.QRadioButton(self.frame_7)
        self.defAppSize41RadioButton.setObjectName("defAppSize41RadioButton")
        self.verticalLayout_59.addWidget(self.defAppSize41RadioButton)
        self.defAppSize31RadioButton = QtWidgets.QRadioButton(self.frame_7)
        self.defAppSize31RadioButton.setObjectName("defAppSize31RadioButton")
        self.verticalLayout_59.addWidget(self.defAppSize31RadioButton)
        self.defAppSize21RadioButton = QtWidgets.QRadioButton(self.frame_7)
        self.defAppSize21RadioButton.setObjectName("defAppSize21RadioButton")
        self.verticalLayout_59.addWidget(self.defAppSize21RadioButton)
        self.defAppSize11RadioButton = QtWidgets.QRadioButton(self.frame_7)
        self.defAppSize11RadioButton.setObjectName("defAppSize11RadioButton")
        self.verticalLayout_59.addWidget(self.defAppSize11RadioButton)
        self.horizontalLayout_87.addLayout(self.verticalLayout_59)
        self.horizontalLayout_86.addWidget(self.frame_7)
        spacerItem30 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_86.addItem(spacerItem30)
        self.verticalLayout_58.addLayout(self.horizontalLayout_86)
        self.gridLayout_27.addLayout(self.verticalLayout_58, 0, 0, 1, 1)
        ...
        self.sigmaLevelToolButton = QtWidgets.QToolButton(self.tab_27)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.sigmaLevelToolButton.setFont(font)
        self.sigmaLevelToolButton.setObjectName("sigmaLevelToolButton")
        self.horizontalLayout_88.addWidget(self.sigmaLevelToolButton)
        spacerItem32 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_88.addItem(spacerItem32)
        self.verticalLayout_60.addLayout(self.horizontalLayout_88)
        self.horizontalLayout_89 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_89.setObjectName("horizontalLayout_89")
        self.frame_8 = QtWidgets.QFrame(self.tab_27)
        ...
        self.horizontalLayout_90.addItem(spacerItem33)
        self.verticalLayout_61 = QtWidgets.QVBoxLayout()
        self.verticalLayout_61.setObjectName("verticalLayout_61")
        self.oneSigmaRadioButton = QtWidgets.QRadioButton(self.frame_8)
        self.oneSigmaRadioButton.setChecked(False)
        self.oneSigmaRadioButton.setObjectName("oneSigmaRadioButton")
        self.verticalLayout_61.addWidget(self.oneSigmaRadioButton)
        self.twoSigmaRadioButton = QtWidgets.QRadioButton(self.frame_8)
        self.twoSigmaRadioButton.setChecked(True)
        self.twoSigmaRadioButton.setObjectName("twoSigmaRadioButton")
        self.verticalLayout_61.addWidget(self.twoSigmaRadioButton)
        self.threeSigmaRadioButton = QtWidgets.QRadioButton(self.frame_8)
        self.threeSigmaRadioButton.setObjectName("threeSigmaRadioButton")
        self.verticalLayout_61.addWidget(self.threeSigmaRadioButton)
        self.horizontalLayout_90.addLayout(self.verticalLayout_61)
        spacerItem34 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_90.addItem(spacerItem34)
        self.horizontalLayout_89.addWidget(self.frame_8)
        self.verticalLayout_60.addLayout(self.horizontalLayout_89)
        self.gridLayout_27.addLayout(self.verticalLayout_60, 0, 1, 1, 1)
        ...
        self.horizontalLayout_91.addItem(spacerItem35)
        self.defaultMaskRadiusToolButton = QtWidgets.QToolButton(self.tab_27)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.defaultMaskRadiusToolButton.setFont(font)
        self.defaultMaskRadiusToolButton.setObjectName("defaultMaskRadiusToolButton")
        self.horizontalLayout_91.addWidget(self.defaultMaskRadiusToolButton)
        spacerItem36 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_91.addItem(spacerItem36)
        self.verticalLayout_62.addLayout(self.horizontalLayout_91)
        ...
        self.horizontalLayout_93 = QtWidgets.QHBoxLayout(self.frame_9)
        ...
        self.radius20radioButton = QtWidgets.QRadioButton(self.frame_9)
        self.radius20radioButton.setObjectName("radius20radioButton")
        self.verticalLayout_63.addWidget(self.radius20radioButton)
        self.radius28radioButton = QtWidgets.QRadioButton(self.frame_9)
        self.radius28radioButton.setObjectName("radius28radioButton")
        self.verticalLayout_63.addWidget(self.radius28radioButton)
        self.radius32radioButton = QtWidgets.QRadioButton(self.frame_9)
        self.radius32radioButton.setChecked(True)
        self.radius32radioButton.setObjectName("radius32radioButton")
        self.verticalLayout_63.addWidget(self.radius32radioButton)
        self.radius40radioButton = QtWidgets.QRadioButton(self.frame_9)
        self.radius40radioButton.setObjectName("radius40radioButton")
        self.verticalLayout_63.addWidget(self.radius40radioButton)
        self.radius45radioButton = QtWidgets.QRadioButton(self.frame_9)
        self.radius45radioButton.setObjectName("radius45radioButton")
        self.verticalLayout_63.addWidget(self.radius45radioButton)
        self.radius53radioButton = QtWidgets.QRadioButton(self.frame_9)
        self.radius53radioButton.setObjectName("radius53radioButton")
        self.verticalLayout_63.addWidget(self.radius53radioButton)
        self.radius68radioButton = QtWidgets.QRadioButton(self.frame_9)
        self.radius68radioButton.setObjectName("radius68radioButton")
        self.verticalLayout_63.addWidget(self.radius68radioButton)
        self.horizontalLayout_93.addLayout(self.verticalLayout_63)
        self.horizontalLayout_92.addWidget(self.frame_9)
        ...
        self.gridLayout_27.addLayout(self.verticalLayout_62, 0, 2, 1, 1)
        self.tabWidget.addTab(self.tab_27, "")
        self.verticalLayout_47.addWidget(self.tabWidget)
        self.layoutWidget_10 = QtWidgets.QWidget(self.splitterTwo)
        self.layoutWidget_10.setObjectName("layoutWidget_10")
        self.verticalLayout_64 = QtWidgets.QVBoxLayout(self.layoutWidget_10)
        self.verticalLayout_64.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_64.setObjectName("verticalLayout_64")
        self.frameView = ImageView(self.layoutWidget_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.transportMaxLeft = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.horizontalLayout_96.addWidget(self.transportMaxLeft)
        self.transportBigLeft = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportBigLeft.setFont(font)
        self.transportBigLeft.setObjectName("transportBigLeft")
        self.horizontalLayout_96.addWidget(self.transportBigLeft)
        self.transportSmallLeft = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportSmallLeft.setFont(font)
        self.transportSmallLeft.setObjectName("transportSmallLeft")
        self.horizontalLayout_96.addWidget(self.transportSmallLeft)
        self.transportMinusOneFrame = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.horizontalLayout_96.addWidget(self.transportMinusOneFrame)
        self.transportPlayLeft = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportPlayLeft.setFont(font)
        self.transportPlayLeft.setObjectName("transportPlayLeft")
        self.horizontalLayout_96.addWidget(self.transportPlayLeft)
        self.transportPause = QtWidgets.QToolButton(self.layoutWidget_10)
        ...
        self.horizontalLayout_96.addWidget(self.transportPause)
        self.transportAnalyze = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_96.addWidget(self.transportAnalyze)
        self.transportPlayRight = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportPlayRight.setFont(font)
        self.transportPlayRight.setObjectName("transportPlayRight")
        self.horizontalLayout_96.addWidget(self.transportPlayRight)
        self.transportPlusOneFrame = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.horizontalLayout_96.addWidget(self.transportPlusOneFrame)
        self.transportSmallRight = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportSmallRight.setFont(font)
        self.transportSmallRight.setObjectName("transportSmallRight")
        self.horizontalLayout_96.addWidget(self.transportSmallRight)
        self.transportBigRight = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportBigRight.setFont(font)
        self.transportBigRight.setObjectName("transportBigRight")
        self.horizontalLayout_96.addWidget(self.transportBigRight)
        self.transportMaxRight = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportMaxRight.setFont(font)
        self.transportMaxRight.setObjectName("transportMaxRight")
        self.horizontalLayout_96.addWidget(self.transportMaxRight)
        self.horizontalLayout_95.addLayout(self.horizontalLayout_96)
        self.verticalLayout_65.addLayout(self.horizontalLayout_95)
        ...
        self.horizontalLayout_98.addItem(spacerItem39)
        self.transportCsv = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_98.addWidget(self.transportCsv)
        self.transportPlot = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_98.addWidget(self.transportPlot)
        self.transportCurrentFrameLabel = QtWidgets.QLabel(self.layoutWidget_10)
        ...
        self.horizontalLayout_98.addWidget(self.transportCurrentFrameLabel)
        self.currentFrameSpinBox = QtWidgets.QSpinBox(self.layoutWidget_10)
        ...
        self.horizontalLayout_98.addWidget(self.currentFrameSpinBox)
        ...
        self.stopAtFrameSpinBox = QtWidgets.QSpinBox(self.layoutWidget_10)
        ...
        self.horizontalLayout_99.addWidget(self.stopAtFrameSpinBox)
        self.transportStopAtFrameLabel = QtWidgets.QLabel(self.layoutWidget_10)
        self.transportStopAtFrameLabel.setObjectName("transportStopAtFrameLabel")
        self.horizontalLayout_99.addWidget(self.transportStopAtFrameLabel)
        self.label_9 = QtWidgets.QLabel(self.layoutWidget_10)
        self.label_9.setText("")
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_99.addWidget(self.label_9)
        self.transportMark = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_99.addWidget(self.transportMark)
        self.transportReturnToMark = QtWidgets.QToolButton(self.layoutWidget_10)
        ...
        self.horizontalLayout_99.addWidget(self.transportReturnToMark)
        self.horizontalLayout_97.addLayout(self.horizontalLayout_99)
        self.transportClearData = QtWidgets.QToolButton(self.layoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_97.addWidget(self.transportClearData)
        spacerItem40 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_97.addItem(spacerItem40)
        self.verticalLayout_65.addLayout(self.horizontalLayout_97)
        self.horizontalLayout_94.addLayout(self.verticalLayout_65)
        ...
        self.verticalLayout_64.addLayout(self.horizontalLayout_94)
        ...
        self.layoutWidget_11 = QtWidgets.QWidget(self.splitterOne)
        self.layoutWidget_11.setObjectName("layoutWidget_11")
        self.verticalLayout_66 = QtWidgets.QVBoxLayout(self.layoutWidget_11)
        ...
        self.textOut = QtWidgets.QTextEdit(self.layoutWidget_11)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.verticalLayout_67.addWidget(self.textOut)
        self.verticalLayout_66.addLayout(self.verticalLayout_67)
        self.textOutLabel = QtWidgets.QLabel(self.layoutWidget_11)
        self.textOutLabel.setObjectName("textOutLabel")
        self.verticalLayout_66.addWidget(self.textOutLabel)
        self.layoutWidget_12 = QtWidgets.QWidget(self.splitterOne)
        self.layoutWidget_12.setObjectName("layoutWidget_12")
        self.horizontalLayout_100 = QtWidgets.QHBoxLayout(self.layoutWidget_12)
        ...
        self.thumbOneView = ImageView(self.layoutWidget_12)
        self.thumbOneView.setMinimumSize(QtCore.QSize(0, 350))
        self.thumbOneView.setObjectName("thumbOneView")
        self.verticalLayout_68.addWidget(self.thumbOneView)
        self.thumbnailOneLabel = QtWidgets.QLabel(self.layoutWidget_12)
        self.thumbnailOneLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.thumbnailOneLabel.setObjectName("thumbnailOneLabel")
        self.verticalLayout_68.addWidget(self.thumbnailOneLabel)
        self.horizontalLayout_100.addLayout(self.verticalLayout_68)
        self.verticalLayout_69 = QtWidgets.QVBoxLayout()
        self.verticalLayout_69.setObjectName("verticalLayout_69")
        self.thumbTwoView = ImageView(self.layoutWidget_12)
        self.thumbTwoView.setObjectName("thumbTwoView")
        self.verticalLayout_69.addWidget(self.thumbTwoView)
        self.thumbnailTwoLabel = QtWidgets.QLabel(self.layoutWidget_12)
        self.thumbnailTwoLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.thumbnailTwoLabel.setObjectName("thumbnailTwoLabel")
        self.verticalLayout_69.addWidget(self.thumbnailTwoLabel)
        self.horizontalLayout_100.addLayout(self.verticalLayout_69)
        self.horizontalLayout_101.addWidget(self.splitterThree)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Threshold spinner increments:"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_19), _translate("MainWindow", "File/Folder"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_20), _translate("MainWindow", "Timestamp"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_21), _translate("MainWindow", "Hot Pixels"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_22), _translate("MainWindow", "\"finder\""))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_23), _translate("MainWindow", "Image/Plot"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_24), _translate("MainWindow", "WCS"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_25), _translate("MainWindow", "Misc."))
        self.toolButton.setText(_translate("MainWindow", "The best and most relevant help is obtained by right-clicking\n"
...
"action associated with it."))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_26), _translate("MainWindow", "Help"))
...
"aperture placement."))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_27), _translate("MainWindow", "Pref."))
