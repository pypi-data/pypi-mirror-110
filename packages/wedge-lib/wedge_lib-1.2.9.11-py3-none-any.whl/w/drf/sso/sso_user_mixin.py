...
class SsoUserMixin:
    ...
    @classmethod
    def get_or_create_sso_user(cls, user: User, password: str, list_apps: list):
    ...
    @classmethod
    def require_update_user_password(cls, user_id, lifespan=None, redirect_uri=None):
        return SsoService.require_update_password(
            user_id=user_id, lifespan=lifespan, redirect_uri=redirect_uri
        )
