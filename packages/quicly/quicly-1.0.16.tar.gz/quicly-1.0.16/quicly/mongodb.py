...
class QxMongoClient(object):
  ...
  def find_many_with_page_info(self, collection_name, filter=None, sort=None, skip=None, limit=None, projection=None, page_info=None, fn_process_item=None, fn_process_sort=None):
...
class QxMongoModel(object):
  def __init__(self, mongo_client, collection_name, pk_name='_id', ex_field_names=None):
