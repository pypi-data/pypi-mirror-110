...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.11.0-alpha.1624446270+7666a1ce'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.11.0-alpha.1624446270+7666a1ce`
                """)
            else:
                raise
