...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.10.0-alpha.1624379191+0b76e3a1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.10.0-alpha.1624379191+0b76e3a1`
                """)
            else:
                raise
