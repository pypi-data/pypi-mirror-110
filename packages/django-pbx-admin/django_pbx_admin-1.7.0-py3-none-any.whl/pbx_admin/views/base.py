...
class AdminListView(PaginationMixin, AdminViewMixin, FormMixin, FooterMixin, ListView):
    template_name = "pbx_admin/list.html"
    allow_empty = True
    ...
    def get_form(self, form_class=None):
        ...
        return self.admin.get_search_form(self, form)
    ...
    def _get_context_header(self):
        ...
        for field in self.admin.list_display:
            attrs = self._get_header_field_attrs(field)
            ...
            if admin_field and hasattr(admin_field, "order_field"):
                order_field = admin_field.order_field
            elif model_field:
    ...
    def _get_header_field_attrs(self, field_name: str) -> dict[str, str] | None:
        if self.admin:
            return self.admin._get_header_field_attrs(field_name)
        return None
...
class AdminUpdateView(AdminSingleObjectView, UpdateView):
    ...
    formsets: dict[str, type[BaseFormSet]] = {}
