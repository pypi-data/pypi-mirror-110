...
from django.forms.widgets import FileInput, Textarea, CheckboxInput, HiddenInput, Input
...
class ImageInput(FileInput):
    ...
    template_name: str = "pbx_admin/forms/widgets/image_input_widget.html"
...
class RemovableImageInput(ImageInput):
    remove_input_cls: type[Input] = CheckboxInput
...
class PrettyRemovableImageInput(RemovableImageInput):
    template_name: str = "pbx_admin/forms/widgets/pretty_image_input_widget.html"
    remove_input_cls: type[Input] = HiddenInput
