...
class Nativemethods(metaclass=Singleton):
    ...
    def init_autd3capi(self):
        if hasattr(self, 'autd3capi'):
            return
        self.autd3capi = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.4.2" + self._bin_ext))
        ...
        self.autd3capi.AUTDSetEnable.argtypes = [c_void_p, POINTER(c_ubyte)]
        self.autd3capi.AUTDSetEnable.restypes = [c_bool]

        self.autd3capi.AUTDSetDelayEnable.argtypes = [c_void_p, POINTER(c_ushort)]
        self.autd3capi.AUTDSetDelayEnable.restypes = [c_bool]
        ...
        self.autd3capi.AUTDSequenceAddPoint.argtypes = [c_void_p, c_double, c_double, c_double]
        self.autd3capi.AUTDSequenceAddPoint.restypes = [c_bool]

        self.autd3capi.AUTDSequenceAddPoints.argtypes = [c_void_p, POINTER(c_double), c_ulong]
    ...
    def init_autd3capi_holo_gain(self):
        if hasattr(self, 'autd3capi_holo_gain'):
            return
        self.autd3capi_holo_gain = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.4.2-holo-gain" + self._bin_ext))
    ...
    def init_autd3capi_soem_link(self):
        if hasattr(self, 'autd3capi_soem_link'):
            return
        self.autd3capi_soem_link = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.4.2-soem-link" + self._bin_ext))
    ...
    def init_autd3capi_twincat_link(self):
        if hasattr(self, 'autd3capi_twincat_link'):
            return
        self.autd3capi_twincat_link = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.4.2-twincat-link" + self._bin_ext))
