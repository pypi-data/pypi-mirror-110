...
class DataModel(root.AbstractShareableHEAObject):
    def __init__(self):
        super().__init__()
...
class Row(root.AbstractNonShareableHEAObject):
    def __init__(self):
        super().__init__()


class Column(root.AbstractNonShareableHEAObject):
    def __init__(self):
        super().__init__()
...
class Entity(root.AbstractNonShareableHEAObject):
    def __init__(self):
        super().__init__()
        self.attributes = []
        self.associations = []
...
class Attribute(root.AbstractNonShareableHEAObject):
    def __init__(self):
        super().__init__()
        self.data_element_uri = None


class Association(root.AbstractNonShareableHEAObject):
    def __init__(self):
        super().__init__()
