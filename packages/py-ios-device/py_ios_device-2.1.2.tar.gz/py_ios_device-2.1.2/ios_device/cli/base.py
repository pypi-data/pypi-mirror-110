...
if __name__ == '__main__':
    with InstrumentsBase() as c:
        print(c.device_info.iconDescriptionFileForAppPath('/private/var/containers/Bundle/Application/A86066DC-C145-4900-90E7-6FB0CF72215A/smoba.app'))
