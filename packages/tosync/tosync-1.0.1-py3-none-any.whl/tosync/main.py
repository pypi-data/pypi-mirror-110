...
# args = parser.parse_args()
sample_data = ['/Users/steph/ML_final/tosync2/DATA/v1.txt', '/Users/steph/ML_final/tosync2/DATA/v1.mp4']
media = [Media(m) for m in sample_data]
model = load_model('/Users/steph/ML_final/tosync2/out/ann.hdf5')
model.compile(loss='mean_squared_error', optimizer='adam', metrics=['accuracy'])
