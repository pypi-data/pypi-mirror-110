...
class Polynomial():
    ...
    def __init__(self, series, shape=(0, 6), validation='p_value', threshold=0.05, confidence=None, rolling=None, outlier_sigma=2, adjust=True, **kwargs):
...
def _pattern_plot(_obj, **kwargs):
    ...
    #ax1.text(0.02, 0.9, r'$R^2$'+f': {_obj.rsq}', transform=ax1.transAxes, va='center', ha='left')
