...
class WorkspacesOperations(object):
    ...
    def get(
            self, resource_group_name, workspace_name, custom_headers=None, raw=False, is_dataplane=False,
            **operation_config):
    ...
    def _sync_keys_initial(
        ...
        # Construct parameters
        query_parameters = {}
        query_parameters['api-version'] = self._serialize.query("self.api_version",
                                                                self.resynckeys_lro_min_api_version, 'str')
