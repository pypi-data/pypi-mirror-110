...
class KubernetesCompute(ComputeTarget):
    ...
    def attach_configuration(resource_id=None, namespace=None,
                             default_instance_type=None, instance_types=None):
        ...
        :type namespace: str
        :param default_instance_type: Compute's default_instance_type.
        :type default_instance_type: str
        :param instance_types: Compute's instance_types. This is a dictionary of name to nodeSelector/resources.
        :type instance_types: dict
        ...
        """
        config = KubernetesComputeAttachConfiguration(resource_id, namespace, default_instance_type, instance_types)
        return config
    ...
    def _build_attach_payload(config, workspace):
        ...
        json_payload['properties']['properties']['defaultInstanceType'] = config.default_instance_type
        json_payload['properties']['properties']['instanceTypes'] = config.instance_types
...
class KubernetesComputeAttachConfiguration(ComputeTargetAttachConfiguration):
    ...
    def __init__(self, resource_id=None, namespace=None, default_instance_type=None, instance_types=None):
