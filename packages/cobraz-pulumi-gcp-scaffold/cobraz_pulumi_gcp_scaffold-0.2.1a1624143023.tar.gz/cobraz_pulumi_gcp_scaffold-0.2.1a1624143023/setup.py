...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp-scaffold', '0.2.1-alpha.1624143023+3721c5f7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp-scaffold 0.2.1-alpha.1624143023+3721c5f7`
                """)
            else:
                raise
