...
class SpecImportParser(Parser):
    ...
    @_('ANY', 'STRING')  # type: ignore # noqa: F821
    ...
    def maybe_import_decl(self, p: YaccProduction) -> List[Tuple[str, str]]:  # Surely an import declaration
                ...
                for verification_query in verification_queries:
                    ...
                    self.certora_verify_struct.append(
                        {"type": "spec",
                         ...
                         "specfile_orig_relpath": as_posix(os.path.relpath(vq_spec)),
                         "specfiles_to_import_decls": vq_spec_with_imports.eventual_path_to_orig_imports,
                         "import_files_to_orig_relpaths": vq_spec_with_imports.eventual_import_paths_to_relpaths
                         }
                    )
                    vq_spec_idx += 1
    ...
    def check_and_collect_imported_spec_files(self, spec_file: str, seen_abspath_imports_to_locs: Dict[str, Set[str]],
        ...
        with open(spec_file, 'r') as f:
            ...
            abspath_imports_with_locs = list(map(
                lambda path_to_loc: (abs_posix_path(as_posix(path_to_loc[0])), path_to_loc[1]),
                imports_with_locs))
