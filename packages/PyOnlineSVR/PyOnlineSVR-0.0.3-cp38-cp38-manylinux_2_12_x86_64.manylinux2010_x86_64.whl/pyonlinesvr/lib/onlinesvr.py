...
def OnlineSVR_CrossValidation(*args) -> "double":
    return _onlinesvr.OnlineSVR_CrossValidation(*args)

def OnlineSVR_LeaveOneOut(*args) -> "double":
    return _onlinesvr.OnlineSVR_LeaveOneOut(*args)

def OnlineSVR_Import(*args) -> "void":
    return _onlinesvr.OnlineSVR_Import(*args)
...
class DoubleVector(object):
    ...
    def Find(self, X: "double") -> "int":
        return _onlinesvr.DoubleVector_Find(self, X)

    @staticmethod
    def Load(Filename: "char *") -> "Vector< double > *":
        return _onlinesvr.DoubleVector_Load(Filename)

    def Save(self, Filename: "char *") -> "void":
...
def DoubleVector_ZeroVector(Length: "int") -> "Vector< double > *":
    return _onlinesvr.DoubleVector_ZeroVector(Length)

def DoubleVector_RandVector(Length: "int") -> "Vector< double > *":
    return _onlinesvr.DoubleVector_RandVector(Length)

def DoubleVector_GetSequence(Start: "double", Step: "double", End: "double") -> "Vector< double > *":
    return _onlinesvr.DoubleVector_GetSequence(Start, Step, End)

def DoubleVector_SumVector(*args) -> "Vector< double > *":
    return _onlinesvr.DoubleVector_SumVector(*args)

def DoubleVector_SubtractVector(*args) -> "Vector< double > *":
    return _onlinesvr.DoubleVector_SubtractVector(*args)

def DoubleVector_ProductVector(*args) -> "Vector< double > *":
    return _onlinesvr.DoubleVector_ProductVector(*args)

def DoubleVector_ProductVectorScalar(*args) -> "double":
    return _onlinesvr.DoubleVector_ProductVectorScalar(*args)

def DoubleVector_Load(Filename: "char *") -> "Vector< double > *":
    return _onlinesvr.DoubleVector_Load(Filename)
...
class IntVector(object):
    ...
    def SetValue(self, Index: "int", Value: "int") -> "void":
    ...
    @staticmethod
    def Load(Filename: "char *") -> "Vector< int > *":
...
def IntVector_ZeroVector(Length: "int") -> "Vector< double > *":
    return _onlinesvr.IntVector_ZeroVector(Length)

def IntVector_RandVector(Length: "int") -> "Vector< double > *":
    return _onlinesvr.IntVector_RandVector(Length)

def IntVector_GetSequence(Start: "int", Step: "int", End: "int") -> "Vector< int > *":
    return _onlinesvr.IntVector_GetSequence(Start, Step, End)

def IntVector_SumVector(*args) -> "Vector< int > *":
    return _onlinesvr.IntVector_SumVector(*args)

def IntVector_SubtractVector(*args) -> "Vector< int > *":
    return _onlinesvr.IntVector_SubtractVector(*args)

def IntVector_ProductVector(*args) -> "Vector< int > *":
    return _onlinesvr.IntVector_ProductVector(*args)

def IntVector_ProductVectorScalar(*args) -> "int":
    return _onlinesvr.IntVector_ProductVectorScalar(*args)

def IntVector_Load(Filename: "char *") -> "Vector< int > *":
    return _onlinesvr.IntVector_Load(Filename)
...
class DoubleMatrix(object):
    ...
    def SumMatrix(self, M: "DoubleMatrix") -> "void":
        return _onlinesvr.DoubleMatrix_SumMatrix(self, M)

    def SubtractMatrix(self, M: "DoubleMatrix") -> "void":
    ...
    @staticmethod
    def ProductVectorVector(V1: "DoubleVector", V2: "DoubleVector") -> "Matrix< double > *":
        return _onlinesvr.DoubleMatrix_ProductVectorVector(V1, V2)

    @staticmethod
    def ProductMatrixMatrix(M1: "DoubleMatrix", M2: "DoubleMatrix") -> "Matrix< double > *":
        return _onlinesvr.DoubleMatrix_ProductMatrixMatrix(M1, M2)

    @staticmethod
    def Load(Filename: "char *") -> "Matrix< double > *":
...
def DoubleMatrix_ZeroMatrix(RowsNumber: "int", ColsNumber: "int") -> "Matrix< double > *":
    return _onlinesvr.DoubleMatrix_ZeroMatrix(RowsNumber, ColsNumber)

def DoubleMatrix_RandMatrix(RowsNumber: "int", ColsNumber: "int") -> "Matrix< double > *":
    return _onlinesvr.DoubleMatrix_RandMatrix(RowsNumber, ColsNumber)

def DoubleMatrix_ProductVector(*args) -> "Vector< double > *":
    return _onlinesvr.DoubleMatrix_ProductVector(*args)

def DoubleMatrix_ProductVectorVector(V1: "DoubleVector", V2: "DoubleVector") -> "Matrix< double > *":
    return _onlinesvr.DoubleMatrix_ProductVectorVector(V1, V2)

def DoubleMatrix_ProductMatrixMatrix(M1: "DoubleMatrix", M2: "DoubleMatrix") -> "Matrix< double > *":
    return _onlinesvr.DoubleMatrix_ProductMatrixMatrix(M1, M2)

def DoubleMatrix_Load(Filename: "char *") -> "Matrix< double > *":
    return _onlinesvr.DoubleMatrix_Load(Filename)
...
class IntMatrix(object):
    ...
    def ExtractRows(self, FromRowIndex: "int", ToRowIndex: "int") -> "Matrix< int > *":
        return _onlinesvr.IntMatrix_ExtractRows(self, FromRowIndex, ToRowIndex)

    def ExtractCols(self, FromColIndex: "int", ToColIndex: "int") -> "Matrix< int > *":
    ...
    def SumMatrix(self, M: "IntMatrix") -> "void":
        return _onlinesvr.IntMatrix_SumMatrix(self, M)

    def SubtractMatrix(self, M: "IntMatrix") -> "void":
    ...
    @staticmethod
    def ProductVectorVector(V1: "IntVector", V2: "IntVector") -> "Matrix< int > *":
        return _onlinesvr.IntMatrix_ProductVectorVector(V1, V2)

    @staticmethod
    def ProductMatrixMatrix(M1: "IntMatrix", M2: "IntMatrix") -> "Matrix< int > *":
...
def IntMatrix_ZeroMatrix(RowsNumber: "int", ColsNumber: "int") -> "Matrix< double > *":
    return _onlinesvr.IntMatrix_ZeroMatrix(RowsNumber, ColsNumber)

def IntMatrix_RandMatrix(RowsNumber: "int", ColsNumber: "int") -> "Matrix< double > *":
    return _onlinesvr.IntMatrix_RandMatrix(RowsNumber, ColsNumber)

def IntMatrix_ProductVector(*args) -> "Vector< int > *":
    return _onlinesvr.IntMatrix_ProductVector(*args)

def IntMatrix_ProductVectorVector(V1: "IntVector", V2: "IntVector") -> "Matrix< int > *":
    return _onlinesvr.IntMatrix_ProductVectorVector(V1, V2)

def IntMatrix_ProductMatrixMatrix(M1: "IntMatrix", M2: "IntMatrix") -> "Matrix< int > *":
    return _onlinesvr.IntMatrix_ProductMatrixMatrix(M1, M2)

def IntMatrix_Load(Filename: "char *") -> "Matrix< double > *":
    return _onlinesvr.IntMatrix_Load(Filename)
