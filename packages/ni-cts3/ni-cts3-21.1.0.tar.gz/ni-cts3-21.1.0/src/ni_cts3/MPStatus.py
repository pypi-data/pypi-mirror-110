...
class CTS3ErrorCode(IntEnum):
    ...
    RET_INVALID_COUPLER_NUMBER = 0x001B,
    ...
    """
    ERRSIM_NO_PPS_REQUEST_PENDING = 200,
    CRET_SIM_NO_EVENT = 390,
    CRET_SIMULATOR_NOT_RUNNING = 392,
    CRET_SIMULATOR_NOT_INITIALIZED = 394,
    CRET_WRONG_SIMU = 443,
    ERRSIM_NO_DEFAULT_PROC = 453,
    CRET_FPGA_SIMU_RAM_FULL = 456,
    ERRSIM_NO_FRAME_AVAILABLE = 724,
    ERRSIM_NO_RATS_PENDING = 727,
    ...
    ERR_RF_FIELD_NOT_SWITCHED_ACT_TGT = 0x0272,
    ...
    ERR_PCD_RF_ON_TIME_TOO_SHORT = 0x027C,
