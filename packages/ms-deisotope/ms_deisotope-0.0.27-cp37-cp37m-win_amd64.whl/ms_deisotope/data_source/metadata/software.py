...
software_names = TermSet([
    ...
    SoftwareName(u'Skyline mzQuantML converter', u'MS:1002546',
                 ...
                 'software',
                 [u'quantitation software name', u'analysis software', u'software', u'quantification information']),
    SoftwareName(u'PatternLab', u'MS:1003108',
                 (u'PatternLab for Proteomics is an integrated computational'
                  u'environment for analyzing shotgun proteomic data.'),
                 'software',
                 [u'quantitation software name', u'analysis software', u'software', u'quantification information']),
    SoftwareName(u'QUIN-XL', u'MS:1003111',
                 (u'Quantification of cross-linked peptides in complex protein'
                  u'mixtures'),
                 'software',
                 [u'quantitation software name', u'software', u'quantification information']),
    ...
    SoftwareName(u'Philosopher', u'MS:1003018',
                 ...
                 'software',
                 [u'analysis software', u'software']),
    SoftwareName(u'SIM-XL', u'MS:1003109',
                 (u'Identifying cross-linked peptides in complex protein'
                  u'mixtures'),
                 'software',
                 [u'analysis software', u'software']),
    SoftwareName(u'EPIFANY', u'MS:1003118',
                 (u'A Method for Efficient High-Confidence Protein Inference.'
                  u'The tool is part of the OpenMS framework'),
                 'software',
                 [u'analysis software', u'TOPP software', u'software', u'data processing software']),
    SoftwareName(u'ProSight', u'MS:1003141',
                 (u'ProSight: Database search engine for top-down proteomics.'),
                 'software',
                 [u'analysis software', u'software']),
    SoftwareName(u'TDPortal', u'MS:1003142',
                 (u'TDPortal: Database search engine for top-down proteomics.'),
                 'software',
                 [u'analysis software', u'software']),
    SoftwareName(u'pyteomics', u'MS:1003146',
                 (u'Python module that helps handling various proteomics data'
                  u'analysis tasks." [DOI:10.1021/acs.jproteome.8b00717'),
                 'software',
                 [u'analysis software', u'software']),
    ...
    SoftwareName(u'MS-DIAL', u'MS:1003082',
                 (u'Data processing software for untargeted metabolomics and'
                  ...
                  u'vendors.'),
                 'software',
                 [u'small molecule analysis software', u'data processing software', u'analysis software', u'software']),
    SoftwareName(u'ThermoRawFileParser', u'MS:1003145',
                 (u'Cross-platform software to convert Thermo RAW files to a'
                  u'number of open formats." [DOI:10.1021/acs.jproteome.9b00328'),
                 'software',
                 [u'data processing software', u'software']),
