...
class UploadFileMessage(BaseMessage):
    def __init__(
        ...
        # type: (str, str, Dict[str, Optional[Any]], Optional[Any], bool, bool) -> None
        self.local_timestamp = local_timestamp()
...
class UploadInMemoryMessage(BaseMessage):
    def __init__(
        self, file_like, upload_type, additional_params, metadata, critical=False
    ):
        # type: (MemoryUploadable, str, Dict[str, Optional[Any]], Optional[Any], bool) -> None
        self.local_timestamp = local_timestamp()
