...
class RestApiClient(BaseApiClient):
    ...
    def get_experiment_asset(
        ...
        # type: (str, Optional[str], Optional[str], str) -> Any
...
def send_file(
    post_endpoint, file_path, params, headers, timeout, metadata=None,
):
    # type: (str, str, Dict[str, str], Dict[str, str], int, Optional[Dict[Any, Any]]) -> Response
...
def send_file_like(
    post_endpoint, file_like, params, headers, timeout, metadata=None,
):
    # type: (str, Any, Dict[str, str], Dict[str, str], int, Optional[Dict[Any, Any]]) -> Response
...
def send_remote_asset(
    post_endpoint, remote_uri, params, headers, timeout, metadata=None,
):
    # type: (str, str, Dict[str, str], Dict[str, str], int, Optional[Dict[Any, Any]]) -> Response
...
class FileUploadManager(object):
    def __init__(self, worker_cpu_ratio):
        ...
        self._pool_size = min(32, cpu_count * worker_cpu_ratio)
        ...
        self._pool = multiprocessing.pool.ThreadPool(processes=self._pool_size)
