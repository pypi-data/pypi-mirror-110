...
setup(
  ...
  version = '0.1.3.4',      # Start with a small number and increase it with every change you make
  ...
  url = 'https://github.com/Jacobamv/Basilic',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/Jacobamv/Basilic/archive/refs/tags/v_01.1.tar.gz',    # I explain this later on
  keywords = ['Web', 'Framework', 'Python', "Flask", "Asynchronius", "Basilic", "Fast", "japronto"],   # Keywords that define your package best
  install_requires=[   
          "japronto==0.1.2",         # I get to this in a second
          'jinja2',
      ],
  classifiers=[
