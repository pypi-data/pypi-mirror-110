...
from experiment.common_requests import get_experiment_metrics, get_quick_view, get_job_history, get_experiment_runs, get_experiment_run_detail, get_experiment_tree_rundetail
from experiment.common_requests import get_last_test_archive_status, get_job_log
...
JWT_SECRET = "autosubmit"
JWT_ALGORITHM = "HS256"
JWT_EXP_DELTA_SECONDS = 36000  # 10 hours
# try:
#     import tkinter
# except:
...
def get_exp_performance(expid):
    ...
    result = get_experiment_metrics(expid)
...
# @app.route('/group/<string:expid>/<string:groupby>')
# def get_experiment_grouped(expid, groupby):
#     app.logger.info("Received Group Request " + expid + " group by " + groupby)
#     result = get_experiment_graph_grouped(expid, groupby)
#     return result
# api.add_resource(Monitor, '/monitor') # Route Monitor
