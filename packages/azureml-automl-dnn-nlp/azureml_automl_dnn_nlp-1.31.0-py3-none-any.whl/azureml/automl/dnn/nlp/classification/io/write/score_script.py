...
def main():
    ...
    if unknown:
        _logger.info("Got unknown args, will ignore them.")
    ...
    predicted_df = inferencer.score(input_dataset_id=args.input_dataset_id)

    if args.enable_datapoint_id_output:
        output_cols = [DatasetLiterals.DATAPOINT_ID, DatasetLiterals.LABEL_COLUMN, DatasetLiterals.LABEL_CONFIDENCE]
