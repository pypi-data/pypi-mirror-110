...
from dkist_header_validator.translator import translate_spec122_to_spec214
...
def test_spec122_to_214_l0_valid(valid_spec_122_header):
    """
    Translates a SPEC-0122 object to a SPEC-214 l0 object
    ...
    """
    translate_spec122_to_spec214_l0(valid_spec_122_header)


def test_spec122_to_214_valid(valid_spec_122_header):
    """
    ...
    Then: For a fits file input, return a HDUList and do not raise an exception
          For a dict, HDUList, or header input, return a dictionary and do not raise an exception
    """
    translate_spec122_to_spec214(valid_spec_122_header)
...
def test_spec122_to_214_l0_missing_required_keys(missing_required_keys_spec_122_header):
    """
    ...
    with pytest.raises(KeyError):
        translate_spec122_to_spec214_l0(missing_required_keys_spec_122_header)


def test_spec122_to_214_missing_required_keys(missing_required_keys_spec_122_header):
    """
    Translates an invalid SPEC-0122 object missing required
    ...
    """
    with pytest.raises(KeyError):
        translate_spec122_to_spec214(missing_required_keys_spec_122_header)
...
def test_translate_to_214_l0_maxheaders(max_headers):
    """
    Translates a SPEC-0122 object with a large number of keywords
    to a SPEC-214 l0 object and validates output against the SPEC-214 l0 schema
    ...
    translate_spec122_to_spec214_l0(max_headers)


def test_translate_to_214_maxheaders(max_headers):
    """
    Translates a SPEC-0122 object with a large number of keywords
    ...
    Then: For a fits file input, return a HDUList and do not raise an exception
          For a dict, HDUList, or header input, return a dictionary and do not raise an exception
    """
    translate_spec122_to_spec214(max_headers)
...
def test_compressed_spec122_to_214_l0_valid(valid_compressed_spec_122_header):
    """
    Translates a compressed SPEC-0122 object to a SPEC-214 l0 object
    Given: A valid compressed SPEC-0122 file
    When: Translating headers
    Then: Return a HDUList and do not raise an exception
    """
    translate_spec122_to_spec214_l0(valid_compressed_spec_122_header)


def test_compressed_spec122_to_214_valid(valid_compressed_spec_122_header):
    """
    ...
    Then: Return a HDUList and do not raise an exception
    """
    translate_spec122_to_spec214(valid_compressed_spec_122_header)
...
def test_compressed_spec122_to_214_l0_missing_required_keys(
    compressed_spec_122_header_missing_required_keys,
):
    """
    Translates a compressed SPEC-0122 object which is
    missing required keys to a SPEC-214 l0 object
    Given: A valid compressed SPEC-0122 file
    When: Translating headers
    Then: Raises a KeyError exception
    """
    with pytest.raises(KeyError):
        translate_spec122_to_spec214_l0(compressed_spec_122_header_missing_required_keys)


def test_compressed_spec122_to_214_missing_required_keys(
    compressed_spec_122_header_missing_required_keys,
):
    """
    Translates a compressed SPEC-0122 object which is
    ...
    """
    with pytest.raises(KeyError):
        translate_spec122_to_spec214(compressed_spec_122_header_missing_required_keys)
