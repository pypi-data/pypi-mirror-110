...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0', 'celery~=4.4.2', 'flower>=0.7.3, <1.0', 'vine~=1.3'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-celery/2.0.0/',
