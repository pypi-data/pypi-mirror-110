...
setup_kwargs = {
    'name': 'rsbcli',
    'version': '0.2.6',
    'description': 'A RAM saving cli to run web applications. Update 0.2.5: Added presets. Now you can type the name of certain websites to open them in RSB. Downloads and fullscreen too ',
