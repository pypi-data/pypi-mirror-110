...
def init_graph_from_crystal(crystal_type,periods):
    ...
    choose_constructor_option={ 'default': networkx_simple, 'simple': networkx_simple, 'chain': networkx_chain,'bcc': networkx_bcc,'fcc': networkx_fcc,'diamond': networkx_diamond,'laves':networkx_laves,'trigonal_stack': networkx_trigonal_stack,'square': networkx_square,'hexagonal':networkx_hexagonal, 'trigonal_planar':networkx_trigonal_planar}
