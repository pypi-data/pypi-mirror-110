...
def ezpp_set_relax(ez, relax):
    ...
    """
    return _oppai.ezpp_set_relax(ez, relax)

def ezpp_set_relax_version(ez, relax_version):
    r"""
    ...
    """
    return _oppai.ezpp_set_relax_version(ez, relax_version)

def ezpp_set_autopilot(ez, relax):
    r"""
    ...
    """
    return _oppai.ezpp_set_autopilot(ez, relax)
