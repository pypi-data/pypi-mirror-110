...
class CigamGestorController:
	...
	@classmethod
	def get_products(cls, url: str, token: str, store: str, reference: str = None):
		headers = cls.__make_headers(token)
	...
	@classmethod
	def get_stocks(cls, url: str, token: str, store: str, reference: str = None):
		headers = cls.__make_headers(token)
	...
	@classmethod
	def get_prices(cls, url: str, token: str, store: str, reference: str = None):
		headers = cls.__make_headers(token)
