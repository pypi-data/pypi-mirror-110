...
class ConstructWithProperties(
    ...
    jsii_type="@seeebiii/projen-test.ConstructWithProperties",
):
    ...
    def __init__(
        ...
        :param props2: -
        '''
        jsii.create(ConstructWithProperties, self, [parent, name, props, props2])


@jsii.interface(jsii_type="@seeebiii/projen-test.IBehaviorProperties")
class IBehaviorProperties(typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_IBehaviorPropertiesProxy"]:
        return _IBehaviorPropertiesProxy

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="otherProp")
    def other_prop(self) -> builtins.str:
        ...


class _IBehaviorPropertiesProxy:
    '''This is a *behavioral interface* identified by ``I`` in its name.
    ...
    __jsii_type__: typing.ClassVar[str] = "@seeebiii/projen-test.IBehaviorProperties"

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="otherProp")
    def other_prop(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "otherProp"))


class LambdaConstruct(
    aws_cdk.core.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="@seeebiii/projen-test.LambdaConstruct",
):
    '''A CDK construct to create Lambda functions.'''

    def __init__(self, parent: aws_cdk.core.Construct, name: builtins.str) -> None:
        '''
        :param parent: -
        :param name: -
        '''
        jsii.create(LambdaConstruct, self, [parent, name])


@jsii.data_type(
    jsii_type="@seeebiii/projen-test.StructProperties",
    jsii_struct_bases=[],
    name_mapping={"my_prop": "myProp"},
)
class StructProperties:
    def __init__(self, *, my_prop: builtins.str) -> None:
    ...
    def my_prop(self) -> builtins.str:
        result = self._values.get("my_prop")
        assert result is not None, "Required property 'my_prop' is missing"
    ...
    def __repr__(self) -> str:
        return "StructProperties(%s)" % ", ".join(
