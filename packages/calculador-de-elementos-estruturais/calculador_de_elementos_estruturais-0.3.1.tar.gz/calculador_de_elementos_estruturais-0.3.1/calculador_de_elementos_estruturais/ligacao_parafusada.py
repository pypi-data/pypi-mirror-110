...
{n}Resistência (Φ * Nn){_n}: {round(self.resistencia_tracao_cantoneira_secao_liquida, 6)} N
    ...
    {n}Resistencia à tração na cantoneira (Φ * Nn){_n}: {round(self.resistencia_tracao_cantoneira, 6)} N
...
{n}Resistẽncia (Φ * Nn){_n}: {round(self.resistencia_tracao_gusset_secao_liquida, 6)} N
