...
{n}Área Bruta da cantoneira (Ag){_n}: {round(self.area_bruta_cantoneira, 6)}

        {n}1.2) Cálculo da Área líquida na seção normal
        
{n}Largura bruta da cantoneira(bg){_n}: {round(self.largura_bruta_cantoneira, 6)}
{n}Largura líquida da cantoneira (bn){_n}: {round(self.largura_liquida_cantoneira, 6)}
{n}Área líquida da cantoneira (An){_n}: {round(self.area_liquida_cantoneira, 6)}

        {n}1.3) Resistência da cantoneira à tração na seção bruta
        
{n}Resistência (Φ * Nn){_n}: {round(self.resistencia_tracao_cantoneira_secao_bruta, 6)}

        {n}1.4) Resistência da cantoneira à tração na seção com furos
        
{n}Resistência (Φ * Nn){_n}: {round(self.resistencia_tracao_cantoneira_secao_liquida, 6)}

    {n}Resistencia à tração na cantoneira (Φ * Nn){_n}: {round(self.resistencia_tracao_cantoneira, 6)}
...
{n}Área Bruta do Gusset (Ag){_n}: {round(self.area_bruta_gusset, 6)}

        {n}2.2) Cálculo da área líquina na seção normal
        
{n}Largura Líquida Gusset (bn){_n}: {round(self.largura_liquida_gusset, 6)}
{n}Área Líquida Gusset {_n}{_n}: {round(self.area_liquida_gusset, 6)}
...
{n}Resistẽncia (Φ * Nn){_n}: {round(self.resistencia_tracao_gusset_secao_liquida, 6)}

    {n}Resistência à tração no Gusset (Φ * Nn){_n}: {round(self.resistencia_tracao_gusset, 6)}
...
{n}Pressão de Esmagamento da chapa (Φ * Nn){_n}: {round(self.pressao_esmagamento_chapa, 6)}

            {n}Cisalhamento nos parafusos

    {n}4) Resistência ao cisalhamento nos parafusos
        
{n}Resistência (Φ * Nn){_n}: {round(self.resistencia_cisalhamento_parafusos, 6)}

        {n}5) Cálculo do Máximo Esforço Nominal
        
{n}Resistência de ligação (Nd){_n}: {round(self.resistencia_ligacao, 6)}

{n}Máximo Esforço Nominal (N){_n}: {round(self.maximo_esforco_nominal, 6)}
