...
class ActivityEventUpdateRequest(Model):
    ...
    def __init__(self, *, clear_existing_binds: bool=None, title: str=None, description: str=None, note: str=None, start_date_time=None, end_date_time=None, document=None, subcategories=None, binds=None, fields=None, **kwargs) -> None:
