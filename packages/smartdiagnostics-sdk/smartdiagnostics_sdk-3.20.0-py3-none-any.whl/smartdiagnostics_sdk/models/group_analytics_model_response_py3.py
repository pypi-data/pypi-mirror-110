...
class GroupAnalyticsModelResponse(Model):
    ...
    def __init__(self, *, group, id: str, name: str, version: str, type, created, is_global: bool, is_deprecated: bool, group_type=None, last_upload=None, indicators=None, properties=None, related_models=None, created_by=None, corporation=None, location=None, triggers=None, tags=None, **kwargs) -> None:
