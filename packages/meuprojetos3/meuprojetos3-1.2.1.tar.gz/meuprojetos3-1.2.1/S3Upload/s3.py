...
def converter_imagem_salva_e_informar_diretorio() -> str:
    imagem_para_converter = Image.open('imagem.jpg').convert("RGB")
    imagem_para_converter.save("convertida.jpg", "jpeg")
...
def subir_imagem_s3(url: str):
    ...
    try:
        respe = s3.upload_file(os.path.join(caminho_da_imagem_convertida, "convertida.jpg"), bucket_name,
                               'anthony.jpg')
