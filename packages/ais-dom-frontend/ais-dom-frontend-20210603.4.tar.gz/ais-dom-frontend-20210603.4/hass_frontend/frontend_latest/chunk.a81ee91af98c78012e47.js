          ...
          <ha-card header="Baza danych do zapisu zdarzeń">
            ...
            ${this.dbConnectionValidating?n.dy`<div style="width: 100%; text-align: center;">
                  ...
                  <div class="card-content">
                    ...
                    <ha-expansion-panel 
                      .header=${n.dy`<ha-icon icon="mdi:filter-plus"></ha-icon> &nbsp;Lista wybranych do zapisywania:`}>
                      <ha-code-editor 
                        mode="yaml" 
                  ...
                  <div class="card-content">
                    <ha-expansion-panel 
                      .header=${n.dy`<ha-icon icon="mdi:filter-remove"></ha-icon> &nbsp;Lista wykluczonych z zapisywania:`}>
                      <ha-code-editor 
                        mode="yaml" 
