...
class ListMemberAccountsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/macie.html#Macie.Paginator.ListMemberAccounts.paginate)
...
class ListS3ResourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.97/reference/services/macie.html#Macie.Paginator.ListS3Resources.paginate)
