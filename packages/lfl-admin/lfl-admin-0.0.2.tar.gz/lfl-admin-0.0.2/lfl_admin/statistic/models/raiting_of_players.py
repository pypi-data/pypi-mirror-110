...
class Raiting_of_playersManager(AuditManager):
            ...
            with transaction.atomic():
                with managed_progress(
                    ...
                    for players_id in players_ids:
                        ...
                        for row in rows:
                            FIO, formation_id, KF, kf_bombar, kf_not_wins, kf_opyt, kf_plus_minus, kf_propusch_com, kf_zabito_com, mid_propusch_com, mid_zabito_com, plays, pers_not_wins, pers_wins, plus_minus, propusch_com, raiting, standoff_cnt, kf_wins, zabito_com, zabito_play, amplua_id, club_id, player_id, win_cnt, not_win_cnt = row
    ...
    def getRecord(record):
        res = {
            ...
            'formation___number_of_players': record.formation.number_of_players,
            'id': record.id,
            'KF': record.KF,
