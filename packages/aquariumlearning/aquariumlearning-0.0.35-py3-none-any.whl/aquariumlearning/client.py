...
class Client:
    ...
    def create_dataset(
        ...
        if pipeline_mode == "STREAMING":
            return self._create_dataset_streaming(
                project_id,
                dataset_id,
                data_url=data_url,
    ...
    def _create_dataset_streaming(
        ...
        """Create a streaming dataset with the provided data urls. The dataset will be processed by the streaming pipeline and will support updates.
