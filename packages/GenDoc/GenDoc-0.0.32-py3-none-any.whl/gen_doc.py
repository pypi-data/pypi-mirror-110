...
def main() -> None:
    ...
    parser.add_argument("--n", 
        type=str, 
        help="Project Name (included in Docs)")
    parser.add_argument("--v", 
        type=str, 
        help="Version Number (included in Docs) (Project Name required to use)")
    parser.add_argument("--f", 
        type=os.path.abspath, 
        nargs="+", 
        help="PATH to files you want to include in the generation")
    parser.add_argument("--d", 
        type=os.path.abspath, 
        help="PATH to the parent directory of the codebase (used only without --f)")
    parser.add_argument("--o", 
        type=os.path.abspath, 
        help="PATH to the output Markdown file")
    parser.add_argument("--e", 
        type=str, 
        help="Message for function without a DocString (enter 0 to exclude functions without a DocString entirely)")
