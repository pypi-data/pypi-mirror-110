...
class League:
    ...
    def predictTeamDay(self):
        ...
        for i in range(0, len(today)):
            ...
            print("HP: " + str(homePIDList[i][0]) + " IP: " + str(finalHPList[i][0][1][2]) + " BF: " + str(
                finalHPList[i][0][1][3]) + " BB%: " + str(
                finalHPList[i][0][1][4]) + " K%: " + str(finalHPList[i][0][1][5]) + " FIP: " + str(
                finalHPList[i][0][1][6]) + " ERA: " + str(finalHPList[i][0][1][7]) + " WHIP: " + str(
                finalHPList[i][0][1][8]) + " K: " + str(finalHPList[i][0][1][10]) + " HR: " + str(
                finalHPList[i][0][1][11]))
            print(str(homePIDList[i][0]) + " Note: " + str(hNList[i]))
            print("AP: " + str(awayPIDList[i][0]) + " IP: " + str(finalAPList[i][0][1][2]) + " BF: " + str(
                finalAPList[i][0][1][3]) + " BB%: " + str(
                finalAPList[i][0][1][4]) + " K%: " + str(finalAPList[i][0][1][5]) + " FIP: " + str(
                finalAPList[i][0][1][6]) + " ERA: " + str(finalAPList[i][0][1][7]) + " WHIP: " + str(
                finalAPList[i][0][1][8]) + " K: " + str(finalAPList[i][0][1][10]) + " HR: " + str(
                finalAPList[i][0][1][11]))
        ...
        for i in range(0, len(allPID)):
            ...
            for j in range(0, len(pitcherStats)):
                ...
                if float(int(playerBF)) > 0:
                    ...
                    # Calculate the FIP score if possible
                    try:
                        FIP = (13 * float(playerHR) + 3 * (
                                    float(playerBB) + float(playerHBP)) - 2 * strikeouts) / float(
                            playerIP)
                        # Constant is the league average FPI score for 2021
                        FIP_constant = 3.133
                        FIP += FIP_constant
