...
class MProvConnection:
    ...
    @property
    def graph_conn(self):
        if self._graph_conn.closed:
            print('connection is closed, creating new connection')
            self._graph_conn = self._create_connection()
