...
class Cliente(models.Model):
    ...
    data_anonimizacao = models.DateTimeField(db_column="cliente_data_anonimizacao", null=True)
    ...
    metadata = JSONField(db_column='cliente_metadata', default=dict, null=False, blank=True)
