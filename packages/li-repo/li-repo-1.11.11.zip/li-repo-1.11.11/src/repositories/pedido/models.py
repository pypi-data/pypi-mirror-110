...
class PedidoVenda(models.Model):
    ...
    # JSON para manter dados imutáveis dentro do pedido se o cliente for anonimizado
    imutavel = JSONField(db_column='pedido_venda_imutavel', default=dict, null=False, blank=True)
