...
from .literals import CloudHsmObjectStateType, HsmStatusType
...
_RequiredListHapgsResponseTypeDef = TypedDict(
    "_RequiredListHapgsResponseTypeDef",
    {
        "HapgList": List[str],
    },
)
_OptionalListHapgsResponseTypeDef = TypedDict(
    "_OptionalListHapgsResponseTypeDef",
    {
        "NextToken": str,
    },
    total=False,
...
_RequiredListLunaClientsResponseTypeDef = TypedDict(
    "_RequiredListLunaClientsResponseTypeDef",
    {
        "ClientList": List[str],
    },
)
_OptionalListLunaClientsResponseTypeDef = TypedDict(
    "_OptionalListLunaClientsResponseTypeDef",
    {
        "NextToken": str,
    },
    total=False,
