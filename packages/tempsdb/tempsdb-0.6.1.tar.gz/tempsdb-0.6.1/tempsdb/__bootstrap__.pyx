...
def bootstrap_cython_submodules():
    modules_set = {'tempsdb.iterators', 'tempsdb.series', 'tempsdb.chunks.base', 'tempsdb.database', 'tempsdb.metadata', 'tempsdb.chunks.direct', 'tempsdb.varlen', 'tempsdb.chunks.gzip', 'tempsdb.chunks.maker', 'tempsdb.chunks.normal', 'tempsdb.exceptions'}
