...
# TODO: Try to build a distributable package of the project
# TODO: Download Windows Terminal and record the gifs for the README with it
# TODO: Add tests (tox or other) to project
# TODO: Add VSCode configurations to new repo in github for 'configs'
