...
class AuditReportCreatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/acm-pca.html#ACMPCA.Waiter.AuditReportCreatedWaiter)
...
class CertificateAuthorityCSRCreatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/acm-pca.html#ACMPCA.Waiter.CertificateAuthorityCSRCreatedWaiter)
...
class CertificateIssuedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        *,
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.99/reference/services/acm-pca.html#ACMPCA.Waiter.CertificateIssuedWaiter)
