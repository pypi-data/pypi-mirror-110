...
def search_rai_assets(run: Run,
    ...
    all_rai_tool_assets = assets_client.list_assets_with_query(
        run_id=run.id,
    ...
    if upload_id is None:
        ...
        all_rai_tools_assets = assets_client.list_assets_with_query(
            run_id=run.id,
            asset_type=asset_type)
...
def list_rai_tool(run: Run,
    ...
    all_rai_assets = assets_client.list_assets_with_query(
        run_id=run.id,
