...
# Certs
SERVER_SECURE_KEY = "/usr/local/laipvt/certs/server_secure.key"
SERVER_KEY = "/usr/local/laipvt/certs/server.key"
SERVER_CSR = "/usr/local/laipvt/certs/server.csr"
CA_CRT = "/usr/local/laipvt/certs/ca.crt"
SERVER_CRT = "/usr/local/laipvt/certs/server.crt"
