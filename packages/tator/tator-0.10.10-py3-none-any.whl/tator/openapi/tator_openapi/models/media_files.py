...
class MediaFiles(object):
    ...
    def __init__(self, archival=None, attachment=None, audio=None, ids=None, image=None, layout=None, quality=None, streaming=None, thumbnail=None, thumbnail_gif=None, local_vars_configuration=None):  # noqa: E501
