...
class MediaType(object):
    ...
    def __init__(self, archive_config=None, attribute_types=None, default_box=None, default_dot=None, default_line=None, default_volume=None, description='', dtype=None, file_format=None, id=None, name=None, overlay_config=None, project=None, streaming_config=None, visible=None, local_vars_configuration=None):  # noqa: E501
