...
class MediaTypeUpdate(object):
    ...
    def __init__(self, archive_config=None, default_box=None, default_dot=None, default_line=None, default_volume=None, description=None, file_format=None, name=None, streaming_config=None, visible=None, local_vars_configuration=None):  # noqa: E501
