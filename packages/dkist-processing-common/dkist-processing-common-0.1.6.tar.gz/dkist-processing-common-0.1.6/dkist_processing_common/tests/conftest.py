...
def complete_common_header():
    ...
    hdu.header["LVL2STAT"] = "polarizer"
    hdu.header["POLANGLE"] = 31.2
    hdu.header["LVL1STAT"] = "retarder"
    hdu.header["RETANGLE"] = 6.66
    hdu.header["LVL0STAT"] = "dark shutter"
    hdu.header["INSTRUME"] = "VBI"
    hdu.header["LINEWAV"] = 1080.0
    hdu.header["DATE-BEG"] = "2020-03-13T00:00:00.000"
    hdu.header["DATE-END"] = "2021-08-15T00:00:00.000"
    hdu.header["PROP_ID"] = "PROPOSAL_ID1"
    hdu.header["LVL3STAT"] = "Clear"
    hdu.header["LAMPSTAT"] = "On"
...
class NonPolCalDataset(Spec122Dataset):
    def __init__(self):
        ...
        self.add_constant_key("LVL3STAT", "On")
        self.add_constant_key("LAMPSTAT", "Clear")
        self.add_constant_key("LVL2STAT", "polarizer")
        self.add_constant_key("POLANGLE", 31.2)
        self.add_constant_key("LVL1STAT", "retarder")
        self.add_constant_key("RETANGLE", 6.66)
        self.add_constant_key("LVL0STAT", "dark shutter")
...
def non_polcal_headers() -> List[L0FitsAccess]:
    ds = NonPolCalDataset()
    ds.add_constant_key("VELOSYS", 1.23)
    header_list = [
        spec122_validator.validate_and_translate_to_214_l0(d.header(), return_type=fits.HDUList)[
            0
        ].header
