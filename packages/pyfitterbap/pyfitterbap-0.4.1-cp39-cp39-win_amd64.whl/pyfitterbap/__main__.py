...
_EPILOG = f"""\
Set the PYFBP_LOG_LEVEL environment variable to change the logging level.
...
def get_parser():
    parser = argparse.ArgumentParser(
        description='pyfbp command line tools.',
        epilog=_EPILOG,
    )
...
def run():
    log_level = os.environ.get('PYFBP_LOG_LEVEL', 'WARNING').upper()
