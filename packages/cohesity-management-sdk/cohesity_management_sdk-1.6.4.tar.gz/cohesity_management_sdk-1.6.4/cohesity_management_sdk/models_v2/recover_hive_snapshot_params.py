...
import cohesity_management_sdk.models_v2.recover_hive_object_params

class RecoverHiveSnapshotParams(object):

    """Implementation of the 'Recover Hive Snapshot Params.' model.
    ...
    Attributes:
        ...
        objects (list of RecoverHiveObjectParams): Specifies details of
    ...
    def __init__(self,
                 ...
                 messages=None,
                 objects=None):
        """Constructor for the RecoverHiveSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') != None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.recover_hive_object_params.RecoverHiveObjectParams.from_dictionary(structure))
