...
import cohesity_management_sdk.models_v2.new_source_config_1

class AWSRDSRecoveryTargetConfig(object):

    """Implementation of the 'AWS RDS Recovery Target Config.' model.
    ...
    Attributes:
        recover_to_new_source (bool): Specifies the parameter whether the
            ...
            Target.
        new_source_config (NewSourceConfig1): Specifies the new destination
            Source configuration parameters where the RDS instances will be
    ...
    def __init__(self,
        ...
        """Constructor for the AWSRDSRecoveryTargetConfig class"""
    ...
    def from_dictionary(cls,
        ...
        new_source_config = cohesity_management_sdk.models_v2.new_source_config_1.NewSourceConfig1.from_dictionary(dictionary.get('newSourceConfig')) if dictionary.get('newSourceConfig') else None
