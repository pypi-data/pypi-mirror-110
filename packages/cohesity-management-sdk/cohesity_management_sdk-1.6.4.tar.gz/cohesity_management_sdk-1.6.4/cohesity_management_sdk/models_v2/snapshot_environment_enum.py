...
class SnapshotEnvironmentEnum(object):

    """Implementation of the 'SnapshotEnvironment' enum.

    Specifies the type of environment of snapshots for which the Recovery has
    to be performed.
