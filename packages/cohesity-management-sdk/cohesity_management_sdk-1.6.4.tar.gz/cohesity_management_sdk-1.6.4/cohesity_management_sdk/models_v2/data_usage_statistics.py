...
class DataUsageStatistics(object):

    """Implementation of the 'Data Usage Statistics.' model.
    ...
    Attributes:
        ...
        outdated_logical_usage_bytes (long|int): Specifies the logical usage
            as computed by the Cohesity Cluster. This field is computed on a
            same frequency as 'StorageConsumedBytes', and it may not be the
            latest value. It is used to compute reduction ratio. hidden: true
    ...
    _names = {
        ...
        "outdated_logical_usage_bytes":'outdatedLogicalUsageBytes',
    ...
    def __init__(self,
                 ...
                 outdated_logical_usage_bytes=None,
        ...
        """Constructor for the DataUsageStatistics class"""
        ...
        self.outdated_logical_usage_bytes = outdated_logical_usage_bytes
    ...
    def from_dictionary(cls,
        ...
        outdated_logical_usage_bytes = dictionary.get('outdatedLogicalUsageBytes')
