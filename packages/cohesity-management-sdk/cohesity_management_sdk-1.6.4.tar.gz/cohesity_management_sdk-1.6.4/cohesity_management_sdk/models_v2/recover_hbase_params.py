...
import cohesity_management_sdk.models_v2.recover_hbase_snapshot_params

class RecoverHbaseParams(object):

    """Implementation of the 'Recover Hbase params.' model.
    ...
    Attributes:
        ...
        snapshots (list of RecoverHbaseSnapshotParams): Specifies the local
    ...
    def __init__(self,
                 ...
                 warnings=None,
                 suffix=None):
        """Constructor for the RecoverHbaseParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('snapshots') != None:
            ...
            for structure in dictionary.get('snapshots'):
                snapshots.append(cohesity_management_sdk.models_v2.recover_hbase_snapshot_params.RecoverHbaseSnapshotParams.from_dictionary(structure))
