...
import cohesity_management_sdk.models_v2.recover_cassandra_object_params

class RecoverCassandraSnapshotParams(object):

    """Implementation of the 'Recover Cassandra Snapshot Params.' model.
    ...
    Attributes:
        ...
        objects (list of RecoverCassandraObjectParams): Specifies details of
    ...
    def __init__(self,
                 ...
                 messages=None,
                 objects=None):
        """Constructor for the RecoverCassandraSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') != None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.recover_cassandra_object_params.RecoverCassandraObjectParams.from_dictionary(structure))
