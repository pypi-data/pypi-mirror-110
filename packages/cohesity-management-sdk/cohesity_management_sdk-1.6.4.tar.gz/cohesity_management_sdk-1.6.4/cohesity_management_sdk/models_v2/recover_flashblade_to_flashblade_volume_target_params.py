...
class RecoverFlashbladeToFlashbladeVolumeTargetParams(object):

    """Implementation of the 'Recover Flashblade To Flashblade Volume Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverFlashbladeToFlashbladeVolumeTargetParams class"""
