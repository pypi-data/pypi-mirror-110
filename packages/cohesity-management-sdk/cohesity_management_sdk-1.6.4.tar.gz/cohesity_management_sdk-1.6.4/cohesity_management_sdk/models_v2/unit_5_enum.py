...
class Unit5Enum(object):

    """Implementation of the 'Unit5' enum.

    Specifies how often to start new Protection Group Runs of a Protection
    Group. <br>'Minutes' specifies that Protection Group run starts
