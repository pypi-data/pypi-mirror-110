...
import cohesity_management_sdk.models_v2.elastifile_target_params_8
...
class RecoverElastifileNASVolumeParams(object):

    """Implementation of the 'Recover Elastifile NAS Volume Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverElastifileNASVolumeParams class"""
    ...
    def from_dictionary(cls,
        ...
        elastifile_target_params = cohesity_management_sdk.models_v2.elastifile_target_params_8.ElastifileTargetParams8.from_dictionary(dictionary.get('elastifileTargetParams')) if dictionary.get('elastifileTargetParams') else None
