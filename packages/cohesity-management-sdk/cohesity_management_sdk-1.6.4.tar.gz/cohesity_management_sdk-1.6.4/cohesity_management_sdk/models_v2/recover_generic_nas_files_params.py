...
import cohesity_management_sdk.models_v2.generic_nas_target_params_3
...
class RecoverGenericNasFilesParams(object):

    """Implementation of the 'Recover Generic Nas files Params.' model.
    ...
    Attributes:
        ...
        target_environment (TargetEnvironment1Enum): Specifies the environment
            ...
            filled out.
        generic_nas_target_params (GenericNasTargetParams3): Specifies the
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverGenericNasFilesParams class"""
    ...
    def from_dictionary(cls,
        ...
        generic_nas_target_params = cohesity_management_sdk.models_v2.generic_nas_target_params_3.GenericNasTargetParams3.from_dictionary(dictionary.get('genericNasTargetParams')) if dictionary.get('genericNasTargetParams') else None
