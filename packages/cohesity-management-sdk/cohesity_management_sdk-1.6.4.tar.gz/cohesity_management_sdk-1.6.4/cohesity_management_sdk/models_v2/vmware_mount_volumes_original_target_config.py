...
class VmwareMountVolumesOriginalTargetConfig(object):

    """Implementation of the 'VMware Mount Volumes Original Target Config.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VmwareMountVolumesOriginalTargetConfig class"""
