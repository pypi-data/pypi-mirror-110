...
class SpecifiesTheSummaryOfTheStateUpdationForTheMultipleDataMigrationSourceAnalysisGroups(object):
    ...
    Attributes:
        ...
        successful_ids (list of long|int): Specifies a list of Data Migration
            source analysis groups ids for which updation of state was
            successful.
    ...
    def __init__(self,
                 failed_ids=None,
                 successful_ids=None):
        """Constructor for the SpecifiesTheSummaryOfTheStateUpdationForTheMultipleDataMigrationSourceAnalysisGroups class"""
