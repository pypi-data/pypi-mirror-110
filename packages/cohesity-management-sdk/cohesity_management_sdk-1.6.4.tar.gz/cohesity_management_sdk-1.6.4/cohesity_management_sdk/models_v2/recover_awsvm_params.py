...
import cohesity_management_sdk.models_v2.aws_target_params

class RecoverAWSVMParams(object):

    """Implementation of the 'Recover AWS VM params.' model.
    ...
    Attributes:
        ...
        aws_target_params (AwsTargetParams): Specifies the params for
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverAWSVMParams class"""
    ...
    def from_dictionary(cls,
        ...
        aws_target_params = cohesity_management_sdk.models_v2.aws_target_params.AwsTargetParams.from_dictionary(dictionary.get('awsTargetParams')) if dictionary.get('awsTargetParams') else None
