...
class RecoverToGenericNASVolumeTargetParams(object):

    """Implementation of the 'Recover To Generic NAS Volume Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToGenericNASVolumeTargetParams class"""
