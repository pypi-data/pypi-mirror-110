...
class AdCustomAttributesTypeParams(object):

    """Implementation of the 'AdCustomAttributesTypeParams' model.

    Specifies the properties accociated to a CustomAttributes type user id
    mapping.
    ...
    def __init__(self,
        ...
        """Constructor for the AdCustomAttributesTypeParams class"""
