...
import cohesity_management_sdk.models_v2.object_snapshots_information

class ProtectedObject(object):

    """Implementation of the 'Protected Object' model.

    Specifies the Protected Object with last Run's snapshot information per
    Protection Group.
    ...
    Attributes:
        ...
        latest_snapshots_info (list of ObjectSnapshotsInformation): Specifies
            the latest snapshot information for every Protection Group for a
            given object.
    ...
    _names = {
        ...
        "latest_snapshots_info":'latestSnapshotsInfo'
    }
    ...
    def __init__(self,
        ...
        self.latest_snapshots_info = latest_snapshots_info
    ...
    def from_dictionary(cls,
        ...
        protection_stats = None
        if dictionary.get('protectionStats') != None:
        ...
        latest_snapshots_info = None
        if dictionary.get('latestSnapshotsInfo') != None:
            latest_snapshots_info = list()
            for structure in dictionary.get('latestSnapshotsInfo'):
                latest_snapshots_info.append(cohesity_management_sdk.models_v2.object_snapshots_information.ObjectSnapshotsInformation.from_dictionary(structure))
