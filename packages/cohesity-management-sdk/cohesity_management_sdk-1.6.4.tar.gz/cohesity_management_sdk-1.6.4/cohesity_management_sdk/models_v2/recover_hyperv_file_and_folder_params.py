...
import cohesity_management_sdk.models_v2.hyperv_target_params_2

class RecoverHypervFileAndFolderParams(object):

    """Implementation of the 'Recover HyperV File And Folder Params' model.
    ...
    Attributes:
        ...
        hyperv_target_params (HypervTargetParams2): Specifies the parameters
            to recover to a HyperV target.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverHypervFileAndFolderParams class"""
    ...
    def from_dictionary(cls,
        ...
        hyperv_target_params = cohesity_management_sdk.models_v2.hyperv_target_params_2.HypervTargetParams2.from_dictionary(dictionary.get('hypervTargetParams')) if dictionary.get('hypervTargetParams') else None
