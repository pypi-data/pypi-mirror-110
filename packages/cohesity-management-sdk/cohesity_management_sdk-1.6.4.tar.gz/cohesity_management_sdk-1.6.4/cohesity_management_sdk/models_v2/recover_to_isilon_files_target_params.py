...
class RecoverToIsilonFilesTargetParams(object):

    """Implementation of the 'Recover To Isilon Files Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToIsilonFilesTargetParams class"""
