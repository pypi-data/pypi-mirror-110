...
import cohesity_management_sdk.models_v2.recover_nas_volume_params
import cohesity_management_sdk.models_v2.recover_file_and_folder_params_4
import cohesity_management_sdk.models_v2.download_file_and_folder_params

class RecoverNetappParams(object):

    """Implementation of the 'Recover Netapp Params.' model.
    ...
    Attributes:
        ...
        recover_nas_volume_params (RecoverNasVolumeParams): Specifies the
            parameters to recover Nas Volumes.
        recover_file_and_folder_params (RecoverFileAndFolderParams4):
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverNetappParams class"""
    ...
    def from_dictionary(cls,
        ...
        recover_nas_volume_params = cohesity_management_sdk.models_v2.recover_nas_volume_params.RecoverNasVolumeParams.from_dictionary(dictionary.get('recoverNasVolumeParams')) if dictionary.get('recoverNasVolumeParams') else None
        recover_file_and_folder_params = cohesity_management_sdk.models_v2.recover_file_and_folder_params_4.RecoverFileAndFolderParams4.from_dictionary(dictionary.get('recoverFileAndFolderParams')) if dictionary.get('recoverFileAndFolderParams') else None
