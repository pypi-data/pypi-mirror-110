...
class AWSRecoverFilesOriginalTargetConfig(object):

    """Implementation of the 'AWS Recover Files Original Target Config.' model.
    ...
    def __init__(self,
                 ...
                 alternate_path=None):
        """Constructor for the AWSRecoverFilesOriginalTargetConfig class"""
