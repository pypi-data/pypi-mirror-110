...
class HDFSIndexedObject(object):

    """Implementation of the 'HDFSIndexedObject' model.
    ...
    Attributes:
        ...
        mtype (Type15Enum): Specifies the HDFS Object Type.
    ...
    def __init__(self,
                 ...
                 mtype=None,
                 id=None):
        """Constructor for the HDFSIndexedObject class"""
