...
import cohesity_management_sdk.models_v2.elastifile_protection_group_object_params
...
class ElastifileProtectionGroupParams(object):

    """Implementation of the 'ElastifileProtectionGroupParams' model.

    Specifies the parameters which are specific to Elastifile related
    Protection Groups.
    ...
    def __init__(self,
        ...
        """Constructor for the ElastifileProtectionGroupParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') != None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.elastifile_protection_group_object_params.ElastifileProtectionGroupObjectParams.from_dictionary(structure))
