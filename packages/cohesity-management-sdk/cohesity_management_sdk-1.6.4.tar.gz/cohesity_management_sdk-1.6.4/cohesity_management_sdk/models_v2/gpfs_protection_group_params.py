...
import cohesity_management_sdk.models_v2.gpfs_protection_group_object_params
...
class GpfsProtectionGroupParams(object):

    """Implementation of the 'GpfsProtectionGroupParams' model.

    Specifies the parameters which are specific to GPFS related Protection
    Groups.

    Attributes:
        objects (list of GpfsProtectionGroupObjectParams): Specifies the
    ...
    def __init__(self,
        ...
        """Constructor for the GpfsProtectionGroupParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') != None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.gpfs_protection_group_object_params.GpfsProtectionGroupObjectParams.from_dictionary(structure))
