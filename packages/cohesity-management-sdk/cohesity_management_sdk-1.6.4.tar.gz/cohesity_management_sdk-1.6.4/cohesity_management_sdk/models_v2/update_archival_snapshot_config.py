...
class UpdateArchivalSnapshotConfig(object):

    """Implementation of the 'Update Archival Snapshot Config.' model.

    Specifies the configuration about updating an existing Archival Snapshot
    Run.

    Attributes:
        id (long|int): Specifies the id of the archival target.
    ...
    def __init__(self,
                 ...
                 data_lock=None,
                 days_to_keep=None):
        """Constructor for the UpdateArchivalSnapshotConfig class"""
