...
class RecoverIsilonToIsilonFilesTargetParams(object):

    """Implementation of the 'Recover Isilon To Isilon Files Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverIsilonToIsilonFilesTargetParams class"""
