...
class ArchivalTargetInfo(object):

    """Implementation of the 'ArchivalTargetInfo' model.

    Specifies the archival target information if the snapshot is an archival
    snapshot.
    ...
    def __init__(self,
                 ...
                 target_name=None,
                 target_type=None):
        """Constructor for the ArchivalTargetInfo class"""
