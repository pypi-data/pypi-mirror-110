...
class HbaseIndexedObject(object):

    """Implementation of the 'HbaseIndexedObject' model.
    ...
    Attributes:
        ...
        mtype (Type16Enum): Specifies the Hbase Object Type.
    ...
    def __init__(self,
                 ...
                 mtype=None,
                 id=None):
        """Constructor for the HbaseIndexedObject class"""
