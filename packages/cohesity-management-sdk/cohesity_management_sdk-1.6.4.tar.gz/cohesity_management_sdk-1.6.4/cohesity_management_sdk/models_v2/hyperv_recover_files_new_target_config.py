...
class HypervRecoverFilesNewTargetConfig(object):

    """Implementation of the 'HyperV Recover Files New Target Config.' model.

    Specifies the configuration for recovering files and folders to a new
    target.
    ...
    def __init__(self,
                 ...
                 absolute_path=None):
        """Constructor for the HypervRecoverFilesNewTargetConfig class"""
