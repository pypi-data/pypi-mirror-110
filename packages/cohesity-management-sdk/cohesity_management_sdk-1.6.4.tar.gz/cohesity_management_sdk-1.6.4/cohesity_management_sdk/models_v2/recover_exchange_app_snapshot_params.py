...
import cohesity_management_sdk.models_v2.exchange_database_recovery_params

class RecoverExchangeAppSnapshotParams(object):
    ...
    Attributes:
        ...
        app_objects (list of ExchangeDatabaseRecoveryParams): Specifies the
    ...
    def __init__(self,
                 ...
                 messages=None,
                 app_objects=None):
        """Constructor for the RecoverExchangeAppSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        app_objects = None
        if dictionary.get('appObjects') != None:
            app_objects = list()
            for structure in dictionary.get('appObjects'):
                app_objects.append(cohesity_management_sdk.models_v2.exchange_database_recovery_params.ExchangeDatabaseRecoveryParams.from_dictionary(structure))
