...
class RecoverFlashbladeFilesParams(object):

    """Implementation of the 'Recover Flashblade files Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverFlashbladeFilesParams class"""
