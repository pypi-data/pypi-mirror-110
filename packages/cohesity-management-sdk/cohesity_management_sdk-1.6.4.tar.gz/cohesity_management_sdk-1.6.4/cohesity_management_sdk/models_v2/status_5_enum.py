...
class Status5Enum(object):
    ...
    Status of the backup run. 'Running' indicates that the run is still
    running. 'Canceled' indicates that the run has been canceled. 'Canceling'
    indicates that the run is in the process of being canceled. 'Failed'
    ...
    still happening. 'Succeeded' indicates that the run has finished
