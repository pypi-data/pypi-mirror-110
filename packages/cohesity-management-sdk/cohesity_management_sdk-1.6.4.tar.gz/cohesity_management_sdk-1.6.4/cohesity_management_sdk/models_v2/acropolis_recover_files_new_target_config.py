...
class AcropolisRecoverFilesNewTargetConfig(object):

    """Implementation of the 'Acropolis Recover Files New Target Config.' model.

    Specifies the configuration for recovering files and folders to the new
    target.
    ...
    def __init__(self,
                 ...
                 absolute_path=None):
        """Constructor for the AcropolisRecoverFilesNewTargetConfig class"""
