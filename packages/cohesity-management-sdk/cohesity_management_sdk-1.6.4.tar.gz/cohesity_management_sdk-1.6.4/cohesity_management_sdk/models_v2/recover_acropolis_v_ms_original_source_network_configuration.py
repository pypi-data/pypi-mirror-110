...
class RecoverAcropolisVMsOriginalSourceNetworkConfiguration(object):

    """Implementation of the 'Recover Acropolis VMs Original Source Network configuration.' model.

    Specifies the network config parameters to be applied for Acropolis VMs if
    ...
    def __init__(self,
                 detach_network=None):
        """Constructor for the RecoverAcropolisVMsOriginalSourceNetworkConfiguration class"""
