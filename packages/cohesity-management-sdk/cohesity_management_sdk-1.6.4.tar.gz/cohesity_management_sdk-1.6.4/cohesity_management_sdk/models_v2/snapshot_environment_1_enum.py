...
class SnapshotEnvironment1Enum(object):

    """Implementation of the 'SnapshotEnvironment1' enum.

    Specifies the type of snapshot environment for which the Recovery was
    performed.
