...
class FullSchedule(object):
    ...
    """Implementation of the 'Full Schedule' model.

    Specifies settings that defines how frequent full backup will be performed
    for a Protection Group.

    Attributes:
        unit (Unit4Enum): Specifies how often to start new runs of a
            ...
            <br>'ProtectOnce' specifies that groups using this policy option
            will run only once and after that group will permanently be
            disabled. <br> Example: To run the Protection Group on Second
            Sunday of Every Month, following schedule need to be set: <br>
    ...
    def __init__(self,
                 ...
                 week_schedule=None,
                 month_schedule=None):
        """Constructor for the FullSchedule class"""
