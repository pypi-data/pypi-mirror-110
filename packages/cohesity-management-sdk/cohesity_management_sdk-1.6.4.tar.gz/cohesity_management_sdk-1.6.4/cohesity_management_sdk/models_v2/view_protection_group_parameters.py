...
import cohesity_management_sdk.models_v2.replication_parameters
...
class ViewProtectionGroupParameters(object):
    ...
    def from_dictionary(cls,
        ...
        replication_params = cohesity_management_sdk.models_v2.replication_parameters.ReplicationParameters.from_dictionary(dictionary.get('replicationParams')) if dictionary.get('replicationParams') else None
