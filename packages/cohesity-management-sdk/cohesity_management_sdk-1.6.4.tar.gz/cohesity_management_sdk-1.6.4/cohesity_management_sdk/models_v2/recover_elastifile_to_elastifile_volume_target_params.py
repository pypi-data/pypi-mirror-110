...
class RecoverElastifileToElastifileVolumeTargetParams(object):

    """Implementation of the 'Recover Elastifile To Elastifile Volume Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverElastifileToElastifileVolumeTargetParams class"""
