...
class AzureVMsRecoveryTargetConfig(object):

    """Implementation of the 'Azure VMs Recovery Target Config.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AzureVMsRecoveryTargetConfig class"""
