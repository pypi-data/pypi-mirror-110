...
import cohesity_management_sdk.models_v2.recover_nas_volume_params_4
import cohesity_management_sdk.models_v2.recover_file_and_folder_params_8
import cohesity_management_sdk.models_v2.download_file_and_folder_params

class RecoverElastifileParams(object):

    """Implementation of the 'Recover Elastifile Params.' model.
    ...
    Attributes:
        ...
        recover_nas_volume_params (RecoverNasVolumeParams4): Specifies the
            parameters to recover Nas Volumes.
        recover_file_and_folder_params (RecoverFileAndFolderParams8):
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverElastifileParams class"""
    ...
    def from_dictionary(cls,
        ...
        recover_nas_volume_params = cohesity_management_sdk.models_v2.recover_nas_volume_params_4.RecoverNasVolumeParams4.from_dictionary(dictionary.get('recoverNasVolumeParams')) if dictionary.get('recoverNasVolumeParams') else None
        recover_file_and_folder_params = cohesity_management_sdk.models_v2.recover_file_and_folder_params_8.RecoverFileAndFolderParams8.from_dictionary(dictionary.get('recoverFileAndFolderParams')) if dictionary.get('recoverFileAndFolderParams') else None
