...
class AWSTargetParamsForRecoverFileAndFolder(object):

    """Implementation of the 'AWS Target Params for Recover File And Folder' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the AWSTargetParamsForRecoverFileAndFolder class"""
