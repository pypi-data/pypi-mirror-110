...
class RecoverToOriginalElastifileFilesTargetParams(object):

    """Implementation of the 'Recover To Original Elastifile Files Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToOriginalElastifileFilesTargetParams class"""
