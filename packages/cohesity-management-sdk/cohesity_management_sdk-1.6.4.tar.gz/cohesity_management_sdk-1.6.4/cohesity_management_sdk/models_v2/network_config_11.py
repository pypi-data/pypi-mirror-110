...
class NetworkConfig11(object):

    """Implementation of the 'NetworkConfig11' model.

    Specifies the networking configuration to be applied to the recovered vApp
    templates.
    ...
    def __init__(self,
        ...
        """Constructor for the NetworkConfig11 class"""
