...
class RecoverVmwareVAppsOriginalSourceConfig(object):

    """Implementation of the 'Recover VMware vApps Original Source Config.' model.

    Specifies the Source configuration if vApps are being recovered to
    Original Source.
    ...
    def __init__(self,
                 network_config=None):
        """Constructor for the RecoverVmwareVAppsOriginalSourceConfig class"""
