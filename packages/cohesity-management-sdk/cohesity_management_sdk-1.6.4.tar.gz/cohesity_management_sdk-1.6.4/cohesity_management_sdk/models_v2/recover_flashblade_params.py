...
import cohesity_management_sdk.models_v2.recover_nas_volume_params_3
import cohesity_management_sdk.models_v2.recover_file_and_folder_params_7
import cohesity_management_sdk.models_v2.download_file_and_folder_params

class RecoverFlashbladeParams(object):

    """Implementation of the 'Recover Flashblade Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverFlashbladeParams class"""
    ...
    def from_dictionary(cls,
        ...
        recover_nas_volume_params = cohesity_management_sdk.models_v2.recover_nas_volume_params_3.RecoverNasVolumeParams3.from_dictionary(dictionary.get('recoverNasVolumeParams')) if dictionary.get('recoverNasVolumeParams') else None
        recover_file_and_folder_params = cohesity_management_sdk.models_v2.recover_file_and_folder_params_7.RecoverFileAndFolderParams7.from_dictionary(dictionary.get('recoverFileAndFolderParams')) if dictionary.get('recoverFileAndFolderParams') else None
