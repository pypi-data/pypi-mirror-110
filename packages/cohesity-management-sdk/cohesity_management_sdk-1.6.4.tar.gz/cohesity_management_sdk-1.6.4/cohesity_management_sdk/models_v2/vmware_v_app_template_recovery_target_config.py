...
class VmwareVAppTemplateRecoveryTargetConfig(object):

    """Implementation of the 'Vmware vApp Template Recovery Target Config.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VmwareVAppTemplateRecoveryTargetConfig class"""
