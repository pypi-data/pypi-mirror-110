...
class UpdateHDFSSourceRequestParameters(object):

    """Implementation of the 'Update HDFS source request parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateHDFSSourceRequestParameters class"""
