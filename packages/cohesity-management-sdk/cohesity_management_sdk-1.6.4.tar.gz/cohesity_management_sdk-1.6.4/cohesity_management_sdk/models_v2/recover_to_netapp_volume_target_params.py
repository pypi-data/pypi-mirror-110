...
class RecoverToNetappVolumeTargetParams(object):

    """Implementation of the 'Recover To Netapp Volume Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToNetappVolumeTargetParams class"""
