...
class IsilonObjectParams(object):

    """Implementation of the 'IsilonObjectParams' model.

    Specifies the common parameters for Isilon objects.

    Attributes:
        supported_nas_mount_protocols (list of
            SupportedNasMountProtocol2Enum): Specifies a list of NAS mount
    ...
    def __init__(self,
        ...
        """Constructor for the IsilonObjectParams class"""
