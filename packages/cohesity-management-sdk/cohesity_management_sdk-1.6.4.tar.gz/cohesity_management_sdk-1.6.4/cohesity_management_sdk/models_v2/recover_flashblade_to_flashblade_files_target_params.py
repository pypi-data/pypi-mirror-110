...
class RecoverFlashbladeToFlashbladeFilesTargetParams(object):

    """Implementation of the 'Recover Flashblade To Flashblade Files Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverFlashbladeToFlashbladeFilesTargetParams class"""
