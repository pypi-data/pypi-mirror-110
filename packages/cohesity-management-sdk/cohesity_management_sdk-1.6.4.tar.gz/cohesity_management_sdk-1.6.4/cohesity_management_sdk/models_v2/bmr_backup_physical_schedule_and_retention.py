...
import cohesity_management_sdk.models_v2.bmr_schedule
import cohesity_management_sdk.models_v2.retention

class BMRBackupPhysicalScheduleAndRetention(object):
    ...
    def __init__(self,
                 schedule=None,
                 retention=None):
        """Constructor for the BMRBackupPhysicalScheduleAndRetention class"""
    ...
    def from_dictionary(cls,
        ...
        schedule = cohesity_management_sdk.models_v2.bmr_schedule.BmrSchedule.from_dictionary(dictionary.get('schedule')) if dictionary.get('schedule') else None
