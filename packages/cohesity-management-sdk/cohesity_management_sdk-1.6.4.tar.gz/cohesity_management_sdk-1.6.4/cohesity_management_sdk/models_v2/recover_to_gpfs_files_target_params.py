...
class RecoverToGPFSFilesTargetParams(object):

    """Implementation of the 'Recover To GPFS Files Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToGPFSFilesTargetParams class"""
