...
class DownTieringInclusionPolicy(object):

    """Implementation of the 'DownTieringInclusionPolicy' model.

    Specifies the files selection rules for downtiering.
    ...
    def __init__(self,
                 ...
                 selection=None,
                 file_size=None):
        """Constructor for the DownTieringInclusionPolicy class"""
