...
class OriginalSourceConfig6(object):

    """Implementation of the 'OriginalSourceConfig6' model.

    Specifies the Source configuration if volumes are being recovered to
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the OriginalSourceConfig6 class"""
