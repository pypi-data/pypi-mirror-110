...
class TdmRefreshTaskResponseParams(object):

    """Implementation of the 'TdmRefreshTaskResponseParams' model.
    ...
    Attributes:
        ...
        view (View): Specifies the details of the view, which is used for the
            clone.
        oracle_params (OracleCloneObject): Specifies the information about an
            Oracle refresh task.
    ...
    def __init__(self,
                 ...
                 view=None,
                 oracle_params=None):
        """Constructor for the TdmRefreshTaskResponseParams class"""
    ...
    def from_dictionary(cls,
        ...
        oracle_params = cohesity_management_sdk.models_v2.oracle_clone_object.OracleCloneObject.from_dictionary(dictionary.get('oracleParams')) if dictionary.get('oracleParams') else None
