...
class RecoverElastifileToElastifileFilesTargetParams(object):

    """Implementation of the 'Recover Elastifile To Elastifile Files Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverElastifileToElastifileFilesTargetParams class"""
