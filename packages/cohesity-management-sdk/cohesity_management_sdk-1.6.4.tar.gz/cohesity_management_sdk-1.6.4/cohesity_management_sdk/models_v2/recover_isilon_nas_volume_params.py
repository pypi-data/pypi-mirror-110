...
class RecoverIsilonNASVolumeParams(object):

    """Implementation of the 'Recover Isilon NAS Volume Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverIsilonNASVolumeParams class"""
