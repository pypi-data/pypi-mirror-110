...
import cohesity_management_sdk.models_v2.original_target_config_4
import cohesity_management_sdk.models_v2.new_target_config_4
import cohesity_management_sdk.models_v2.vlan_config

class VmwareTargetParams5(object):

    """Implementation of the 'VmwareTargetParams5' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the VmwareTargetParams5 class"""
    ...
    def from_dictionary(cls,
        ...
        original_target_config = cohesity_management_sdk.models_v2.original_target_config_4.OriginalTargetConfig4.from_dictionary(dictionary.get('originalTargetConfig')) if dictionary.get('originalTargetConfig') else None
        new_target_config = cohesity_management_sdk.models_v2.new_target_config_4.NewTargetConfig4.from_dictionary(dictionary.get('newTargetConfig')) if dictionary.get('newTargetConfig') else None
