...
class KubernetesNamespaceRecoveryTargetConfig(object):
    ...
    Attributes:
        ...
        new_source_config (KubernetesNamespaceRecoveryNewSourceConfig):
            Specifies the new source configuration if a Kubernetes Namespace
            is being restored to a different source than the one from which it
            was protected.
    ...
    def __init__(self,
        ...
        """Constructor for the KubernetesNamespaceRecoveryTargetConfig class"""
    ...
    def from_dictionary(cls,
        ...
        new_source_config = cohesity_management_sdk.models_v2.kubernetes_namespace_recovery_new_source_config.KubernetesNamespaceRecoveryNewSourceConfig.from_dictionary(dictionary.get('newSourceConfig')) if dictionary.get('newSourceConfig') else None
