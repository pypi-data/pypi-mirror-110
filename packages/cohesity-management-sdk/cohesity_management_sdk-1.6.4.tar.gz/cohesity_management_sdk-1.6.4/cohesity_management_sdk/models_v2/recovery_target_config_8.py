...
import cohesity_management_sdk.models_v2.new_source_config_9
import cohesity_management_sdk.models_v2.original_source_config

class RecoveryTargetConfig8(object):

    """Implementation of the 'RecoveryTargetConfig8' model.
    ...
    original Snource with different configuration. If not specified, then the
    ...
    Attributes:
        recover_to_new_source (bool): Specifies the parameter whether the
            ...
            Target.
        new_source_config (NewSourceConfig9): Specifies the new destination
    ...
    def __init__(self,
        ...
        """Constructor for the RecoveryTargetConfig8 class"""
    ...
    def from_dictionary(cls,
        ...
        new_source_config = cohesity_management_sdk.models_v2.new_source_config_9.NewSourceConfig9.from_dictionary(dictionary.get('newSourceConfig')) if dictionary.get('newSourceConfig') else None
