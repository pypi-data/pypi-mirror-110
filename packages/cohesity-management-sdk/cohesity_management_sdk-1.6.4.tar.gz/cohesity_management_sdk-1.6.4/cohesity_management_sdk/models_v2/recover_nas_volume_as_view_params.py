...
class RecoverNASVolumeAsViewParams(object):

    """Implementation of the 'Recover NAS Volume as View Params.' model.

    Specifies the recovery target configuration if NAS volumes are being
    ...
    def __init__(self,
                 ...
                 qos_policy=None,
                 vlan_config=None):
        """Constructor for the RecoverNASVolumeAsViewParams class"""
