...
class NewSourceConfig13(object):

    """Implementation of the 'NewSourceConfig13' model.

    Specifies the new destination Source configuration parameters where the
    files will be recovered. This is mandatory if recoverToNewSource is set to
    true.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the NewSourceConfig13 class"""
