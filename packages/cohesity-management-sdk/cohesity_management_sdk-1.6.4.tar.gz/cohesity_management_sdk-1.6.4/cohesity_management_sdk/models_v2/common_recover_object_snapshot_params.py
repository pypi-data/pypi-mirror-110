...
class CommonRecoverObjectSnapshotParams(object):

    """Implementation of the 'Common Recover Object Snapshot Params.' model.
    ...
    def __init__(self,
                 ...
                 end_time_usecs=None,
                 messages=None):
        """Constructor for the CommonRecoverObjectSnapshotParams class"""
