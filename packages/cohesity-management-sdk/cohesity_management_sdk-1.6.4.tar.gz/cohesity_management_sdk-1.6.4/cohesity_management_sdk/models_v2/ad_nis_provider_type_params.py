...
class AdNisProviderTypeParams(object):

    """Implementation of the 'AdNisProviderTypeParams' model.

    Specifies the properties associated to a NisProvider type user id
    mapping.
    ...
    def __init__(self,
        ...
        """Constructor for the AdNisProviderTypeParams class"""
