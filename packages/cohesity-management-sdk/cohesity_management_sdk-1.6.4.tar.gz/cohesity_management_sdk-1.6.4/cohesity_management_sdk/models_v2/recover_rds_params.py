...
import cohesity_management_sdk.models_v2.aws_target_params_2

class RecoverRdsParams(object):

    """Implementation of the 'RecoverRdsParams' model.

    Specifies the parameters to AWS RDS.

    Attributes:
        recover_protection_group_runs_params (list of
            RecoverProtectionGroupRunParams): Specifies the Protection Group
            Runs params to recover. All the RDS instances that are
            successfully backed up by specified Runs will be recovered. This
            can be specified along with individual snapshots of RDS instances.
            User has to make sure that specified Object snapshots and
        ...
        aws_target_params (AwsTargetParams2): Specifies the params for
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverRdsParams class"""
    ...
    def from_dictionary(cls,
        ...
        recover_protection_group_runs_params = None
        if dictionary.get('recoverProtectionGroupRunsParams') != None:
        ...
        aws_target_params = cohesity_management_sdk.models_v2.aws_target_params_2.AwsTargetParams2.from_dictionary(dictionary.get('awsTargetParams')) if dictionary.get('awsTargetParams') else None
