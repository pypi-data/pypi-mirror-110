...
class RecoverGPFSToGPFSFilesTargetParams(object):

    """Implementation of the 'Recover GPFS To GPFS Files Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverGPFSToGPFSFilesTargetParams class"""
