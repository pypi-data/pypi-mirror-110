...
import cohesity_management_sdk.models_v2.physical_target_params

class RecoverPhysicalVolumesParams(object):

    """Implementation of the 'Recover Physical Volumes params.' model.
    ...
    Attributes:
        ...
        physical_target_params (PhysicalTargetParams): Specifies the params
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverPhysicalVolumesParams class"""
    ...
    def from_dictionary(cls,
        ...
        physical_target_params = cohesity_management_sdk.models_v2.physical_target_params.PhysicalTargetParams.from_dictionary(dictionary.get('physicalTargetParams')) if dictionary.get('physicalTargetParams') else None
