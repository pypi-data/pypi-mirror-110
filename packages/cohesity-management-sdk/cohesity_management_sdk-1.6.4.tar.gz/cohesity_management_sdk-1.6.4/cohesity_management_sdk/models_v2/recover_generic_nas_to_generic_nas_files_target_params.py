...
class RecoverGenericNasToGenericNasFilesTargetParams(object):

    """Implementation of the 'Recover Generic Nas To Generic Nas Files Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverGenericNasToGenericNasFilesTargetParams class"""
