...
class AntivirusScanConfig(object):
    ...
    def from_dictionary(cls,
        ...
        scan_filter = cohesity_management_sdk.models_v2.file_extension_filter.FileExtensionFilter.from_dictionary(dictionary.get('scanFilter')) if dictionary.get('scanFilter') else None
