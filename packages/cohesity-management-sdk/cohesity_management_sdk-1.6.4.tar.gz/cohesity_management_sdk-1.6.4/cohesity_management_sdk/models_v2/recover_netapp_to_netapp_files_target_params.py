...
import cohesity_management_sdk.models_v2.new_source_config_11
import cohesity_management_sdk.models_v2.original_source_config_7

class RecoverNetappToNetappFilesTargetParams(object):

    """Implementation of the 'Recover Netapp To Netapp Files Target Params.' model.
    ...
    Attributes:
        recover_to_new_source (bool): Specifies the parameter whether the
            ...
            target.
        new_source_config (NewSourceConfig11): Specifies the new destination
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverNetappToNetappFilesTargetParams class"""
    ...
    def from_dictionary(cls,
        ...
        new_source_config = cohesity_management_sdk.models_v2.new_source_config_11.NewSourceConfig11.from_dictionary(dictionary.get('newSourceConfig')) if dictionary.get('newSourceConfig') else None
