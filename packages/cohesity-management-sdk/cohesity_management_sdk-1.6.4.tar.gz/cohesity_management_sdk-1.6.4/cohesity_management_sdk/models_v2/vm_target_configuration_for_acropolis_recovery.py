...
class VmTargetConfigurationForAcropolisRecovery(object):

    """Implementation of the 'Vm Target Configuration for Acropolis Recovery' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VmTargetConfigurationForAcropolisRecovery class"""
