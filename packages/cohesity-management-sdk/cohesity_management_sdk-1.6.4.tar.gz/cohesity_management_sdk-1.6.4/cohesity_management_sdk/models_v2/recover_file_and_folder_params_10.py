...
class RecoverFileAndFolderParams10(object):

    """Implementation of the 'RecoverFileAndFolderParams10' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverFileAndFolderParams10 class"""
