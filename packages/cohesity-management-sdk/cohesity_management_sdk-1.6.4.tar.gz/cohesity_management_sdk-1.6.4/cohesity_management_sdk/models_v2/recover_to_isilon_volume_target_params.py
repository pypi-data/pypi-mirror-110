...
import cohesity_management_sdk.models_v2.volume
import cohesity_management_sdk.models_v2.parent_source
import cohesity_management_sdk.models_v2.recovery_vlan_config

class RecoverToIsilonVolumeTargetParams(object):

    """Implementation of the 'Recover To Isilon Volume Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToIsilonVolumeTargetParams class"""
    ...
    def from_dictionary(cls,
        ...
        volume = cohesity_management_sdk.models_v2.volume.Volume.from_dictionary(dictionary.get('volume')) if dictionary.get('volume') else None
