...
class RecoverKVMVMsOriginalSourceConfig(object):

    """Implementation of the 'Recover KVM VMs Original Source Config.' model.
    ...
    def __init__(self,
                 network_config=None):
        """Constructor for the RecoverKVMVMsOriginalSourceConfig class"""
