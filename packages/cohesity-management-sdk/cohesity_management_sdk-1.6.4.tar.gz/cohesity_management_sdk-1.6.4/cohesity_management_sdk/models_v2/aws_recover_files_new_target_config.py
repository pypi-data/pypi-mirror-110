...
class AWSRecoverFilesNewTargetConfig(object):

    """Implementation of the 'AWS Recover Files New Target Config.' model.
    ...
    def __init__(self,
                 ...
                 absolute_path=None):
        """Constructor for the AWSRecoverFilesNewTargetConfig class"""
