...
import cohesity_management_sdk.models_v2.new_source_config_23
import cohesity_management_sdk.models_v2.original_source_config_19

class PureTargetParams(object):
    ...
    def __init__(self,
        ...
        """Constructor for the PureTargetParams class"""
    ...
    def from_dictionary(cls,
        ...
        new_source_config = cohesity_management_sdk.models_v2.new_source_config_23.NewSourceConfig23.from_dictionary(dictionary.get('newSourceConfig')) if dictionary.get('newSourceConfig') else None
        original_source_config = cohesity_management_sdk.models_v2.original_source_config_19.OriginalSourceConfig19.from_dictionary(dictionary.get('originalSourceConfig')) if dictionary.get('originalSourceConfig') else None
