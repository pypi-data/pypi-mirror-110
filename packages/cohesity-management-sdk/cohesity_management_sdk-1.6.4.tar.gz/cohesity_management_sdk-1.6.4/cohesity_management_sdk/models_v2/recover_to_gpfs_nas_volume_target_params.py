...
class RecoverToGPFSNasVolumeTargetParams(object):

    """Implementation of the 'Recover To GPFS Nas Volume Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToGPFSNasVolumeTargetParams class"""
