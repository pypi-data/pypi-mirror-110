...
class RemoteAdapterReplicationParameters(object):
    ...
    Attributes:
        ...
        view_name (string): Specifies the name of the remote view. By default
            the name will be same as the protected view. If a view with the
            specified name already exists on the remote cluster, the created
            name will have a suffix '-1'.
    ...
    def __init__(self,
                 create_view=None,
                 view_name=None):
        """Constructor for the RemoteAdapterReplicationParameters class"""
