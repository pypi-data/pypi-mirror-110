...
class FileLevelDataLockConfigurations(object):

    """Implementation of the 'File Level Data Lock Configurations.' model.
    ...
    Attributes:
        ...
        mode (Mode5Enum): Specifies the mode of file level datalock.
    ...
    def __init__(self,
                 ...
                 mode=None):
        """Constructor for the FileLevelDataLockConfigurations class"""
