...
class RecoverToNetappFilesTargetParams(object):

    """Implementation of the 'Recover To Netapp Files Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToNetappFilesTargetParams class"""
