...
class AzureTargetParamsForRecoverFiles(object):

    """Implementation of the 'Azure Target Params for Recover Files' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the AzureTargetParamsForRecoverFiles class"""
