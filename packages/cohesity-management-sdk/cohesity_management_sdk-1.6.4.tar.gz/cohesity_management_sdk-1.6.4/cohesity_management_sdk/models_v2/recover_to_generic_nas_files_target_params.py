...
class RecoverToGenericNasFilesTargetParams(object):

    """Implementation of the 'Recover To Generic Nas Files Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToGenericNasFilesTargetParams class"""
