...
class RecoverGenericNASToGenericNASVolumeTargetParams(object):

    """Implementation of the 'Recover Generic NAS To Generic NAS Volume Target Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverGenericNASToGenericNASVolumeTargetParams class"""
