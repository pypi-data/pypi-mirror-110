...
class RecoverIsilonToIsilonVolumeTargetParams(object):

    """Implementation of the 'Recover Isilon To Isilon Volume Target Params.' model.

    Specifies the params of the Isilon recovery target.

    Attributes:
        recover_to_new_source (bool): Specifies the parameter whether the
            recovery should be performed to a new or the original Isilon
            target.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverIsilonToIsilonVolumeTargetParams class"""
