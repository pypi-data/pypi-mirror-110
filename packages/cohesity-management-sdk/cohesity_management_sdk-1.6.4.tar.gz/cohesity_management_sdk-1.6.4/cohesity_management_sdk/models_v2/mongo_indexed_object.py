...
class MongoIndexedObject(object):

    """Implementation of the 'MongoIndexedObject' model.
    ...
    Attributes:
        ...
        mtype (Type26Enum): Specifies the Mongo Object Type.
    ...
    def __init__(self,
                 ...
                 mtype=None,
                 id=None):
        """Constructor for the MongoIndexedObject class"""
