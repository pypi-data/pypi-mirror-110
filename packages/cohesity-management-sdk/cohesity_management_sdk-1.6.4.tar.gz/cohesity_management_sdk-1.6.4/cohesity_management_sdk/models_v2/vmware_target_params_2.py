...
import cohesity_management_sdk.models_v2.original_target_config_3
import cohesity_management_sdk.models_v2.new_target_config_3
import cohesity_management_sdk.models_v2.mounted_volume_mapping
import cohesity_management_sdk.models_v2.vlan_config_1

class VmwareTargetParams2(object):

    """Implementation of the 'VmwareTargetParams2' model.
    ...
    Attributes:
        ...
        original_target_config (OriginalTargetConfig3): Specifies the
            configuration for mounting to the original target.
        new_target_config (NewTargetConfig3): Specifies the configuration for
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the VmwareTargetParams2 class"""
    ...
    def from_dictionary(cls,
        ...
        original_target_config = cohesity_management_sdk.models_v2.original_target_config_3.OriginalTargetConfig3.from_dictionary(dictionary.get('originalTargetConfig')) if dictionary.get('originalTargetConfig') else None
        new_target_config = cohesity_management_sdk.models_v2.new_target_config_3.NewTargetConfig3.from_dictionary(dictionary.get('newTargetConfig')) if dictionary.get('newTargetConfig') else None
        read_only_mount = dictionary.get('readOnlyMount')
        volume_names = dictionary.get('volumeNames')
        mounted_volume_mapping = None
        if dictionary.get('mountedVolumeMapping') != None:
