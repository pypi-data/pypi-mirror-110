...
class RecoverAzureVMsNewSourceNetworkConfiguration(object):

    """Implementation of the 'Recover Azure VMs New Source Network configuration.' model.

    Specifies the network config parameters to be applied for Azure VMs if
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverAzureVMsNewSourceNetworkConfiguration class"""
