...
class RecoverAWSRDSNewSourceNetworkConfiguration(object):

    """Implementation of the 'Recover AWS RDS New Source Network configuration.' model.

    Specifies the network config parameters to be applied for AWS RDS if
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverAWSRDSNewSourceNetworkConfiguration class"""
    ...
    def from_dictionary(cls,
        ...
        security_groups = None
        if dictionary.get('securityGroups') != None:
