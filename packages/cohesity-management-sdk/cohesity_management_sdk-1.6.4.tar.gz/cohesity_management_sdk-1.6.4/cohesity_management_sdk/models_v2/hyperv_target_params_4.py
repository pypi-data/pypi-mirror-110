...
import cohesity_management_sdk.models_v2.recovery_target_config_9
import cohesity_management_sdk.models_v2.vlan_config_1

class HypervTargetParams4(object):

    """Implementation of the 'HyperV Target Params.4' model.
    ...
    Attributes:
        ...
        recovery_target_config (RecoveryTargetConfig9): Specifies the recovery
        ...
        continue_on_error (bool): Specifies whether to continue recovering
            ...
            false.
        instant_recovery (bool): Specifies whether to perform an instant
            recovery. By instant recovery, the recovered VM is available
            before files are completely copied to the recovered VM. Default is
            true.
        preserve_uuids (bool): Specifies whether to preserve uuids of
            recovered VMs. Default is false.
    ...
    _names = {
        ...
        "instant_recovery":'instantRecovery',
    ...
    def __init__(self,
                 ...
                 preserve_uuids=None,
                 vlan_config=None):
        """Constructor for the HypervTargetParams4 class"""
    ...
    def from_dictionary(cls,
        ...
        recovery_target_config = cohesity_management_sdk.models_v2.recovery_target_config_9.RecoveryTargetConfig9.from_dictionary(dictionary.get('recoveryTargetConfig')) if dictionary.get('recoveryTargetConfig') else None
        power_on_vms = dictionary.get('powerOnVms')
        continue_on_error = dictionary.get('continueOnError')
        instant_recovery = dictionary.get('instantRecovery')
        preserve_uuids = dictionary.get('preserveUuids')
