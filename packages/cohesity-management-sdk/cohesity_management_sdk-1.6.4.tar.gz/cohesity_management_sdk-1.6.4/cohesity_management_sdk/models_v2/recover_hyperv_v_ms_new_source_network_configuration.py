...
class RecoverHypervVMsNewSourceNetworkConfiguration(object):

    """Implementation of the 'Recover HyperV VMs New Source Network configuration.' model.
    ...
    def __init__(self,
                 detach_network=None,
                 virtual_switch=None):
        """Constructor for the RecoverHypervVMsNewSourceNetworkConfiguration class"""
