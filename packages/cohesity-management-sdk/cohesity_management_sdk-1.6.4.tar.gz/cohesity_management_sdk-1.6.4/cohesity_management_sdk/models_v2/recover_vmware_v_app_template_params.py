...
class RecoverVmwareVAppTemplateParams(object):

    """Implementation of the 'Recover VMware vApp template params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverVmwareVAppTemplateParams class"""
