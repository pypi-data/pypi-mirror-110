...
import cohesity_management_sdk.models_v2.recover_hbase_object_params

class RecoverHbaseSnapshotParams(object):

    """Implementation of the 'Recover Hbase Snapshot Params.' model.
    ...
    Attributes:
        ...
        objects (list of RecoverHbaseObjectParams): Specifies details of
    ...
    def __init__(self,
                 ...
                 messages=None,
                 objects=None):
        """Constructor for the RecoverHbaseSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') != None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.recover_hbase_object_params.RecoverHbaseObjectParams.from_dictionary(structure))
