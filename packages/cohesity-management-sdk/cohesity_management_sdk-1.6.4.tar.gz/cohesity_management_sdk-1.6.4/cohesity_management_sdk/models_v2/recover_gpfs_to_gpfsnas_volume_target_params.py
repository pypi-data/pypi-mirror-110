...
class RecoverGPFSToGPFSNASVolumeTargetParams(object):

    """Implementation of the 'Recover GPFS To GPFS NAS Volume Target Params.' model.

    Specifies the params of the GPFS recovery target.

    Attributes:
        recover_to_new_source (bool): Specifies the parameter whether the
            recovery should be performed to a new or the original GPFS
            target.
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverGPFSToGPFSNASVolumeTargetParams class"""
