...
class RecoverHDFSParams(object):
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverHDFSParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('snapshots') != None:
            ...
            for structure in dictionary.get('snapshots'):
                snapshots.append(cohesity_management_sdk.models_v2.recover_hdfs_snapshot_params.RecoverHdfsSnapshotParams.from_dictionary(structure))
