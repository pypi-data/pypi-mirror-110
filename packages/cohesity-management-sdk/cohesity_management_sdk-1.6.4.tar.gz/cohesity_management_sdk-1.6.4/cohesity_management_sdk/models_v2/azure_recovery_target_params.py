...
import cohesity_management_sdk.models_v2.recovery_target_config_3

class AzureRecoveryTargetParams(object):

    """Implementation of the 'Azure Recovery Target Params' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AzureRecoveryTargetParams class"""
    ...
    def from_dictionary(cls,
        ...
        recovery_target_config = cohesity_management_sdk.models_v2.recovery_target_config_3.RecoveryTargetConfig3.from_dictionary(dictionary.get('recoveryTargetConfig')) if dictionary.get('recoveryTargetConfig') else None
