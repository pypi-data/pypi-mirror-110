...
class ActiveDirectory(object):
    ...
    def from_dictionary(cls,
        ...
        machine_accounts = None
        if dictionary.get('machineAccounts') != None:
        ...
        centrify_zones = None
        if dictionary.get('centrifyZones') != None:
            centrify_zones = list()
        ...
        domain_controllers = None
        if dictionary.get('domainControllers') != None:
        ...
        security_principals = None
        if dictionary.get('securityPrincipals') != None:
