...
class RenameRecoveredVAppsParams(object):

    """Implementation of the 'RenameRecoveredVAppsParams' model.

    Specifies params to rename the vApps that are recovered. If not specified,
    ...
    def __init__(self,
                 prefix=None,
                 suffix=None):
        """Constructor for the RenameRecoveredVAppsParams class"""
