...
class RecoverKVMVMsOriginalSourceNetworkConfiguration(object):

    """Implementation of the 'Recover KVM VMs Original Source Network configuration.' model.
    ...
    def __init__(self,
                 detach_network=None):
        """Constructor for the RecoverKVMVMsOriginalSourceNetworkConfiguration class"""
