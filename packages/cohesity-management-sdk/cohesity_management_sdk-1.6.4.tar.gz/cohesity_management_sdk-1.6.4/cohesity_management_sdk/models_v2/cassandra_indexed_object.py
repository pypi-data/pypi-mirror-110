...
class CassandraIndexedObject(object):

    """Implementation of the 'CassandraIndexedObject' model.
    ...
    Attributes:
        ...
        mtype (Type5Enum): Specifies the Cassandra Object type.
    ...
    def __init__(self,
                 ...
                 mtype=None,
                 id=None):
        """Constructor for the CassandraIndexedObject class"""
