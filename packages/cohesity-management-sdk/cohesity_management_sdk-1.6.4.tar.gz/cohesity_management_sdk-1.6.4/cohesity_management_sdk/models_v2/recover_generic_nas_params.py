...
import cohesity_management_sdk.models_v2.recover_nas_volume_params_1
import cohesity_management_sdk.models_v2.recover_file_and_folder_params_5
import cohesity_management_sdk.models_v2.download_file_and_folder_params

class RecoverGenericNASParams(object):

    """Implementation of the 'Recover Generic NAS Params.' model.
    ...
    Attributes:
        ...
        recover_nas_volume_params (RecoverNasVolumeParams1): Specifies the
            parameters to recover Nas Volumes.
        recover_file_and_folder_params (RecoverFileAndFolderParams5):
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverGenericNASParams class"""
    ...
    def from_dictionary(cls,
        ...
        recover_nas_volume_params = cohesity_management_sdk.models_v2.recover_nas_volume_params_1.RecoverNasVolumeParams1.from_dictionary(dictionary.get('recoverNasVolumeParams')) if dictionary.get('recoverNasVolumeParams') else None
        recover_file_and_folder_params = cohesity_management_sdk.models_v2.recover_file_and_folder_params_5.RecoverFileAndFolderParams5.from_dictionary(dictionary.get('recoverFileAndFolderParams')) if dictionary.get('recoverFileAndFolderParams') else None
