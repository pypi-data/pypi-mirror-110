...
class RecoverToElastifileFilesTargetParams(object):

    """Implementation of the 'Recover To Elastifile Files Target Params.' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToElastifileFilesTargetParams class"""
