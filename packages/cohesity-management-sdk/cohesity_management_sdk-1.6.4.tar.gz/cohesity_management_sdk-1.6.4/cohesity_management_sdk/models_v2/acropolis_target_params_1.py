...
import cohesity_management_sdk.models_v2.recovery_target_config
import cohesity_management_sdk.models_v2.vlan_config_1

class AcropolisTargetParams1(object):

    """Implementation of the 'AcropolisTargetParams1' model.
    ...
    Attributes:
        ...
        recovery_target_config (RecoveryTargetConfig): Specifies the recovery
    ...
    def __init__(self,
        ...
        """Constructor for the AcropolisTargetParams1 class"""
    ...
    def from_dictionary(cls,
        ...
        recovery_target_config = cohesity_management_sdk.models_v2.recovery_target_config.RecoveryTargetConfig.from_dictionary(dictionary.get('recoveryTargetConfig')) if dictionary.get('recoveryTargetConfig') else None
