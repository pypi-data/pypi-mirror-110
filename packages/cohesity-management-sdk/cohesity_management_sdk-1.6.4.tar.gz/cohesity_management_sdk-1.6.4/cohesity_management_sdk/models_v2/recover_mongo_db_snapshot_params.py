...
import cohesity_management_sdk.models_v2.recover_mongo_db_object_params

class RecoverMongoDBSnapshotParams(object):

    """Implementation of the 'Recover MongoDB Snapshot Params.' model.
    ...
    Attributes:
        ...
        objects (list of RecoverMongoDBObjectParams): Specifies details of
    ...
    def __init__(self,
                 ...
                 messages=None,
                 objects=None):
        """Constructor for the RecoverMongoDBSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') != None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.recover_mongo_db_object_params.RecoverMongoDBObjectParams.from_dictionary(structure))
