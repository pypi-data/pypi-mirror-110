...
import cohesity_management_sdk.models_v2.isilon_target_params_5
...
class RecoverFileAndFolderParams6(object):

    """Implementation of the 'RecoverFileAndFolderParams6' model.
    ...
    Attributes:
        ...
        target_environment (TargetEnvironment1Enum): Specifies the environment
            ...
            filled out.
        isilon_target_params (IsilonTargetParams5): Specifies the params for a
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverFileAndFolderParams6 class"""
    ...
    def from_dictionary(cls,
        ...
        isilon_target_params = cohesity_management_sdk.models_v2.isilon_target_params_5.IsilonTargetParams5.from_dictionary(dictionary.get('isilonTargetParams')) if dictionary.get('isilonTargetParams') else None
