...
import cohesity_management_sdk.models_v2.new_source_config_6
import cohesity_management_sdk.models_v2.original_source_config_3

class VmwareVMsRecoveryTargetConfig(object):

    """Implementation of the 'Vmware VMs Recovery Target Config.' model.
    ...
    Attributes:
        recover_to_new_source (bool): Specifies the parameter whether the
            ...
            Target.
        new_source_config (NewSourceConfig6): Specifies the new destination
            Source configuration parameters where the VMs will be recovered.
            This is mandatory if recoverToNewSource is set to true.
        original_source_config (OriginalSourceConfig3): Specifies the Source
    ...
    def __init__(self,
        ...
        """Constructor for the VmwareVMsRecoveryTargetConfig class"""
    ...
    def from_dictionary(cls,
        ...
        new_source_config = cohesity_management_sdk.models_v2.new_source_config_6.NewSourceConfig6.from_dictionary(dictionary.get('newSourceConfig')) if dictionary.get('newSourceConfig') else None
        original_source_config = cohesity_management_sdk.models_v2.original_source_config_3.OriginalSourceConfig3.from_dictionary(dictionary.get('originalSourceConfig')) if dictionary.get('originalSourceConfig') else None
