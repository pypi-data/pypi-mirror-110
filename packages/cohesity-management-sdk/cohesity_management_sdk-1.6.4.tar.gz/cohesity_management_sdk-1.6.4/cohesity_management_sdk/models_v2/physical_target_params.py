...
class PhysicalTargetParams(object):

    """Implementation of the 'PhysicalTargetParams' model.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the PhysicalTargetParams class"""
    ...
    def from_dictionary(cls,
        ...
        volume_mapping = None
        if dictionary.get('volumeMapping') != None:
            volume_mapping = list()
