...
import cohesity_management_sdk.models_v2.recover_couchbase_object_params

class RecoverCouchbaseSnapshotParams(object):

    """Implementation of the 'Recover Couchbase Snapshot Params.' model.
    ...
    Attributes:
        ...
        objects (list of RecoverCouchbaseObjectParams): Specifies details of
    ...
    def __init__(self,
                 ...
                 messages=None,
                 objects=None):
        """Constructor for the RecoverCouchbaseSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') != None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.recover_couchbase_object_params.RecoverCouchbaseObjectParams.from_dictionary(structure))
