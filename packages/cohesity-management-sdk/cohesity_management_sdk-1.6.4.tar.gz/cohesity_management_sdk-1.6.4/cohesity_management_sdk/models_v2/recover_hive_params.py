...
import cohesity_management_sdk.models_v2.recover_hive_snapshot_params

class RecoverHiveParams(object):

    """Implementation of the 'Recover Hive params.' model.
    ...
    Attributes:
        ...
        snapshots (list of RecoverHiveSnapshotParams): Specifies the local
    ...
    def __init__(self,
                 ...
                 warnings=None,
                 suffix=None):
        """Constructor for the RecoverHiveParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('snapshots') != None:
            ...
            for structure in dictionary.get('snapshots'):
                snapshots.append(cohesity_management_sdk.models_v2.recover_hive_snapshot_params.RecoverHiveSnapshotParams.from_dictionary(structure))
