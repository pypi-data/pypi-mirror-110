...
- useZebraStyles (boolean; optional):
    ...
    @_explicitize_args
    def __init__(self, className=Component.UNDEFINED, id=Component.REQUIRED, data=Component.UNDEFINED, columns=Component.UNDEFINED, isSortable=Component.UNDEFINED, locale=Component.UNDEFINED, overflowMenuOnHover=Component.UNDEFINED, radio=Component.UNDEFINED, shouldShowBorder=Component.UNDEFINED, size=Component.UNDEFINED, stickyHeader=Component.UNDEFINED, useStaticWidth=Component.UNDEFINED, useZebraStyles=Component.UNDEFINED, title=Component.UNDEFINED, description=Component.UNDEFINED, isSearchable=Component.UNDEFINED, actions=Component.UNDEFINED, action=Component.UNDEFINED, isPageable=Component.UNDEFINED, pageSizes=Component.UNDEFINED, pageSize=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'action', 'actions', 'className', 'columns', 'data', 'description', 'isPageable', 'isSearchable', 'isSortable', 'locale', 'overflowMenuOnHover', 'pageSize', 'pageSizes', 'radio', 'shouldShowBorder', 'size', 'stickyHeader', 'style', 'title', 'useStaticWidth', 'useZebraStyles']
        self._type = 'DataTable'
        self._namespace = 'dash_carbon_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'action', 'actions', 'className', 'columns', 'data', 'description', 'isPageable', 'isSearchable', 'isSortable', 'locale', 'overflowMenuOnHover', 'pageSize', 'pageSizes', 'radio', 'shouldShowBorder', 'size', 'stickyHeader', 'style', 'title', 'useStaticWidth', 'useZebraStyles']
