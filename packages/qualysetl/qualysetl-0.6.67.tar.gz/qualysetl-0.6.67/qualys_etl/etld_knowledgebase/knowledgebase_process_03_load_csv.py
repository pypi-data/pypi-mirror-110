...
def prepare_csv_cell(csv_cell, csv_column, qid):
    if csv_cell is None:
        csv_cell = ""
        ...
        csv_cell = kb_format_cve_list(csv_cell, qid)
...
def kb_create_csv_from_shelve(no_truncation=False):
    ...
    csv_columns = etld_lib_functions.kb_csv_columns()
    csv_headers = {}
...
def kb_format_cve_list(kb_item, qid):
    global kb_cve_qid_list
    kb_cve_list_return = ""
