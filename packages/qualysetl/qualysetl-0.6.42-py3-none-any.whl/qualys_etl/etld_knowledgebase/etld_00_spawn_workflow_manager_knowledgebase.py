...
def main():
    ...
    etld_lib_spawn_etl.log_file_max_size = (1024 * 1)          # 1024 * size = Max Meg Size
    etld_lib_spawn_etl.spawned_process_max_run_time = (60*20)       # (seconds * minutes), then terminate as there is an issue.
    ...
    etld_lib_spawn_etl.target_module_to_run = etl_knowledgebase.kb_etl_workflow
    etld_lib_spawn_etl.target_method_in_module_to_run = "kb_etl_workflow"
